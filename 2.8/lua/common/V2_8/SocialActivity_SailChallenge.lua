...
function Initialize()
    ...
    for k,v in pairs(stage_berth_windzone) do
        ...
        table.insert(variables,{ name = "stage_berth_"..tostring(k).."_active_num", value = 0})
    end

    table.insert(variables,{ name = "current_stage_die_monster_num", value = 0})
    table.insert(variables,{ name = "coin_num", value = 0})
    table.insert(variables,{ name = "reminder_index", value = 0})
end
