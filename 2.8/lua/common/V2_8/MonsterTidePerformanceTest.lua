...
function Initialize()
    ...
    --GM，暂停怪物潮
    table.insert(variables,{ name = "GM_Stop_Tide", value = 0})
    --GM，启动怪物潮
    table.insert(variables,{ name = "GM_Start_Tide", value = 0})
    --GM，重启测试
    table.insert(variables,{ name = "GM_Restart_Test", value = 0})
    --GM，选择是否开启优化怪物潮
    table.insert(variables,{ name = "GM_Optimize_Tide", value = 0})
    --GM，选择是否开启轻量化怪物潮
    table.insert(variables,{ name = "GM_Light_Tide", value = 0})
end
