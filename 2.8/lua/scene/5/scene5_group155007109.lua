...
-- 装置
gadgets = {
	{ config_id = 109002, gadget_id = 70211002, pos = { x = -37.761, y = 196.700, z = 1549.096 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}
