...
suites = {
	{
		...
		monsters = { },
		gadgets = { },
		regions = { 401001, 401002, 401003 },
		triggers = { "ENTER_REGION_401001", "ENTER_REGION_401002", "ENTER_REGION_401003" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_ENTER_REGION_401001(context, evt)
	if evt.param1 ~= 401001 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_401001(context, evt)
