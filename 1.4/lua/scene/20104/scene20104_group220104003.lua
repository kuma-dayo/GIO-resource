...
gadgets = {
	...
	{ config_id = 3053, gadget_id = 70220014, pos = { x = -93.350, y = 28.155, z = 10.099 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	...
	{ config_id = 3059, gadget_id = 70211101, pos = { x = -66.528, y = 25.331, z = -76.771 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true },
	{ config_id = 3060, gadget_id = 70220014, pos = { x = -67.113, y = 25.330, z = -77.947 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3061, gadget_id = 70211101, pos = { x = -103.797, y = 12.884, z = -76.892 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true },
	...
	{ config_id = 3066, gadget_id = 70211101, pos = { x = -159.396, y = -8.084, z = 26.422 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 11, drop_tag = "解谜低级璃月", isOneoff = true, persistent = true },
