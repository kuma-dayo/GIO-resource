...
-- 怪物
monsters = {
	{ config_id = 9001, monster_id = 26020101, pos = { x = -291.110, y = 31.754, z = 170.916 }, rot = { x = 0.000, y = 242.751, z = 0.000 }, level = 1, disableWander = true, affix = { 1021, 1030 }, pose_id = 1, title_id = 2111, special_name_id = 10016 }
}
