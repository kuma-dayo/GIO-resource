...
-- 怪物
monsters = {
	[8002] = { config_id = 8002, monster_id = 26020201, pos = { x = -138.991, y = 20.470, z = -5.276 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, affix = { 1008 }, pose_id = 1, title_id = 2112, special_name_id = 17 }
}
