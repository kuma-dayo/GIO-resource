...
function LF_Set_Secure_Timer(context, name)
	if name == "sink" then
		ScriptLib.CreateGroupTimerEvent(context, 133102769, "sink", 20)
	elseif name == "summon" then
		ScriptLib.CreateGroupTimerEvent(context, 133102769, "summon", 40)
	end
	return 0
end
...
regions = {
	...
	{ config_id = 769059, shape = RegionShape.SPHERE, radius = 45, pos = { x = 1788.900, y = 200.550, z = 276.559 }, area_id = 5 },
...
triggers = {
	...
	{ config_id = 1769056, name = "TIMER_EVENT_769056", event = EventType.EVENT_TIMER_EVENT, source = "", condition = "", action = "action_EVENT_TIMER_EVENT_769056", trigger_count = 0 },
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_769052", "GROUP_REFRESH_769053", "TIMER_EVENT_769056", "ENTER_REGION_769059", "LEAVE_REGION_769060", "GROUP_WILL_UNLOAD_769061", "VARIABLE_CHANGE_769068" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_ANY_MONSTER_DIE_769027(context, evt)
	...
	elseif evt.param1 == defs.monster_boss then
		...
		ScriptLib.CreateGroupTimerEvent(context, defs.group_id, "boss_die", 3)
...
-- 触发操作
function action_EVENT_TIMER_EVENT_769056(context, evt)
