...
-- 怪物
monsters = {
	{ config_id = 620, monster_id = 24010101, pos = { x = 2348.752, y = 283.871, z = -1730.709 }, rot = { x = 0.000, y = 10.000, z = 0.000 }, level = 20, drop_tag = "遗迹守卫", pose_id = 100, title_id = 6001, special_name_id = 10007, area_id = 1 }
}
