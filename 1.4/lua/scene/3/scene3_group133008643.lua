...
regions = {
	...
	{ config_id = 643007, shape = RegionShape.SPHERE, radius = 10, pos = { x = 928.284, y = 345.947, z = -819.170 }, area_id = 10 },
	{ config_id = 643008, shape = RegionShape.SPHERE, radius = 10, pos = { x = 928.284, y = 345.947, z = -819.170 }, area_id = 10 }
}
...
suites = {
	{
		...
		monsters = { },
		gadgets = { },
		regions = { 643001, 643002, 643003, 643007 },
		triggers = { "ENTER_REGION_643001", "ENTER_REGION_643002", "ENTER_REGION_643003", "ENTER_REGION_643007" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		...
		monsters = { },
		gadgets = { },
		regions = { 643004, 643005, 643006, 643008 },
		triggers = { "ENTER_REGION_643004", "ENTER_REGION_643005", "ENTER_REGION_643006", "ENTER_REGION_643008" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_ENTER_REGION_643003(context, evt)
	if evt.param1 ~= 643003 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_643003(context, evt)
	-- 提前设置环境区域
	if 0 ~= ScriptLib.EnterWeatherArea(context, 2024) then
	  return -1
	end
...
-- 触发条件
function condition_EVENT_ENTER_REGION_643006(context, evt)
	if evt.param1 ~= 643006 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_643006(context, evt)
	-- 提前设置环境区域
	if 0 ~= ScriptLib.EnterWeatherArea(context, 2038) then
	  return -1
	end
