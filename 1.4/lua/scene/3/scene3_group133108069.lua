...
-- 怪物
monsters = {
	{ config_id = 69001, monster_id = 28050202, pos = { x = -337.234, y = 231.155, z = -947.618 }, rot = { x = 0.000, y = 135.672, z = 0.000 }, level = 32, area_id = 7 },
	{ config_id = 69002, monster_id = 28050202, pos = { x = -329.351, y = 232.618, z = -965.400 }, rot = { x = 0.000, y = 147.797, z = 0.000 }, level = 32, pose_id = 3, area_id = 7 }
}
