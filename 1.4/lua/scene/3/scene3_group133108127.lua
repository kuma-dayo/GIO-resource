...
-- 怪物
monsters = {
	{ config_id = 127001, monster_id = 21020501, pos = { x = -318.136, y = 200.236, z = -643.830 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, drop_id = 1000100, area_id = 7 }
}

-- NPC
npcs = {
	{ config_id = 127004, npc_id = 20131, pos = { x = -318.141, y = 200.729, z = -639.402 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, area_id = 7 }
}

-- 装置
gadgets = {
	{ config_id = 127002, gadget_id = 70360001, pos = { x = -318.923, y = 200.219, z = -640.245 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 7 },
	{ config_id = 127006, gadget_id = 70360092, pos = { x = -318.216, y = 199.850, z = -639.361 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, state = GadgetState.GearStart, isOneoff = true, persistent = true, area_id = 7 },
	{ config_id = 127007, gadget_id = 70360001, pos = { x = -318.198, y = 200.236, z = -639.330 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 32, area_id = 7 },
	{ config_id = 127013, gadget_id = 70211021, pos = { x = -314.952, y = 200.106, z = -639.512 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗高级璃月", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 7 }
}
