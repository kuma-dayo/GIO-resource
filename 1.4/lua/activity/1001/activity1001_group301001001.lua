...
-- 装置
gadgets = {
	{ config_id = 1006, gadget_id = 70211001, pos = { x = 2772.368, y = 196.899, z = -1733.203 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "战斗低级蒙德", showcutscene = true, isOneoff = true, type = GadgetType.GADGET_WORLD_CHECT }
}
