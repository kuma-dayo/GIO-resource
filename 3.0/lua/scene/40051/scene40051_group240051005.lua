...
-- 怪物
monsters = {
	{ config_id = 5005, monster_id = 26090801, pos = { x = 436.066, y = 101.842, z = 454.665 }, rot = { x = 0.000, y = 170.300, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 5006, monster_id = 26090801, pos = { x = 439.303, y = 102.287, z = 451.375 }, rot = { x = 0.000, y = 251.897, z = 0.000 }, level = 1, pose_id = 101 },
	{ config_id = 5007, monster_id = 26090401, pos = { x = 439.649, y = 101.691, z = 454.343 }, rot = { x = 0.000, y = 230.571, z = 0.000 }, level = 1, pose_id = 101 }
}
