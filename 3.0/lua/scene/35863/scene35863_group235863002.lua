...
points = {
	...
	{ config_id = 2007, pos = { x = 521.580, y = 103.815, z = 363.136 }, rot = { x = 0.000, y = 314.612, z = 0.000 }, tag = 1 },
	...
	{ config_id = 2011, pos = { x = 512.562, y = 103.677, z = 370.046 }, rot = { x = 0.000, y = 48.975, z = 0.000 }, tag = 4 },
