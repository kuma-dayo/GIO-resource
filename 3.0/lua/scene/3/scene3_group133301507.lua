...
gadgets = {
	...
	{ config_id = 507007, gadget_id = 70290008, pos = { x = -98.197, y = 53.373, z = 3852.761 }, rot = { x = 0.000, y = 355.392, z = 0.000 }, level = 27, area_id = 22 },
	{ config_id = 507008, gadget_id = 70500000, pos = { x = -98.197, y = 53.373, z = 3852.761 }, rot = { x = 0.000, y = 355.391, z = 0.000 }, level = 27, point_type = 3008, owner = 507007, area_id = 22 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 507001, 507002, 507003, 507004, 507005, 507006, 507007, 507008 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
