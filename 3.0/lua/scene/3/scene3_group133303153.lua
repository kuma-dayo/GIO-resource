...
regions = {
	...
	-- 靠近涂鸦注目
	{ config_id = 153019, shape = RegionShape.SPHERE, radius = 5, pos = { x = -1357.048, y = 261.021, z = 3307.545 }, area_id = 23 }
}
...
triggers = {
	...
	-- 全亮则创suite2
	{ config_id = 1153018, name = "GROUP_LOAD_153018", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_153018", action = "action_EVENT_GROUP_LOAD_153018" },
	-- 靠近涂鸦注目
...
suites = {
	{
		...
		regions = { 153019 },
		triggers = { "VARIABLE_CHANGE_153010", "VARIABLE_CHANGE_153011", "VARIABLE_CHANGE_153012", "VARIABLE_CHANGE_153013", "VARIABLE_CHANGE_153014", "VARIABLE_CHANGE_153015", "VARIABLE_CHANGE_153016", "GADGET_STATE_CHANGE_153017", "GROUP_LOAD_153018", "ENTER_REGION_153019" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
