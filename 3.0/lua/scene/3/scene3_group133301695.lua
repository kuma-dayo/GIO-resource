...
-- 装置
gadgets = {
	[695002] = { config_id = 695002, gadget_id = 70360001, pos = { x = -579.428, y = 143.740, z = 3388.698 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, area_id = 22 }
}
...
-- 点位
points = {
	[695001] = { config_id = 695001, pos = { x = -596.800, y = 168.588, z = 3375.531 }, rot = { x = 0.000, y = 88.995, z = 0.000 }, area_id = 22 }
}
