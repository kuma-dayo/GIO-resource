...
-- 装置
gadgets = {
	{ config_id = 424001, gadget_id = 70211101, pos = { x = -1783.044, y = 232.528, z = 2963.635 }, rot = { x = 0.000, y = 98.146, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 },
