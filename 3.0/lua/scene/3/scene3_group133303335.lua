...
monsters = {
	...
	{ config_id = 335004, monster_id = 25310201, pos = { x = -1907.005, y = 243.777, z = 3359.017 }, rot = { x = 0.000, y = 170.584, z = 0.000 }, level = 30, drop_tag = "中级镀金旅团", disableWander = true, pose_id = 9003, area_id = 23 },
	{ config_id = 335005, monster_id = 25310101, pos = { x = -1903.543, y = 243.767, z = 3363.365 }, rot = { x = 0.000, y = 225.076, z = 0.000 }, level = 30, drop_tag = "中级镀金旅团", disableWander = true, pose_id = 9005, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 335002, gadget_id = 70211012, pos = { x = -1902.503, y = 243.790, z = 3361.476 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
