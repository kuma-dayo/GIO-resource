...
suites = {
	{
		...
		gadgets = { 58001, 58017 },
		regions = { 58006 },
		triggers = { "GADGET_STATE_CHANGE_58004", "QUEST_START_58005", "ENTER_REGION_58006", "QUEST_START_58007", "QUEST_START_58008", "QUEST_START_58011", "QUEST_FINISH_58014", "QUEST_FINISH_58015", "GADGET_STATE_CHANGE_58016", "SELECT_OPTION_58018" },
		rand_weight = 100
	}
}
...
function action_EVENT_QUEST_FINISH_58014(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133303058, EntityType.GADGET, 58017 ) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : remove_gadget_by_configid")
			return -1
		end
