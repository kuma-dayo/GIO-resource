...
-- 触发器
triggers = {
	{ config_id = 1266002, name = "GADGET_STATE_CHANGE_266002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "266001", condition = "condition_EVENT_GADGET_STATE_CHANGE_266002", action = "action_EVENT_GADGET_STATE_CHANGE_266002" }
}
