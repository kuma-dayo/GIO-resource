...
triggers = {
	...
	-- 核心消失任务完成
	{ config_id = 1214023, name = "ANY_GADGET_DIE_214023", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_214023", action = "action_EVENT_ANY_GADGET_DIE_214023" },
	-- 节点死对应特效消失
...
suites = {
	{
		...
		regions = { },
		triggers = { "GROUP_REFRESH_214009", "LUA_NOTIFY_214010", "ANY_GADGET_DIE_214023", "ANY_GADGET_DIE_214024", "ANY_GADGET_DIE_214025", "ANY_GADGET_DIE_214026" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_214023(context, evt)
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_214023(context, evt)
