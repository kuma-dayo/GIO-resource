...
-- 怪物
monsters = {
	{ config_id = 176001, monster_id = 24021101, pos = { x = -905.582, y = -5.537, z = 3143.241 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, affix = { 5182, 5183, 5184 }, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 176002, gadget_id = 70360001, pos = { x = -908.549, y = -5.524, z = 3133.614 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 176004, gadget_id = 70211001, pos = { x = -907.838, y = -5.634, z = 3127.231 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
