...
-- 怪物
monsters = {
	{ config_id = 295001, monster_id = 26090901, pos = { x = 112.832, y = 131.055, z = 3045.477 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "蕈兽", pose_id = 101, area_id = 20 },
	{ config_id = 295002, monster_id = 26090901, pos = { x = 117.726, y = 130.158, z = 3044.573 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "蕈兽", pose_id = 101, area_id = 20 }
}
