...
gadgets = {
	...
	{ config_id = 361005, gadget_id = 70290010, pos = { x = -721.941, y = 222.339, z = 3540.536 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, area_id = 22 },
	{ config_id = 361006, gadget_id = 70500000, pos = { x = -721.941, y = 222.339, z = 3540.536 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 3006, owner = 361005, area_id = 22 }
}
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_361004(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_361004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301361, suite = 2 }) then
