...
-- 怪物
monsters = {
	{ config_id = 632001, monster_id = 25210301, pos = { x = -408.790, y = 277.380, z = 3999.000 }, rot = { x = 0.000, y = 143.613, z = 0.000 }, level = 33, drop_tag = "镀金旅团", disableWander = true, affix = { 4180 }, pose_id = 9002, area_id = 22 }
}
