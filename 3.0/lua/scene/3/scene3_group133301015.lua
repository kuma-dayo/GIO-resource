...
-- 怪物
monsters = {
	{ config_id = 15004, monster_id = 25210501, pos = { x = -446.625, y = 225.421, z = 3423.795 }, rot = { x = 0.000, y = 277.683, z = 0.000 }, level = 1, drop_tag = "镀金旅团", disableWander = true, pose_id = 9503, area_id = 22 },
	{ config_id = 15005, monster_id = 25310201, pos = { x = -448.085, y = 224.756, z = 3429.679 }, rot = { x = 0.000, y = 206.456, z = 0.000 }, level = 1, drop_tag = "中级镀金旅团", disableWander = true, pose_id = 1, area_id = 22 },
...
-- 装置
gadgets = {
	{ config_id = 15001, gadget_id = 70310009, pos = { x = -451.351, y = 224.588, z = 3432.491 }, rot = { x = 3.761, y = 333.772, z = 4.886 }, level = 33, area_id = 22 },
	{ config_id = 15002, gadget_id = 70211002, pos = { x = -456.383, y = 224.966, z = 3429.114 }, rot = { x = 353.747, y = 139.136, z = 2.634 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 22 },
	...
	{ config_id = 15018, gadget_id = 70210101, pos = { x = -446.456, y = 225.886, z = 3422.723 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 15019, gadget_id = 70210101, pos = { x = -454.374, y = 224.728, z = 3440.522 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 22 },
...
suites = {
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_15003", "ANY_MONSTER_DIE_15011" },
		rand_weight = 100
	}
}
