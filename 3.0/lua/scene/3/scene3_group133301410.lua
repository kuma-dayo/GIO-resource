...
monsters = {
	...
	{ config_id = 410005, monster_id = 25310201, pos = { x = -857.088, y = 218.575, z = 3258.036 }, rot = { x = 0.000, y = 96.192, z = 0.000 }, level = 30, drop_tag = "中级镀金旅团", pose_id = 9002, area_id = 23 },
	{ config_id = 410006, monster_id = 25020201, pos = { x = -838.451, y = 213.902, z = 3268.537 }, rot = { x = 0.000, y = 207.783, z = 0.000 }, level = 30, drop_tag = "盗宝团", pose_id = 9005, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 410007, gadget_id = 70310004, pos = { x = -836.123, y = 214.164, z = 3268.261 }, rot = { x = 339.334, y = 0.808, z = 4.669 }, level = 30, state = GadgetState.GearStart, area_id = 23 }
}
