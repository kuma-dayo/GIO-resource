...
triggers = {
	...
	{ config_id = 1309013, name = "SELECT_OPTION_309013", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_309013", action = "action_EVENT_SELECT_OPTION_309013" }
}
...
function action_EVENT_SELECT_OPTION_309013(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=597.5055, y=145.0007, z=2501.604}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=597.5055, y=145.0007, z=2501.604}
