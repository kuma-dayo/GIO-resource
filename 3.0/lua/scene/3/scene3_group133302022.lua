...
triggers = {
	...
	{ config_id = 1022025, name = "GROUP_LOAD_22025", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_22025", action = "action_EVENT_GROUP_LOAD_22025" }
}
