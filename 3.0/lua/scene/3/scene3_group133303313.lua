...
gadgets = {
	...
	[313004] = { config_id = 313004, gadget_id = 70310440, pos = { x = -1222.996, y = 244.411, z = 3541.647 }, rot = { x = 0.000, y = 291.024, z = 0.000 }, level = 30, persistent = true, area_id = 23 }
}
...
triggers = {
	...
	-- G键触发
	{ config_id = 1313012, name = "ENTER_REGION_313012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_313012", action = "action_EVENT_ENTER_REGION_313012" }
}
