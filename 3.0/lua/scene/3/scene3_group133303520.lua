...
monsters = {
	...
	{ config_id = 520003, monster_id = 28050106, pos = { x = -1509.198, y = 182.587, z = 3434.816 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 520005, gadget_id = 70217020, pos = { x = -1509.343, y = 182.651, z = 3434.775 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
