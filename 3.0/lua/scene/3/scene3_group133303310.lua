...
gadgets = {
	...
	{ config_id = 310003, gadget_id = 70211002, pos = { x = -1493.225, y = 127.766, z = 3372.684 }, rot = { x = 0.000, y = 303.471, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_310004(context, evt)
	-- 将configid为 310003 的物件更改为状态 GadgetState.ChestLocked
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 310003, GadgetState.ChestLocked) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
