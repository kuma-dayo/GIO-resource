...
gadgets = {
	...
	{ config_id = 348002, gadget_id = 70330199, pos = { x = -574.423, y = 210.570, z = 2990.327 }, rot = { x = 6.948, y = 354.310, z = 353.103 }, level = 27, state = GadgetState.GearStop, isOneoff = true, area_id = 24 }
}
...
suites = {
	{
		...
		gadgets = { 348002 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_348003" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
