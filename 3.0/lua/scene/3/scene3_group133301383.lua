...
-- 触发器
triggers = {
	{ config_id = 1383014, name = "ENTER_REGION_383014", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_383014", action = "action_EVENT_ENTER_REGION_383014", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 383001, 383002, 383007, 383008, 383011, 383012, 383013 },
		regions = { 383014 },
