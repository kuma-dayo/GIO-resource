...
-- 装置
gadgets = {
	{ config_id = 525005, gadget_id = 70217020, pos = { x = -574.747, y = 133.395, z = 3416.691 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 22 },
