...
-- 装置
gadgets = {
	{ config_id = 52001, gadget_id = 70310001, pos = { x = -1455.394, y = 135.000, z = 2532.456 }, rot = { x = 0.000, y = 330.613, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 52002, gadget_id = 70310001, pos = { x = -1445.928, y = 138.303, z = 2523.938 }, rot = { x = 0.000, y = 236.597, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 52003, gadget_id = 70310001, pos = { x = -1442.104, y = 137.692, z = 2527.893 }, rot = { x = 0.000, y = 54.101, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 52004, gadget_id = 70310001, pos = { x = -1450.371, y = 136.726, z = 2536.144 }, rot = { x = 0.000, y = 306.780, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 52005, gadget_id = 70360001, pos = { x = -1447.281, y = 137.012, z = 2533.597 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 52006, gadget_id = 70211131, pos = { x = -1445.792, y = 137.404, z = 2530.012 }, rot = { x = 5.818, y = 280.478, z = 358.809 }, level = 26, drop_tag = "解谜超级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_52007", "VARIABLE_CHANGE_52008", "VARIABLE_CHANGE_52009", "VARIABLE_CHANGE_52010", "GADGET_STATE_CHANGE_52011", "GROUP_LOAD_52012" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_VARIABLE_CHANGE_52010(context, evt)
	...
	if 0 ~= ScriptLib.AddQuestProgress(context, "133304052") then
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_52011(context, evt)
	if 52006 ~= evt.param2 or GadgetState.ChestOpened ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_52011(context, evt)
