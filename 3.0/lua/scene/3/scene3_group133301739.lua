...
gadgets = {
	...
	{ config_id = 739003, gadget_id = 70710007, pos = { x = -239.821, y = 277.665, z = 3476.046 }, rot = { x = 18.820, y = 251.518, z = 357.428 }, level = 27, area_id = 29 },
	{ config_id = 739010, gadget_id = 70230111, pos = { x = -242.964, y = 276.941, z = 3474.735 }, rot = { x = 3.305, y = 74.345, z = 70.845 }, level = 27, area_id = 29 }
}

-- 区域
regions = {
	{ config_id = 739007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -244.640, y = 266.191, z = 3479.992 }, area_id = 29 }
}
...
garbages = {
	gadgets = {
		{ config_id = 739001, gadget_id = 70710006, pos = { x = -257.757, y = 266.266, z = 3493.075 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 29 },
...
function condition_EVENT_GADGET_STATE_CHANGE_739008(context, evt)
	if 739010 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
function action_EVENT_GADGET_STATE_CHANGE_739008(context, evt)
	...
	if 0 ~= ScriptLib.ChangeGroupVariableValueByGroup(context, "count", 1, 133301741) then
...
function condition_EVENT_GADGET_CREATE_739009(context, evt)
	if 739010 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 0, evt.param1) then
		return false
	end
...
function action_EVENT_GADGET_CREATE_739009(context, evt)
	-- 将configid为 739010 的物件更改为状态 GadgetState.GearAction1
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 739010, GadgetState.GearAction1) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
