...
-- 装置
gadgets = {
	{ config_id = 89002, gadget_id = 70330199, pos = { x = -922.732, y = 363.413, z = 3160.220 }, rot = { x = 0.012, y = 234.410, z = 0.008 }, level = 30, state = GadgetState.GearStop, area_id = 23 },
	{ config_id = 89004, gadget_id = 70217020, pos = { x = -923.667, y = 363.518, z = 3159.914 }, rot = { x = 346.282, y = 248.419, z = 344.730 }, level = 26, drop_tag = "摩拉石箱须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
