...
-- 装置
gadgets = {
	{ config_id = 200001, gadget_id = 70330216, pos = { x = -1333.553, y = 292.038, z = 3255.932 }, rot = { x = 4.102, y = 122.646, z = 2.513 }, level = 30, state = GadgetState.GearStop, persistent = true, area_id = 23 },
