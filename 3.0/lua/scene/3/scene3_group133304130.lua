...
monsters = {
	...
	{ config_id = 130012, monster_id = 21010201, pos = { x = -1092.628, y = 224.787, z = 2884.464 }, rot = { x = 0.000, y = 66.110, z = 0.000 }, level = 30, drop_tag = "丘丘人", area_id = 21 },
	{ config_id = 130013, monster_id = 21010201, pos = { x = -1093.869, y = 224.638, z = 2887.615 }, rot = { x = 0.000, y = 74.360, z = 0.000 }, level = 30, drop_tag = "丘丘人", area_id = 21 },
	{ config_id = 130015, monster_id = 21010501, pos = { x = -1120.941, y = 232.583, z = 2884.299 }, rot = { x = 0.000, y = 81.441, z = 0.000 }, level = 30, drop_tag = "远程丘丘人", area_id = 21 },
	...
	{ config_id = 130017, monster_id = 21011001, pos = { x = -1116.528, y = 232.573, z = 2882.855 }, rot = { x = 0.000, y = 25.034, z = 0.000 }, level = 30, drop_tag = "远程丘丘人", area_id = 21 }
}
...
triggers = {
	...
	{ config_id = 1130008, name = "MONSTER_BATTLE_130008", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_130008", action = "action_EVENT_MONSTER_BATTLE_130008", trigger_count = 0 },
...
suites = {
	{
		...
		regions = { 130005 },
		triggers = { "ENTER_REGION_130005", "MONSTER_BATTLE_130008", "ANY_MONSTER_DIE_130014" },
		rand_weight = 100
	}
}
...
function action_EVENT_ENTER_REGION_130005(context, evt)
	...
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 130016, delay_time = 0 }) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : create_monster")
	  return -1
	end
...
-- 触发条件
function condition_EVENT_MONSTER_BATTLE_130008(context, evt)
