...
gadgets = {
	...
	{ config_id = 48005, gadget_id = 70210101, pos = { x = 479.032, y = 229.080, z = 2336.913 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 48007, gadget_id = 70210101, pos = { x = 476.642, y = 228.640, z = 2328.316 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 20 }
}
