...
triggers = {
	...
	{ config_id = 1046007, name = "GROUP_LOAD_46007", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_46007", action = "action_EVENT_GROUP_LOAD_46007" },
	{ config_id = 1046008, name = "GROUP_LOAD_46008", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_46008", action = "action_EVENT_GROUP_LOAD_46008" }
}
...
suites = {
	...
	},
	{
		...
		gadgets = { 46002 },
		regions = { },
		triggers = { "SELECT_OPTION_46003", "GADGET_STATE_CHANGE_46006", "GROUP_LOAD_46007", "GROUP_LOAD_46008" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function condition_EVENT_GROUP_LOAD_46008(context, evt)
	-- 判断变量"dug"为1
	if ScriptLib.GetGroupVariableValue(context, "dug") ~= 1 then
			return false
	end
