...
gadgets = {
	...
	{ config_id = 87007, gadget_id = 70210101, pos = { x = -1092.824, y = 208.678, z = 3518.955 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 },
