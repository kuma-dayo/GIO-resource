...
-- 怪物
monsters = {
	{ config_id = 131001, monster_id = 25210501, pos = { x = -537.814, y = 202.794, z = 2946.812 }, rot = { x = 0.000, y = 212.404, z = 0.000 }, level = 27, drop_tag = "镀金旅团", disableWander = true, pose_id = 9504, area_id = 24 },
	{ config_id = 131004, monster_id = 28061201, pos = { x = -525.157, y = 200.016, z = 2931.131 }, rot = { x = 0.000, y = 128.517, z = 0.000 }, level = 27, drop_tag = "驮兽盗宝团", pose_id = 1, area_id = 24 },
	...
	{ config_id = 131007, monster_id = 25210401, pos = { x = -536.522, y = 202.475, z = 2936.755 }, rot = { x = 0.000, y = 252.796, z = 0.000 }, level = 27, drop_tag = "镀金旅团", area_id = 24 }
}
