...
-- 装置
gadgets = {
	{ config_id = 52002, gadget_id = 70211012, pos = { x = -615.465, y = 183.454, z = 3615.097 }, rot = { x = 5.345, y = 90.686, z = 0.955 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 22 },
	...
	{ config_id = 52010, gadget_id = 70300107, pos = { x = -617.831, y = 176.998, z = 3609.040 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, state = GadgetState.GearStart, area_id = 22 },
	...
	{ config_id = 52030, gadget_id = 70330197, pos = { x = -600.515, y = 169.883, z = 3590.873 }, rot = { x = 0.000, y = 277.777, z = 0.000 }, level = 33, area_id = 22 }
}
...
triggers = {
	...
	{ config_id = 1052025, name = "MONSTER_BATTLE_52025", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_52025", action = "action_EVENT_MONSTER_BATTLE_52025", trigger_count = 0 },
	{ config_id = 1052026, name = "MONSTER_BATTLE_52026", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_52026", action = "action_EVENT_MONSTER_BATTLE_52026", trigger_count = 0 }
}
