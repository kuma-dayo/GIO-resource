...
triggers = {
	...
	{ config_id = 1264004, name = "GADGET_STATE_CHANGE_264004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "264003", condition = "condition_EVENT_GADGET_STATE_CHANGE_264004", action = "action_EVENT_GADGET_STATE_CHANGE_264004" }
}
