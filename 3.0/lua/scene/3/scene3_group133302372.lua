...
gadgets = {
	...
	{ config_id = 372008, gadget_id = 70211002, pos = { x = -757.998, y = 213.986, z = 2789.405 }, rot = { x = 353.670, y = 148.058, z = 3.933 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 }
}
