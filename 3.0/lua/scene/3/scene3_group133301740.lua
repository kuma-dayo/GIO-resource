...
gadgets = {
	...
	{ config_id = 740003, gadget_id = 70710007, pos = { x = -243.748, y = 278.983, z = 3469.798 }, rot = { x = 25.953, y = 341.198, z = 340.182 }, level = 27, area_id = 29 },
	{ config_id = 740010, gadget_id = 70230111, pos = { x = -244.998, y = 277.318, z = 3472.508 }, rot = { x = 336.422, y = 165.773, z = 87.559 }, level = 27, area_id = 29 }
}

-- 区域
regions = {
	{ config_id = 740007, shape = RegionShape.SPHERE, radius = 5, pos = { x = -238.124, y = 264.681, z = 3483.801 }, area_id = 29 }
}
...
garbages = {
	gadgets = {
		{ config_id = 740001, gadget_id = 70710006, pos = { x = -254.925, y = 265.925, z = 3496.363 }, rot = { x = 0.000, y = 249.075, z = 0.000 }, level = 27, area_id = 29 },
...
function condition_EVENT_GADGET_STATE_CHANGE_740008(context, evt)
	if 740010 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
function condition_EVENT_GADGET_CREATE_740009(context, evt)
	if 740010 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 0, evt.param1) then
		return false
	end
