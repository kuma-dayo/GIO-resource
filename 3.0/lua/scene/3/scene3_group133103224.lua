...
gadgets = {
	...
	{ config_id = 224011, gadget_id = 70210101, pos = { x = 101.869, y = 296.855, z = 1733.596 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用璃月", isOneoff = true, persistent = true, area_id = 6 },
	{ config_id = 224012, gadget_id = 70210101, pos = { x = 125.480, y = 295.513, z = 1739.760 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用璃月", isOneoff = true, persistent = true, area_id = 6 },
