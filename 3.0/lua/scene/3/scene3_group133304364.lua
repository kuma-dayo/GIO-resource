...
-- 装置
gadgets = {
	{ config_id = 364001, gadget_id = 70900050, pos = { x = -1525.808, y = 203.195, z = 2748.766 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, persistent = true, area_id = 21 },
	{ config_id = 364002, gadget_id = 70900050, pos = { x = -1462.154, y = 205.553, z = 2729.744 }, rot = { x = 354.829, y = 348.659, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	...
	{ config_id = 364012, gadget_id = 70211101, pos = { x = -1530.458, y = 203.947, z = 2752.190 }, rot = { x = 0.000, y = 21.140, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
