...
gadgets = {
	...
	-- 恒素果交互
	{ config_id = 126016, gadget_id = 70360001, pos = { x = -1296.361, y = 256.700, z = 1861.950 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "QUEST_START_126001", "QUEST_START_126005", "QUEST_START_126007", "GADGET_STATE_CHANGE_126009", "QUEST_START_126012", "GADGET_STATE_CHANGE_126013", "QUEST_FINISH_126014", "QUEST_FINISH_126015", "SELECT_OPTION_126017" },
		rand_weight = 100
	}
}
...
function action_EVENT_QUEST_FINISH_126015(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133304126, EntityType.GADGET, 126016 ) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : remove_gadget_by_configid")
			return -1
		end
