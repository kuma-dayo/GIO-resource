...
-- 怪物
monsters = {
	[233002] = { config_id = 233002, monster_id = 26120301, pos = { x = -357.161, y = 107.499, z = 2259.652 }, rot = { x = 0.000, y = 284.847, z = 0.000 }, level = 33, drop_tag = "大蕈兽", affix = { 6116, 6117 }, isElite = true, pose_id = 101, area_id = 24, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
