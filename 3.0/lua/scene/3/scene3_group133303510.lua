...
gadgets = {
	...
	{ config_id = 510002, gadget_id = 70211150, pos = { x = -1868.055, y = 181.191, z = 3147.543 }, rot = { x = 0.000, y = 82.985, z = 0.000 }, level = 26, chest_drop_id = 21910067, drop_count = 1, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
