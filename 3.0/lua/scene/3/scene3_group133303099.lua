...
-- 怪物
monsters = {
	{ config_id = 99001, monster_id = 23010401, pos = { x = -1095.538, y = 264.769, z = 3913.302 }, rot = { x = 0.000, y = 33.893, z = 0.000 }, level = 30, drop_tag = "先遣队", pose_id = 9011, area_id = 23 },
...
gadgets = {
	...
	{ config_id = 99012, gadget_id = 70210101, pos = { x = -1107.140, y = 264.469, z = 3942.790 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 },
	{ config_id = 99013, gadget_id = 70210101, pos = { x = -1091.003, y = 272.619, z = 3929.245 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 23 }
}
