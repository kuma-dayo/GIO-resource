...
-- 怪物
monsters = {
	{ config_id = 291001, monster_id = 22050101, pos = { x = -793.614, y = 181.666, z = 3728.290 }, rot = { x = 0.000, y = 195.650, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 101, area_id = 23 },
	{ config_id = 291007, monster_id = 22040101, pos = { x = -797.898, y = 181.564, z = 3725.405 }, rot = { x = 0.000, y = 115.555, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 101, area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 291008, gadget_id = 70211001, pos = { x = -800.876, y = 181.659, z = 3723.274 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
