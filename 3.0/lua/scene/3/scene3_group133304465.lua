...
-- 装置
gadgets = {
	{ config_id = 465002, gadget_id = 70211002, pos = { x = -1704.743, y = 333.489, z = 2417.792 }, rot = { x = 348.455, y = 0.641, z = 350.421 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
