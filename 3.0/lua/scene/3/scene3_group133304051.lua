...
-- 装置
gadgets = {
	{ config_id = 51001, gadget_id = 70900050, pos = { x = -1641.036, y = 457.353, z = 2113.482 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 51002, gadget_id = 70900050, pos = { x = -1649.103, y = 455.639, z = 2111.622 }, rot = { x = 0.000, y = 0.000, z = 6.820 }, level = 30, state = GadgetState.GearStop, area_id = 21 },
	{ config_id = 51003, gadget_id = 70211012, pos = { x = -1644.523, y = 456.487, z = 2111.870 }, rot = { x = 0.000, y = 0.000, z = 7.417 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
