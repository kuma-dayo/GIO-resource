...
-- 触发器
triggers = {
	{ config_id = 1137003, name = "MONSTER_BATTLE_137003", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_137003", action = "action_EVENT_MONSTER_BATTLE_137003", trigger_count = 0 }
}
...
suites = {
	{
		...
		gadgets = { 137005, 137006, 137007, 137008, 137009, 137010 },
		regions = { },
