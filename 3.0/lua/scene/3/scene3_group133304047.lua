...
gadgets = {
	...
	{ config_id = 47002, gadget_id = 70350093, pos = { x = -1493.486, y = 221.345, z = 2503.615 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 47003, gadget_id = 70360001, pos = { x = -1493.486, y = 222.370, z = 2503.615 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
...
regions = {
	-- 接取三级wq任务
	{ config_id = 47020, shape = RegionShape.SPHERE, radius = 10, pos = { x = -1493.486, y = 221.345, z = 2503.615 }, area_id = 21 }
}
