...
monsters = {
	...
	{ config_id = 581012, monster_id = 22030202, pos = { x = -722.758, y = 118.169, z = 4034.926 }, rot = { x = 0.000, y = 341.029, z = 0.000 }, level = 30, drop_tag = "深渊使徒", disableWander = true, pose_id = 101, area_id = 25 },
...
-- 装置
gadgets = {
	{ config_id = 581001, gadget_id = 70300085, pos = { x = -759.010, y = 154.967, z = 4042.018 }, rot = { x = 358.418, y = 110.151, z = 358.812 }, level = 33, area_id = 25 },
	...
	{ config_id = 581004, gadget_id = 70300085, pos = { x = -690.075, y = 136.931, z = 3752.469 }, rot = { x = 0.759, y = 257.681, z = 0.867 }, level = 33, area_id = 25 },
	...
	{ config_id = 581007, gadget_id = 70300085, pos = { x = -688.531, y = 134.464, z = 4081.516 }, rot = { x = 359.759, y = 62.311, z = 351.834 }, level = 33, area_id = 25 },
	...
	{ config_id = 581014, gadget_id = 70300085, pos = { x = -558.486, y = 152.731, z = 3840.372 }, rot = { x = 343.187, y = 116.157, z = 347.299 }, level = 33, area_id = 25 },
	...
	{ config_id = 581016, gadget_id = 70300085, pos = { x = -589.930, y = 163.279, z = 4054.440 }, rot = { x = 357.539, y = 95.120, z = 354.066 }, level = 33, area_id = 25 },
	{ config_id = 581018, gadget_id = 70300085, pos = { x = -619.585, y = 127.830, z = 3773.226 }, rot = { x = 1.747, y = 179.854, z = 343.467 }, level = 33, area_id = 25 },
	...
	{ config_id = 581020, gadget_id = 70300085, pos = { x = -649.822, y = 141.358, z = 3946.060 }, rot = { x = 1.034, y = 175.546, z = 349.605 }, level = 33, area_id = 25 },
...
triggers = {
	...
	{ config_id = 1581017, name = "GADGET_STATE_CHANGE_581017", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_581017", action = "action_EVENT_GADGET_STATE_CHANGE_581017", trigger_count = 0 },
	-- 变量=1
	{ config_id = 1581034, name = "VARIABLE_CHANGE_581034", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581034", action = "action_EVENT_VARIABLE_CHANGE_581034", trigger_count = 0 },
	-- 变量=2
	{ config_id = 1581035, name = "VARIABLE_CHANGE_581035", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581035", action = "action_EVENT_VARIABLE_CHANGE_581035", trigger_count = 0 },
	-- 变量=3
	{ config_id = 1581036, name = "VARIABLE_CHANGE_581036", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581036", action = "action_EVENT_VARIABLE_CHANGE_581036", trigger_count = 0 },
	-- 变量=4
	{ config_id = 1581037, name = "VARIABLE_CHANGE_581037", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581037", action = "action_EVENT_VARIABLE_CHANGE_581037", trigger_count = 0 },
	-- 变量=5
	{ config_id = 1581038, name = "VARIABLE_CHANGE_581038", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581038", action = "action_EVENT_VARIABLE_CHANGE_581038", trigger_count = 0 },
	-- 变量=6
	{ config_id = 1581039, name = "VARIABLE_CHANGE_581039", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581039", action = "action_EVENT_VARIABLE_CHANGE_581039", trigger_count = 0 },
	-- 变量=7
	{ config_id = 1581040, name = "VARIABLE_CHANGE_581040", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_581040", action = "action_EVENT_VARIABLE_CHANGE_581040", trigger_count = 0 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 581027, 581028, 581029, 581030, 581031, 581032, 581033 },
		regions = { },
	...
	},
	{
		...
		gadgets = { 581001, 581002, 581004, 581005, 581007, 581008, 581013, 581014, 581015, 581016, 581018, 581019, 581020, 581021, 581026 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_581011", "GADGET_STATE_CHANGE_581017", "VARIABLE_CHANGE_581034", "VARIABLE_CHANGE_581035", "VARIABLE_CHANGE_581036", "VARIABLE_CHANGE_581037", "VARIABLE_CHANGE_581038", "VARIABLE_CHANGE_581039", "VARIABLE_CHANGE_581040" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_581017(context, evt)
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581002) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581005) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581008) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581013) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581015) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581019) then
		return false
	end
	
	if GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, 133301581, 581021) then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_581017(context, evt)
	-- 延迟0秒刷怪
