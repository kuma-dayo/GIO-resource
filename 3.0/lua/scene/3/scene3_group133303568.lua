...
-- 装置
gadgets = {
	{ config_id = 568002, gadget_id = 70330199, pos = { x = -1437.588, y = 274.057, z = 3766.301 }, rot = { x = 3.024, y = 0.448, z = 8.435 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
