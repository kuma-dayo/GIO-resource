...
-- 装置
gadgets = {
	{ config_id = 11001, gadget_id = 70330218, pos = { x = -150.925, y = 251.707, z = 3527.725 }, rot = { x = 11.353, y = 283.404, z = 1.458 }, level = 27, area_id = 29 },
	{ config_id = 11002, gadget_id = 70310199, pos = { x = -170.995, y = 243.593, z = 3525.193 }, rot = { x = 0.000, y = 77.598, z = 0.000 }, level = 27, area_id = 29 },
	{ config_id = 11008, gadget_id = 70211001, pos = { x = -150.227, y = 252.356, z = 3527.376 }, rot = { x = 0.763, y = 297.121, z = 4.970 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 29 }
}
...
-- 触发器
triggers = {
	{ config_id = 1011007, name = "ANY_GADGET_DIE_11007", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_11007", action = "action_EVENT_ANY_GADGET_DIE_11007", trigger_count = 0 },
	{ config_id = 1011009, name = "ANY_MONSTER_DIE_11009", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_11009", action = "action_EVENT_ANY_MONSTER_DIE_11009", trigger_count = 0 }
}
