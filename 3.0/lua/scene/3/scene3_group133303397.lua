...
-- 装置
gadgets = {
	{ config_id = 397008, gadget_id = 70211001, pos = { x = -1122.947, y = 186.985, z = 3597.405 }, rot = { x = 0.000, y = 263.644, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
-- 触发器
triggers = {
	{ config_id = 1397009, name = "ANY_GADGET_DIE_397009", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_397009", action = "action_EVENT_ANY_GADGET_DIE_397009" }
}
...
suites = {
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "ANY_GADGET_DIE_397009" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_397009(context, evt)
	-- 判断剩余怪物数量是否是0
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_397009(context, evt)
	-- 创建id为397008的gadget
	if 0 ~= ScriptLib.CreateGadget(context, { config_id = 397008 }) then
