...
-- 触发器
triggers = {
	{ config_id = 1034002, name = "QUEST_FINISH_34002", event = EventType.EVENT_QUEST_FINISH, source = "7306634", condition = "", action = "action_EVENT_QUEST_FINISH_34002", trigger_count = 0 },
