...
-- 怪物
monsters = {
	{ config_id = 368001, monster_id = 20010401, pos = { x = -801.240, y = 220.786, z = 2573.609 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "大史莱姆", area_id = 24 },
...
-- 装置
gadgets = {
	{ config_id = 368005, gadget_id = 70217020, pos = { x = -794.358, y = 211.602, z = 2560.526 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 24 }
}

-- 区域
regions = {
	{ config_id = 368006, shape = RegionShape.SPHERE, radius = 5, pos = { x = -794.292, y = 212.660, z = 2560.696 }, area_id = 24 }
}
