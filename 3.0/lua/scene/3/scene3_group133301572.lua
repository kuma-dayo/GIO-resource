...
-- 点位
points = {
	[572005] = { config_id = 572005, pos = { x = -619.062, y = -41.145, z = 3775.760 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, area_id = 25 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_572004", "GADGET_STATE_CHANGE_572007" },
		rand_weight = 100
	}
}
...
function action_EVENT_GADGET_STATE_CHANGE_572004(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-563.531, y=-37.57143, z=3824.91}，持续时间为1.5秒，并且为强制注目形式，不广播其他玩家
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_572007(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_572007(context, evt)
