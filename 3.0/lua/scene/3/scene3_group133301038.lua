...
gadgets = {
	...
	[38040] = { config_id = 38040, gadget_id = 72000026, pos = { x = -679.007, y = -150.389, z = 4034.530 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, area_id = 25 },
	-- 防止玩家在终战的时候跑出去
...
regions = {
	...
	-- 戴冠Region
	[38033] = { config_id = 38033, shape = RegionShape.SPHERE, radius = 50, pos = { x = -679.548, y = -150.387, z = 4034.548 }, area_id = 25, team_ability_group_list = { "ActivityAbility_ForestWQ_AssistAttack" } }
}
