...
monsters = {
	...
	{ config_id = 291006, monster_id = 28020301, pos = { x = 58.422, y = 366.334, z = 2153.679 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "走兽", area_id = 20 },
	...
	{ config_id = 291008, monster_id = 28020313, pos = { x = -1.517, y = 403.135, z = 2066.858 }, rot = { x = 0.000, y = 279.129, z = 0.000 }, level = 27, drop_tag = "走兽", disableWander = true, area_id = 20 }
}
