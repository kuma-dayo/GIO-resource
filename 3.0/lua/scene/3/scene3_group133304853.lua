...
-- 怪物
monsters = {
	{ config_id = 853001, monster_id = 26120301, pos = { x = -1473.335, y = 135.000, z = 2560.270 }, rot = { x = 0.000, y = 285.251, z = 0.000 }, level = 30, drop_tag = "大蕈兽", isOneoff = true, pose_id = 104, area_id = 21 },
	{ config_id = 853006, monster_id = 26120101, pos = { x = -1477.425, y = 135.229, z = 2566.338 }, rot = { x = 0.000, y = 168.680, z = 0.000 }, level = 30, drop_tag = "大蕈兽", isOneoff = true, pose_id = 104, area_id = 21 },
	{ config_id = 853007, monster_id = 26120201, pos = { x = -1482.995, y = 135.180, z = 2560.959 }, rot = { x = 0.000, y = 45.397, z = 0.000 }, level = 30, drop_tag = "大蕈兽", isOneoff = true, pose_id = 104, area_id = 21 }
}
...
function condition_EVENT_ANY_MONSTER_DIE_853003(context, evt)
	--判断死亡怪物的configid是否为 853001
	if evt.param1 ~= 853001 then
	    return false
	 end
