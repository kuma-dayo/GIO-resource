...
-- 装置
gadgets = {
	{ config_id = 454001, gadget_id = 70211102, pos = { x = -1899.612, y = 53.965, z = 3185.967 }, rot = { x = 0.000, y = 17.287, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
