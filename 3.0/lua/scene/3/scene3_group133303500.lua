...
-- 装置
gadgets = {
	{ config_id = 500002, gadget_id = 70211002, pos = { x = -1751.971, y = 330.624, z = 3702.708 }, rot = { x = 0.000, y = 81.485, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
