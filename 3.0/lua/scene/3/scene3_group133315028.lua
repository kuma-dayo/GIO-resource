...
-- 触发器
triggers = {
	{ config_id = 1028001, name = "GADGET_CREATE_28001", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_28001", action = "action_EVENT_GADGET_CREATE_28001" },
...
suites = {
	...
	},
	{
		...
		regions = { },
		triggers = { "GADGET_CREATE_28001", "ANY_MONSTER_DIE_28004" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_28001(context, evt)
	if 28017 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_28001(context, evt)
