...
-- 装置
gadgets = {
	{ config_id = 375005, gadget_id = 70330197, pos = { x = -883.983, y = 213.005, z = 3007.934 }, rot = { x = 0.000, y = 313.935, z = 0.000 }, level = 27, area_id = 23 },
	{ config_id = 375006, gadget_id = 70330197, pos = { x = -882.105, y = 209.363, z = 2971.368 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 23 }
}
