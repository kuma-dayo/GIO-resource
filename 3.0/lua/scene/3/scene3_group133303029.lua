...
gadgets = {
	...
	{ config_id = 29012, gadget_id = 70220020, pos = { x = -1814.443, y = -8.190, z = 3211.060 }, rot = { x = 0.000, y = 30.388, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 29013, gadget_id = 70220020, pos = { x = -1815.967, y = -7.627, z = 3208.884 }, rot = { x = 0.000, y = 30.388, z = 0.000 }, level = 30, area_id = 23 }
}
...
suites = {
	...
	},
	{
		...
		-- description = ,
		monsters = { 29001 },
		gadgets = { 29008, 29009, 29010, 29011, 29012, 29013 },
		regions = { },
