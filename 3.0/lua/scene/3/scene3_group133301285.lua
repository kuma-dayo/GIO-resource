...
-- 怪物
monsters = {
	{ config_id = 285001, monster_id = 26120101, pos = { x = -734.597, y = 299.831, z = 3270.384 }, rot = { x = 0.000, y = 293.804, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, pose_id = 103, area_id = 23 },
	{ config_id = 285007, monster_id = 26120101, pos = { x = -740.542, y = 299.340, z = 3267.484 }, rot = { x = 0.000, y = 37.773, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, pose_id = 102, area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 285008, gadget_id = 70211001, pos = { x = -744.145, y = 299.868, z = 3272.026 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
