...
triggers = {
	...
	-- 变量65
	{ config_id = 1175029, name = "QUEST_START_175029", event = EventType.EVENT_QUEST_START, source = "7310012", condition = "", action = "action_EVENT_QUEST_START_175029", trigger_count = 0 },
	-- 操作台为0上按钮
