...
monsters = {
	...
	{ config_id = 85009, monster_id = 25210103, pos = { x = -571.956, y = 217.688, z = 3134.516 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, drop_tag = "镀金旅团", disableWander = true, pose_id = 9505, area_id = 22 }
}
...
-- 装置
gadgets = {
	{ config_id = 85002, gadget_id = 70211002, pos = { x = -587.267, y = 216.058, z = 3132.272 }, rot = { x = 359.606, y = 180.990, z = 354.837 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 22 },
	...
	{ config_id = 85017, gadget_id = 70210101, pos = { x = -573.981, y = 219.717, z = 3134.043 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 85018, gadget_id = 70210101, pos = { x = -577.039, y = 216.798, z = 3128.699 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 22 },
