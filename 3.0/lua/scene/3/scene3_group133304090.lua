...
npcs = {
	...
	{ config_id = 90010, npc_id = 12720, pos = { x = -1910.762, y = 203.455, z = 2553.447 }, rot = { x = 0.000, y = 186.097, z = 0.000 }, area_id = 21 },
	{ config_id = 90011, npc_id = 12720, pos = { x = -1919.866, y = 243.382, z = 2558.888 }, rot = { x = 0.000, y = 232.418, z = 0.000 }, area_id = 21 },
	{ config_id = 90012, npc_id = 12720, pos = { x = -2030.238, y = 203.380, z = 2491.867 }, rot = { x = 0.000, y = 116.045, z = 0.000 }, area_id = 21 },
	{ config_id = 90013, npc_id = 12720, pos = { x = -1887.276, y = 260.151, z = 2480.790 }, rot = { x = 0.000, y = 259.233, z = 0.000 }, area_id = 21 }
}

-- 装置
gadgets = {
	{ config_id = 90002, gadget_id = 70360286, pos = { x = -1923.182, y = 203.272, z = 2485.320 }, rot = { x = 0.000, y = 115.354, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 90018, gadget_id = 70360286, pos = { x = -1910.762, y = 203.455, z = 2553.447 }, rot = { x = 0.000, y = 186.097, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 90019, gadget_id = 70360286, pos = { x = -1919.866, y = 243.382, z = 2558.888 }, rot = { x = 0.000, y = 232.418, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 90020, gadget_id = 70360286, pos = { x = -2030.238, y = 203.380, z = 2491.867 }, rot = { x = 0.000, y = 116.045, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 90021, gadget_id = 70360286, pos = { x = -1887.275, y = 260.152, z = 2480.789 }, rot = { x = 0.000, y = 259.233, z = 0.000 }, level = 1, area_id = 21 }
}

-- 区域
regions = {
	{ config_id = 90003, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1923.182, y = 203.272, z = 2485.320 }, area_id = 21 },
	{ config_id = 90022, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1910.762, y = 203.455, z = 2553.447 }, area_id = 21 },
	{ config_id = 90028, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1919.866, y = 243.382, z = 2558.888 }, area_id = 21 },
	{ config_id = 90034, shape = RegionShape.SPHERE, radius = 23, pos = { x = -2030.238, y = 203.380, z = 2491.867 }, area_id = 21 },
	{ config_id = 90040, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1887.275, y = 260.152, z = 2480.789 }, area_id = 21 }
}
...
triggers = {
	...
	{ config_id = 1090004, name = "QUEST_START_90004", event = EventType.EVENT_QUEST_START, source = "2301204", condition = "", action = "action_EVENT_QUEST_START_90004", trigger_count = 0 },
	...
	{ config_id = 1090023, name = "QUEST_START_90023", event = EventType.EVENT_QUEST_START, source = "2301204", condition = "", action = "action_EVENT_QUEST_START_90023", trigger_count = 0 },
	...
	{ config_id = 1090029, name = "QUEST_START_90029", event = EventType.EVENT_QUEST_START, source = "2301204", condition = "", action = "action_EVENT_QUEST_START_90029", trigger_count = 0 },
	...
	{ config_id = 1090035, name = "QUEST_START_90035", event = EventType.EVENT_QUEST_START, source = "2301204", condition = "", action = "action_EVENT_QUEST_START_90035", trigger_count = 0 },
	...
	{ config_id = 1090041, name = "QUEST_START_90041", event = EventType.EVENT_QUEST_START, source = "2301204", condition = "", action = "action_EVENT_QUEST_START_90041", trigger_count = 0 },
