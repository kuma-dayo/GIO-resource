...
monsters = {
	...
	[357011] = { config_id = 357011, monster_id = 25210302, pos = { x = -1254.424, y = 243.773, z = 3727.444 }, rot = { x = 0.000, y = 238.254, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 23 },
	...
	[357013] = { config_id = 357013, monster_id = 25210302, pos = { x = -1261.761, y = 237.413, z = 3759.659 }, rot = { x = 0.000, y = 201.880, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 23 },
...
gadgets = {
	...
	[357021] = { config_id = 357021, gadget_id = 70360286, pos = { x = -1256.813, y = 248.987, z = 3724.384 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 23 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1357022, name = "GROUP_LOAD_357022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_357022", action = "action_EVENT_GROUP_LOAD_357022" },
	-- 判断父任务完成则弄死group
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_357022", "GROUP_LOAD_357023", "ENTER_REGION_357024", "CHALLENGE_SUCCESS_357026", "CHALLENGE_FAIL_357027", "LEAVE_REGION_357029", "GROUP_LOAD_357031", "CHALLENGE_SUCCESS_357035", "CHALLENGE_SUCCESS_357040", "CHALLENGE_FAIL_357047", "GROUP_LOAD_357048", "TIME_AXIS_PASS_357053" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		...
		regions = { 357034 },
		triggers = { "ANY_GADGET_DIE_357025", "SELECT_OPTION_357028", "CHALLENGE_SUCCESS_357030", "CHALLENGE_FAIL_357032", "GADGET_STATE_CHANGE_357033", "LEAVE_REGION_357034", "SELECT_OPTION_357036", "CHALLENGE_SUCCESS_357037", "LUA_NOTIFY_357038", "LUA_NOTIFY_357039", "ANY_GADGET_DIE_357041", "ANY_GADGET_DIE_357042", "ANY_GADGET_DIE_357043", "LUA_NOTIFY_357044", "LUA_NOTIFY_357045", "LUA_NOTIFY_357046" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_357023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_357023(context, evt)
	ScriptLib.SetGroupDead(context, 133303357)
...
function condition_EVENT_SELECT_OPTION_357028(context, evt)
	-- 判断是gadgetid 357021 option_id 72
...
-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_357043(context, evt)
	if 357020 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_357043(context, evt)
	-- 添加suite7的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133303357, 7)
