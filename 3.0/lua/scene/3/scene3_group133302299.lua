...
monsters = {
	...
	{ config_id = 299018, monster_id = 28030313, pos = { x = -400.176, y = 253.488, z = 2915.838 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 }
}
