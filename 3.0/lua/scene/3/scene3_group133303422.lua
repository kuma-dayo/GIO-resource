...
-- 装置
gadgets = {
	{ config_id = 422001, gadget_id = 70330238, pos = { x = -1282.462, y = 229.860, z = 3807.600 }, rot = { x = 0.000, y = 353.957, z = 0.000 }, level = 30, area_id = 23 },
	...
	{ config_id = 422006, gadget_id = 70290558, pos = { x = -1272.389, y = 231.362, z = 3808.724 }, rot = { x = 41.944, y = 322.429, z = 0.000 }, level = 30, area_id = 23 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_422003(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133303422, EntityType.GADGET, 422006 ) then
...
function action_EVENT_GROUP_LOAD_422004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133303422, suite = 2 }) then
...
function action_EVENT_GADGET_STATE_CHANGE_422005(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=-1272.389, y=231.3622, z=3808.724}，持续时间为0秒，并且为强制注目形式，不广播其他玩家
