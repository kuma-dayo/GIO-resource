...
gadgets = {
	...
	[103004] = { config_id = 103004, gadget_id = 70310440, pos = { x = -1203.500, y = 289.119, z = 2505.813 }, rot = { x = 0.000, y = 210.660, z = 0.000 }, level = 30, persistent = true, area_id = 21 }
}
...
triggers = {
	...
	-- G键触发
	{ config_id = 1103012, name = "ENTER_REGION_103012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_103012", action = "action_EVENT_ENTER_REGION_103012" }
}
