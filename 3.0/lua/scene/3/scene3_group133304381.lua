...
-- 装置
gadgets = {
	{ config_id = 381001, gadget_id = 70330235, pos = { x = -1170.833, y = 177.489, z = 2090.933 }, rot = { x = 0.310, y = 92.030, z = 1.672 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 381002, gadget_id = 70211001, pos = { x = -1177.714, y = 178.619, z = 2090.976 }, rot = { x = 0.000, y = 83.057, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_381003" },
		rand_weight = 100
	}
}
