...
gadgets = {
	...
	[104004] = { config_id = 104004, gadget_id = 70310440, pos = { x = -1069.869, y = 267.224, z = 3032.430 }, rot = { x = 0.000, y = 278.137, z = 0.000 }, level = 30, persistent = true, area_id = 23 }
}
...
triggers = {
	...
	-- 触发G
	{ config_id = 1104012, name = "ENTER_REGION_104012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_104012", action = "action_EVENT_ENTER_REGION_104012" }
}
