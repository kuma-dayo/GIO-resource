...
-- 触发器
triggers = {
	{ config_id = 1369002, name = "GADGET_STATE_CHANGE_369002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_369002", action = "action_EVENT_GADGET_STATE_CHANGE_369002" },
	{ config_id = 1369003, name = "GADGET_STATE_CHANGE_369003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_369003", action = "action_EVENT_GADGET_STATE_CHANGE_369003" }
}
