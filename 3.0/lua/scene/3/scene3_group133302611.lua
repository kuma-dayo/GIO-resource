...
gadgets = {
	...
	{ config_id = 611010, gadget_id = 70310198, pos = { x = -360.384, y = 108.339, z = 2248.617 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 24 },
	{ config_id = 611011, gadget_id = 70310198, pos = { x = -376.954, y = 103.600, z = 2266.860 }, rot = { x = 0.000, y = 191.991, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 24 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 611001, 611002, 611003, 611010, 611011 },
		regions = { 611007 },
		triggers = { "PLATFORM_REACH_POINT_611005", "AVATAR_NEAR_PLATFORM_611006", "ENTER_REGION_611007", "GADGET_STATE_CHANGE_611008", "PLATFORM_ARRIVAL_611012", "PLATFORM_ARRIVAL_611013" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { },
		gadgets = { 611001, 611004, 611010, 611011 },
		regions = { },
...
-- 触发条件
function condition_EVENT_PLATFORM_ARRIVAL_611012(context, evt)
	-- 判断是gadgetid 为 611002的移动平台，是否到达了330200013 的路线中的 3 点
	
	if 611002 ~= evt.param1 then
	  return false
	end
	
	if 330200013 ~= evt.param2 then
	  return false
	end
...
-- 触发操作
function action_EVENT_PLATFORM_ARRIVAL_611012(context, evt)
	-- 将configid为 611010 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 611010, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
-- 触发条件
function condition_EVENT_PLATFORM_ARRIVAL_611013(context, evt)
	-- 判断是gadgetid 为 611002的移动平台，是否到达了330200013 的路线中的 12 点
...
-- 触发操作
function action_EVENT_PLATFORM_ARRIVAL_611013(context, evt)
	-- 将configid为 611011 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 611011, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
