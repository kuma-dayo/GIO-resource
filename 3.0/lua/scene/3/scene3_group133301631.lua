...
-- 怪物
monsters = {
	{ config_id = 631003, monster_id = 25210302, pos = { x = -385.977, y = 282.873, z = 4015.950 }, rot = { x = 0.000, y = 359.718, z = 0.000 }, level = 33, drop_tag = "镀金旅团", disableWander = true, affix = { 4180 }, pose_id = 9007, area_id = 22 }
}
