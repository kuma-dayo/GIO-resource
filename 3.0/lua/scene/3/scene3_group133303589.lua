...
-- 装置
gadgets = {
	{ config_id = 589005, gadget_id = 70217020, pos = { x = -1792.446, y = 376.989, z = 3734.128 }, rot = { x = 0.000, y = 173.926, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
