...
gadgets = {
	...
	[121004] = { config_id = 121004, gadget_id = 70310440, pos = { x = -1369.852, y = 272.411, z = 3880.516 }, rot = { x = 0.000, y = 86.879, z = 0.000 }, level = 30, persistent = true, area_id = 23 }
}
...
triggers = {
	...
	-- G键触发
	{ config_id = 1121012, name = "ENTER_REGION_121012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_121012", action = "action_EVENT_ENTER_REGION_121012" }
}
