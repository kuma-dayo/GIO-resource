...
-- 怪物
monsters = {
	{ config_id = 417001, monster_id = 28030313, pos = { x = -699.458, y = 240.235, z = 2231.564 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	...
	{ config_id = 417003, monster_id = 28030313, pos = { x = -748.938, y = 210.692, z = 2375.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 417004, monster_id = 28030313, pos = { x = -737.763, y = 239.649, z = 2338.573 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 417005, monster_id = 28030313, pos = { x = -712.834, y = 203.713, z = 2485.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 417006, monster_id = 28030313, pos = { x = -483.625, y = 293.264, z = 2233.822 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 417007, monster_id = 28030313, pos = { x = -391.561, y = 282.564, z = 2183.290 }, rot = { x = 0.000, y = 128.205, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 417008, monster_id = 28030313, pos = { x = -628.173, y = 367.977, z = 2146.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	...
	{ config_id = 417016, monster_id = 28030313, pos = { x = -712.034, y = 203.654, z = 2484.699 }, rot = { x = 0.000, y = 63.739, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 417001, 417002, 417003, 417004, 417005, 417006, 417007, 417008, 417009, 417010, 417011, 417012, 417013, 417014, 417015, 417016, 417017 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
