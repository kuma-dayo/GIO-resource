...
-- 怪物
monsters = {
	{ config_id = 25001, monster_id = 28030313, pos = { x = -1937.249, y = 216.480, z = 3181.063 }, rot = { x = 0.000, y = 120.601, z = 0.000 }, level = 30, drop_tag = "鸟类", isOneoff = true, pose_id = 3, area_id = 23 },
	{ config_id = 25003, monster_id = 28030313, pos = { x = -1929.955, y = 214.445, z = 3178.802 }, rot = { x = 0.000, y = 307.562, z = 0.000 }, level = 30, drop_tag = "鸟类", area_id = 23 },
	{ config_id = 25004, monster_id = 28030313, pos = { x = -1941.406, y = 219.411, z = 3178.764 }, rot = { x = 0.000, y = 44.080, z = 0.000 }, level = 30, drop_tag = "鸟类", pose_id = 3, area_id = 23 }
}
