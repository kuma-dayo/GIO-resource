...
monsters = {
	...
	{ config_id = 121006, monster_id = 28060103, pos = { x = -1263.369, y = 176.500, z = 3019.512 }, rot = { x = 0.000, y = 332.036, z = 0.000 }, level = 30, drop_tag = "走兽", isOneoff = true, pose_id = 1, area_id = 21 },
	{ config_id = 121007, monster_id = 28060103, pos = { x = -1275.650, y = 176.500, z = 3019.737 }, rot = { x = 0.000, y = 340.205, z = 0.000 }, level = 30, drop_tag = "走兽", isOneoff = true, pose_id = 1, area_id = 21 },
	{ config_id = 121008, monster_id = 28060103, pos = { x = -1287.521, y = 176.500, z = 3058.012 }, rot = { x = 0.000, y = 157.702, z = 0.000 }, level = 30, drop_tag = "走兽", isOneoff = true, pose_id = 1, area_id = 21 },
	{ config_id = 121009, monster_id = 28060103, pos = { x = -1293.560, y = 176.500, z = 3057.376 }, rot = { x = 0.000, y = 126.455, z = 0.000 }, level = 30, drop_tag = "走兽", isOneoff = true, pose_id = 1, area_id = 21 },
...
suites = {
	...
	},
	{
		...
		regions = { 121004 },
		triggers = { "ENTER_REGION_121004", "ANY_MONSTER_DIE_121013" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
		...
		gadgets = { 121011, 121017 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_121016" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
