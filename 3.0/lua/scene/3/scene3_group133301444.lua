...
-- 怪物
monsters = {
	{ config_id = 444001, monster_id = 20010501, pos = { x = -404.304, y = 190.854, z = 3407.930 }, rot = { x = 0.000, y = 140.704, z = 0.000 }, level = 27, drop_tag = "史莱姆", disableWander = true, area_id = 22 },
...
gadgets = {
	...
	{ config_id = 444007, gadget_id = 70500000, pos = { x = -405.568, y = 190.109, z = 3409.759 }, rot = { x = 6.672, y = 47.130, z = 1.434 }, level = 1, point_type = 3006, area_id = 22 },
	{ config_id = 444008, gadget_id = 70290010, pos = { x = -396.082, y = 190.125, z = 3402.271 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 22 },
	{ config_id = 444009, gadget_id = 70500000, pos = { x = -396.082, y = 190.125, z = 3402.271 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, point_type = 3006, owner = 444008, area_id = 22 }
}
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 444001, 444002, 444003, 444012, 444013 },
		gadgets = { 444005, 444006, 444007, 444008, 444009 },
		regions = { 444004 },
