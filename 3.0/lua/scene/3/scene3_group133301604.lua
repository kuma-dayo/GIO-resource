...
gadgets = {
	...
	{ config_id = 604004, gadget_id = 70217020, pos = { x = -392.315, y = 204.311, z = 3781.304 }, rot = { x = 1.702, y = 62.241, z = 353.502 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 22 },
	{ config_id = 604007, gadget_id = 70217020, pos = { x = -367.438, y = 213.180, z = 3737.962 }, rot = { x = 1.702, y = 62.241, z = 353.502 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 22 }
}
...
suites = {
	{
		...
		gadgets = { 604001, 604002, 604003, 604004, 604007 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
