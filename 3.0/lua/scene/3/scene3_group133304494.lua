...
-- 怪物
monsters = {
	{ config_id = 494007, monster_id = 26090901, pos = { x = -1397.129, y = 217.948, z = 3073.144 }, rot = { x = 0.000, y = 30.302, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 21 },
	{ config_id = 494008, monster_id = 26090901, pos = { x = -1398.772, y = 218.171, z = 3075.065 }, rot = { x = 0.000, y = 50.431, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 21 }
}
...
-- 装置
gadgets = {
	{ config_id = 494001, gadget_id = 70330238, pos = { x = -1389.332, y = 214.709, z = 3080.424 }, rot = { x = 0.000, y = 100.204, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 494002, gadget_id = 70290558, pos = { x = -1399.064, y = 218.408, z = 3072.929 }, rot = { x = 0.000, y = 116.071, z = 0.000 }, level = 30, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 21 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_494003", "GROUP_LOAD_494004", "GADGET_STATE_CHANGE_494005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_GADGET_STATE_CHANGE_494003(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133304494, EntityType.GADGET, 494002 ) then
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_494004(context, evt)
	if GadgetState.GearStop ~= ScriptLib.GetGadgetStateByConfigId(context, 133304494, 494001) then
		return false
	end
...
-- 触发操作
function action_EVENT_GROUP_LOAD_494004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133304494, suite = 2 }) then
