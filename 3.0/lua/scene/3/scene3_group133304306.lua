...
monsters = {
	...
	[306011] = { config_id = 306011, monster_id = 25210302, pos = { x = -1165.500, y = 298.623, z = 2134.418 }, rot = { x = 0.000, y = 119.448, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 21 },
...
gadgets = {
	...
	[306021] = { config_id = 306021, gadget_id = 70360286, pos = { x = -1152.498, y = 286.277, z = 2156.031 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 21 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1306022, name = "GROUP_LOAD_306022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_306022", action = "action_EVENT_GROUP_LOAD_306022" },
	-- 判断父任务完成则弄死group
	...
	-- 挑战失败重置门变量
	{ config_id = 1306053, name = "CHALLENGE_FAIL_306053", event = EventType.EVENT_CHALLENGE_FAIL, source = "458", condition = "", action = "action_EVENT_CHALLENGE_FAIL_306053" }
}
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_306019", "GROUP_LOAD_306022", "GROUP_LOAD_306023", "ENTER_REGION_306024", "CHALLENGE_SUCCESS_306026", "CHALLENGE_FAIL_306027", "LEAVE_REGION_306029", "CHALLENGE_SUCCESS_306034", "CHALLENGE_SUCCESS_306039", "CHALLENGE_FAIL_306046", "GROUP_LOAD_306047", "TIME_AXIS_PASS_306052" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_306023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_306023(context, evt)
	ScriptLib.SetGroupDead(context, 133304306)
...
function condition_EVENT_SELECT_OPTION_306028(context, evt)
	-- 判断是gadgetid 306021 option_id 72
