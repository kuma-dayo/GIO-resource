...
gadgets = {
	...
	{ config_id = 640003, gadget_id = 70210101, pos = { x = -59.067, y = 172.429, z = 2055.163 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 640004, gadget_id = 70210101, pos = { x = -59.622, y = 172.535, z = 2053.717 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 640005, gadget_id = 70220103, pos = { x = -68.202, y = 171.987, z = 2084.469 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 640001, 640003, 640004, 640015, 640023, 640024, 640025, 640026 },
		regions = { 640006 },
