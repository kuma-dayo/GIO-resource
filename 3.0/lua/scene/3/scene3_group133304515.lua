...
-- 装置
gadgets = {
	[515001] = { config_id = 515001, gadget_id = 70330229, pos = { x = -1220.442, y = 185.078, z = 2268.040 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, mark_flag = 3, area_id = 21 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 515001, 515002, 515006, 515007 },
		regions = { },
