...
-- 装置
gadgets = {
	{ config_id = 431001, gadget_id = 70211101, pos = { x = -1639.536, y = 214.078, z = 2272.267 }, rot = { x = 12.027, y = 280.857, z = 27.114 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 },
