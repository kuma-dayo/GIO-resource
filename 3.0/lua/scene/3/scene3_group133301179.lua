...
-- 怪物
monsters = {
	{ config_id = 179001, monster_id = 24021101, pos = { x = -905.655, y = -5.537, z = 3142.397 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, affix = { 5182 }, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 179002, gadget_id = 70360001, pos = { x = -907.906, y = -5.568, z = 3126.498 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 179003, gadget_id = 70211021, pos = { x = -889.564, y = -5.588, z = 3140.922 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 26, drop_tag = "战斗高级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
