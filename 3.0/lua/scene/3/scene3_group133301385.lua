...
gadgets = {
	...
	{ config_id = 385011, gadget_id = 70210101, pos = { x = -377.369, y = 211.713, z = 3133.892 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 385012, gadget_id = 70210101, pos = { x = -387.440, y = 210.434, z = 3136.985 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 22 },
