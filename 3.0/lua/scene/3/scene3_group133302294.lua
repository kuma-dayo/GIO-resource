...
-- 怪物
monsters = {
	{ config_id = 294001, monster_id = 26010101, pos = { x = -644.219, y = 163.192, z = 2730.337 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "骗骗花", area_id = 24 }
}
...
-- 装置
gadgets = {
	{ config_id = 294002, gadget_id = 70510014, pos = { x = -644.191, y = 163.196, z = 2730.351 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 27, isOneoff = true, persistent = true, area_id = 24 }
}
