...
-- 装置
gadgets = {
	{ config_id = 174002, gadget_id = 70330199, pos = { x = -489.218, y = 227.672, z = 3965.222 }, rot = { x = 358.580, y = 92.944, z = 352.796 }, level = 33, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 22 }
}
