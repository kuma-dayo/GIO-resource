...
-- 装置
gadgets = {
	{ config_id = 254001, gadget_id = 70500000, pos = { x = -612.650, y = 144.103, z = 4008.070 }, rot = { x = 0.000, y = 353.188, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 25, is_enable_interact = false },
