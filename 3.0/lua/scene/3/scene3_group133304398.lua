...
-- 装置
gadgets = {
	{ config_id = 398001, gadget_id = 70211101, pos = { x = -1564.050, y = 296.809, z = 3036.505 }, rot = { x = 0.000, y = 87.288, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 },
