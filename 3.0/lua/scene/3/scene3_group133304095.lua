...
-- NPC
npcs = {
	{ config_id = 95001, npc_id = 12719, pos = { x = -1950.011, y = 209.186, z = 2461.868 }, rot = { x = 0.000, y = 249.491, z = 0.000 }, area_id = 21 },
	{ config_id = 95008, npc_id = 12719, pos = { x = -1937.896, y = 220.304, z = 2581.073 }, rot = { x = 0.000, y = 205.539, z = 0.000 }, area_id = 21 },
	{ config_id = 95009, npc_id = 12719, pos = { x = -1951.451, y = 206.502, z = 2572.303 }, rot = { x = 0.000, y = 171.520, z = 0.000 }, area_id = 21 },
	{ config_id = 95010, npc_id = 12719, pos = { x = -2006.806, y = 203.629, z = 2594.940 }, rot = { x = 0.000, y = 103.507, z = 0.000 }, area_id = 21 },
	{ config_id = 95011, npc_id = 12719, pos = { x = -1861.635, y = 201.211, z = 2568.409 }, rot = { x = 0.000, y = 29.595, z = 0.000 }, area_id = 21 }
}

-- 装置
gadgets = {
	{ config_id = 95002, gadget_id = 70360286, pos = { x = -1950.011, y = 209.186, z = 2461.868 }, rot = { x = 0.000, y = 249.491, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 95012, gadget_id = 70360286, pos = { x = -1937.896, y = 220.304, z = 2581.073 }, rot = { x = 0.000, y = 205.539, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 95013, gadget_id = 70360286, pos = { x = -1951.451, y = 206.502, z = 2572.303 }, rot = { x = 0.000, y = 171.520, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 95014, gadget_id = 70360286, pos = { x = -2006.806, y = 203.629, z = 2594.940 }, rot = { x = 0.000, y = 103.507, z = 0.000 }, level = 1, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 21 },
	{ config_id = 95015, gadget_id = 70360286, pos = { x = -1861.635, y = 201.211, z = 2568.409 }, rot = { x = 0.000, y = 29.595, z = 0.000 }, level = 1, area_id = 21 }
}

-- 区域
regions = {
	-- 小圈-开车
	{ config_id = 95036, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1950.011, y = 209.186, z = 2461.868 }, area_id = 21 },
	-- 小圈-开车
	{ config_id = 95037, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1937.896, y = 220.304, z = 2581.073 }, area_id = 21 },
	-- 小圈-开车
	{ config_id = 95038, shape = RegionShape.CYLINDER, radius = 20, pos = { x = -1951.451, y = 206.636, z = 2572.303 }, height = 18.000, area_id = 21 },
	-- 小圈-开车
	{ config_id = 95039, shape = RegionShape.SPHERE, radius = 23, pos = { x = -2006.806, y = 203.650, z = 2594.940 }, area_id = 21 },
	-- 小圈-开车
	{ config_id = 95040, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1861.635, y = 201.211, z = 2568.409 }, area_id = 21 }
}
...
triggers = {
	...
	{ config_id = 1095004, name = "QUEST_START_95004", event = EventType.EVENT_QUEST_START, source = "2301203", condition = "", action = "action_EVENT_QUEST_START_95004", trigger_count = 0 },
	...
	{ config_id = 1095017, name = "QUEST_START_95017", event = EventType.EVENT_QUEST_START, source = "2301203", condition = "", action = "action_EVENT_QUEST_START_95017", trigger_count = 0 },
	...
	{ config_id = 1095022, name = "QUEST_START_95022", event = EventType.EVENT_QUEST_START, source = "2301203", condition = "", action = "action_EVENT_QUEST_START_95022", trigger_count = 0 },
	...
	{ config_id = 1095027, name = "QUEST_START_95027", event = EventType.EVENT_QUEST_START, source = "2301203", condition = "", action = "action_EVENT_QUEST_START_95027", trigger_count = 0 },
	...
	{ config_id = 1095032, name = "QUEST_START_95032", event = EventType.EVENT_QUEST_START, source = "2301203", condition = "", action = "action_EVENT_QUEST_START_95032", trigger_count = 0 },
