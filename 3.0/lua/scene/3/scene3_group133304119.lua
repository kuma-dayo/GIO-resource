...
-- NPC
npcs = {
	{ config_id = 119001, npc_id = 12679, pos = { x = -1883.650, y = 211.396, z = 2582.589 }, rot = { x = 0.000, y = 91.538, z = 0.000 }, area_id = 21 },
	{ config_id = 119004, npc_id = 12679, pos = { x = -1958.880, y = 201.936, z = 2553.177 }, rot = { x = 0.000, y = 186.589, z = 0.000 }, area_id = 21 },
	{ config_id = 119013, npc_id = 12679, pos = { x = -1880.333, y = 203.583, z = 2512.068 }, rot = { x = 0.000, y = 22.497, z = 0.000 }, area_id = 21 },
	{ config_id = 119019, npc_id = 12679, pos = { x = -1934.837, y = 236.939, z = 2488.028 }, rot = { x = 0.000, y = 313.290, z = 0.000 }, area_id = 21 },
	{ config_id = 119025, npc_id = 12679, pos = { x = -1891.197, y = 243.382, z = 2566.726 }, rot = { x = 0.000, y = 124.913, z = 0.000 }, area_id = 21 }
}

-- 装置
gadgets = {
	{ config_id = 119002, gadget_id = 70360286, pos = { x = -1883.619, y = 211.396, z = 2582.628 }, rot = { x = 0.000, y = 91.538, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 119006, gadget_id = 70360286, pos = { x = -1958.878, y = 201.936, z = 2553.170 }, rot = { x = 0.000, y = 186.589, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 119014, gadget_id = 70360286, pos = { x = -1880.259, y = 203.775, z = 2512.167 }, rot = { x = 0.000, y = 22.497, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 119020, gadget_id = 70360286, pos = { x = -1934.727, y = 236.939, z = 2487.923 }, rot = { x = 0.000, y = 313.290, z = 0.000 }, level = 1, area_id = 21 },
	{ config_id = 119026, gadget_id = 70360286, pos = { x = -1891.519, y = 243.403, z = 2568.684 }, rot = { x = 0.000, y = 124.913, z = 0.000 }, level = 1, area_id = 21 }
}

-- 区域
regions = {
	-- 小圈-开车提示
	{ config_id = 119005, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1883.619, y = 211.396, z = 2582.628 }, area_id = 21 },
	-- 小圈-开车提示
	{ config_id = 119009, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1891.519, y = 243.403, z = 2568.684 }, area_id = 21 },
	-- 小圈-开车提示
	{ config_id = 119012, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1958.878, y = 201.936, z = 2553.170 }, area_id = 21 },
	-- 小圈-开车提示
	{ config_id = 119018, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1880.259, y = 203.775, z = 2512.167 }, area_id = 21 },
	-- 小圈-开车提示
	{ config_id = 119024, shape = RegionShape.SPHERE, radius = 23, pos = { x = -1934.727, y = 236.939, z = 2487.923 }, area_id = 21 }
}
...
triggers = {
	...
	-- 2301202任务开始
	{ config_id = 1119007, name = "QUEST_START_119007", event = EventType.EVENT_QUEST_START, source = "2301202", condition = "", action = "action_EVENT_QUEST_START_119007", trigger_count = 0 },
	...
	-- 2301202任务开始
	{ config_id = 1119011, name = "QUEST_START_119011", event = EventType.EVENT_QUEST_START, source = "2301202", condition = "", action = "action_EVENT_QUEST_START_119011", trigger_count = 0 },
	-- 小圈-开车提示
	...
	-- 2301202任务开始
	{ config_id = 1119022, name = "QUEST_START_119022", event = EventType.EVENT_QUEST_START, source = "2301202", condition = "", action = "action_EVENT_QUEST_START_119022", trigger_count = 0 },
	-- 2301202任务结束
	...
	-- 2301202任务开始
	{ config_id = 1119028, name = "QUEST_START_119028", event = EventType.EVENT_QUEST_START, source = "2301202", condition = "", action = "action_EVENT_QUEST_START_119028", trigger_count = 0 },
	-- 2301202任务结束
	...
	-- 2301202任务开始
	{ config_id = 1119030, name = "QUEST_START_119030", event = EventType.EVENT_QUEST_START, source = "2301202", condition = "", action = "action_EVENT_QUEST_START_119030", trigger_count = 0 },
