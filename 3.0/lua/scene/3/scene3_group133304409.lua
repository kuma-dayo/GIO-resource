...
triggers = {
	...
	{ config_id = 1409006, name = "MONSTER_BATTLE_409006", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "", action = "action_EVENT_MONSTER_BATTLE_409006", trigger_count = 0 }
}
