...
-- 装置
gadgets = {
	{ config_id = 559002, gadget_id = 70330199, pos = { x = -1229.360, y = 233.827, z = 4007.041 }, rot = { x = 12.853, y = 200.534, z = 355.274 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
