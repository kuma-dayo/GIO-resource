...
gadgets = {
	...
	[197005] = { config_id = 197005, gadget_id = 70310205, pos = { x = -1636.425, y = 500.144, z = 2163.249 }, rot = { x = 1.349, y = 326.447, z = 3.765 }, level = 33, area_id = 21 },
	...
	[197024] = { config_id = 197024, gadget_id = 70211121, pos = { x = -1636.348, y = 500.309, z = 2163.158 }, rot = { x = 0.000, y = 328.147, z = 0.000 }, level = 26, drop_tag = "解谜高级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 },
	[197033] = { config_id = 197033, gadget_id = 70950145, pos = { x = -1636.348, y = 500.309, z = 2163.158 }, rot = { x = 0.000, y = 147.490, z = 0.000 }, level = 33, area_id = 21 },
	[197034] = { config_id = 197034, gadget_id = 70310148, pos = { x = -1638.064, y = 499.981, z = 2165.603 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, area_id = 21 },
	...
	-- 挂按钮用的
	[197046] = { config_id = 197046, gadget_id = 70950145, pos = { x = -1638.064, y = 499.981, z = 2165.603 }, rot = { x = 0.000, y = 147.490, z = 0.000 }, level = 33, worktop_config = { init_options = { 758 } }, area_id = 21 }
}

-- 区域
regions = {
	[197029] = { config_id = 197029, shape = RegionShape.SPHERE, radius = 150, pos = { x = -1658.658, y = 455.376, z = 2201.806 }, area_id = 21 }
}
