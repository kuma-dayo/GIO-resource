...
gadgets = {
	...
	{ config_id = 509002, gadget_id = 70211002, pos = { x = -1611.069, y = 163.074, z = 3165.715 }, rot = { x = 358.130, y = 84.383, z = 19.628 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_509004(context, evt)
	-- 将configid为 509002 的物件更改为状态 GadgetState.ChestLocked
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 509002, GadgetState.ChestLocked) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
