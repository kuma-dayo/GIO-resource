...
-- 装置
gadgets = {
	{ config_id = 531002, gadget_id = 70211012, pos = { x = -952.089, y = 147.747, z = 2781.451 }, rot = { x = 0.000, y = 18.991, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 },
...
function action_EVENT_ANY_MONSTER_DIE_531003(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-952.6269, y=147.686, z=2779.676}，持续时间为1.5秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-952.6269, y=147.686, z=2779.676}
