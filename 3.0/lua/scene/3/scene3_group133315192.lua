...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 192001, 192002, 192003, 192004, 192005, 192006, 192007, 192008, 192009, 192010, 192011, 192014 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_192012", "GADGET_STATE_CHANGE_192013", "GROUP_LOAD_192015", "GADGET_STATE_CHANGE_192016" },
		rand_weight = 100
	}
}
