...
monsters = {
	...
	{ config_id = 358005, monster_id = 25210503, pos = { x = -1252.191, y = 237.227, z = 3749.104 }, rot = { x = 0.000, y = 81.410, z = 0.000 }, level = 30, drop_tag = "镀金旅团", affix = { 4180 }, pose_id = 9001, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 358007, gadget_id = 70310479, pos = { x = -1248.495, y = 243.701, z = 3728.452 }, rot = { x = 0.000, y = 7.147, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 },
	{ config_id = 358008, gadget_id = 70310479, pos = { x = -1251.154, y = 243.592, z = 3731.777 }, rot = { x = 0.000, y = 7.147, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 },
