...
-- 触发器
triggers = {
	{ config_id = 1711003, name = "MONSTER_BATTLE_711003", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_711003", action = "action_EVENT_MONSTER_BATTLE_711003", trigger_count = 0 }
}
