...
gadgets = {
	...
	[415024] = { config_id = 415024, gadget_id = 70211121, pos = { x = 220.234, y = 296.820, z = 2461.315 }, rot = { x = 0.000, y = 354.553, z = 0.000 }, level = 26, drop_tag = "解谜高级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 },
	[415061] = { config_id = 415061, gadget_id = 70360001, pos = { x = 220.238, y = 296.820, z = 2461.148 }, rot = { x = 0.000, y = 151.087, z = 0.000 }, level = 33, area_id = 20 },
...
suites = {
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 415061, 415062, 415067, 415072, 415073, 415074 },
		regions = { },
		triggers = { },
		rand_weight = 100
	}
