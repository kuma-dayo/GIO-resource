...
monsters = {
	...
	{ config_id = 19020, monster_id = 25210301, pos = { x = -1937.896, y = 221.063, z = 2885.929 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "镀金旅团", affix = { 4180 }, pose_id = 9002, area_id = 21 },
...
-- 装置
gadgets = {
	{ config_id = 19006, gadget_id = 70310479, pos = { x = -1923.788, y = 209.654, z = 2912.218 }, rot = { x = 0.000, y = 2.422, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 21 },
	{ config_id = 19007, gadget_id = 70310479, pos = { x = -1924.054, y = 209.559, z = 2908.763 }, rot = { x = 0.000, y = 4.289, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 21 },
	...
	{ config_id = 19029, gadget_id = 70217020, pos = { x = -1897.757, y = 217.818, z = 2914.265 }, rot = { x = 0.000, y = 318.180, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 21 },
...
suites = {
	{
		...
		regions = { 19015 },
		triggers = { "GROUP_LOAD_19010", "GROUP_LOAD_19011", "VARIABLE_CHANGE_19013", "ENTER_REGION_19015", "GADGET_CREATE_19024", "SELECT_OPTION_19034" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_19010(context, evt)
...
function action_EVENT_GROUP_LOAD_19010(context, evt)
	ScriptLib.SetGroupDead(context, 133304019)
