...
-- 装置
gadgets = {
	{ config_id = 234002, gadget_id = 70330199, pos = { x = -1621.430, y = 113.495, z = 3264.289 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
