...
gadgets = {
	...
	{ config_id = 358002, gadget_id = 70310200, pos = { x = -1632.007, y = 120.882, z = 2309.456 }, rot = { x = 9.205, y = 326.162, z = 13.981 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 358003, gadget_id = 70310200, pos = { x = -1610.994, y = 131.467, z = 2282.740 }, rot = { x = 320.475, y = 357.077, z = 9.392 }, level = 30, persistent = true, area_id = 21 },
	...
	{ config_id = 358006, gadget_id = 70330255, pos = { x = -1668.417, y = 120.797, z = 2279.885 }, rot = { x = 0.000, y = 47.726, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 358007, gadget_id = 70330255, pos = { x = -1668.417, y = 120.797, z = 2279.885 }, rot = { x = 0.000, y = 89.405, z = 0.000 }, level = 30, persistent = true, area_id = 21 },
...
triggers = {
	...
	{ config_id = 1358010, name = "GADGET_CREATE_358010", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_358010", action = "action_EVENT_GADGET_CREATE_358010" }
}

-- 变量
variables = {
	{ config_id = 1, name = "start", value = 5, no_refresh = true }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_358008", "GADGET_CREATE_358010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_358010(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_CREATE_358010(context, evt)
	-- 运营数据埋点，匹配LD定义的规则使用
