...
gadgets = {
	...
	{ config_id = 512002, gadget_id = 70211002, pos = { x = -1815.154, y = 126.405, z = 3328.738 }, rot = { x = 0.000, y = 322.140, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_512004(context, evt)
	-- 将configid为 512002 的物件更改为状态 GadgetState.ChestLocked
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 512002, GadgetState.ChestLocked) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
