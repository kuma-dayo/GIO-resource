...
gadgets = {
	...
	{ config_id = 379005, gadget_id = 70290422, pos = { x = -890.015, y = 270.991, z = 3283.108 }, rot = { x = 17.641, y = 321.088, z = 339.452 }, level = 30, persistent = true, server_global_value_config = {["SGV_GRASSSEAL_TARGET"] = 1, ["SGV_GRASSSEAL_ATTACHPOINT"] = 2}, area_id = 23 },
	...
	{ config_id = 379007, gadget_id = 70290422, pos = { x = -917.944, y = 270.093, z = 3296.372 }, rot = { x = 11.049, y = 69.645, z = 351.058 }, level = 30, persistent = true, server_global_value_config = {["SGV_GRASSSEAL_TARGET"] = 3, ["SGV_GRASSSEAL_ATTACHPOINT"] = 1}, area_id = 23 },
...
regions = {
	-- 保底怪物入战，封印环销毁
	{ config_id = 379016, shape = RegionShape.SPHERE, radius = 20, pos = { x = -896.681, y = 269.157, z = 3290.715 }, area_id = 23 }
}
