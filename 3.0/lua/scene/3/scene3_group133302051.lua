...
triggers = {
	...
	{ config_id = 1051002, name = "GROUP_LOAD_51002", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_51002", action = "action_EVENT_GROUP_LOAD_51002" },
