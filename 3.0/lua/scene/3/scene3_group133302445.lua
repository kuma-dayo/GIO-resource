...
-- 装置
gadgets = {
	{ config_id = 445005, gadget_id = 70211101, pos = { x = -522.871, y = 102.890, z = 2377.603 }, rot = { x = 348.010, y = 60.637, z = 349.585 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 },
	{ config_id = 445006, gadget_id = 70330199, pos = { x = -545.787, y = 102.122, z = 2367.982 }, rot = { x = 0.000, y = 34.453, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 24 },
	{ config_id = 445009, gadget_id = 70330199, pos = { x = -536.811, y = 103.094, z = 2354.861 }, rot = { x = 0.000, y = 331.895, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 24 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_445015", "GADGET_STATE_CHANGE_445016", "GADGET_STATE_CHANGE_445017", "GADGET_STATE_CHANGE_445018" },
		rand_weight = 100
	}
}
