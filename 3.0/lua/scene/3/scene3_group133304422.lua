...
monsters = {
	...
	{ config_id = 422009, monster_id = 20011301, pos = { x = -1381.095, y = 330.949, z = 2089.705 }, rot = { x = 0.000, y = 258.508, z = 0.000 }, level = 30, drop_tag = "大史莱姆", area_id = 21 },
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 422001, 422004, 422005 },
		gadgets = { 422002 },
		regions = { },
		triggers = { "GROUP_LOAD_422013" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 422008, 422009 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_422007" },
		rand_weight = 100
	},
	{
		-- suite_id = 7,
...
function action_EVENT_ANY_MONSTER_DIE_422003(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304422, 2)
	
	-- 添加suite6的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304422, 6)
	
	-- 删除suite5的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133304422, 5)
	
	return 0
end

-- 触发条件
function condition_EVENT_ANY_MONSTER_DIE_422007(context, evt)
	-- 判断剩余怪物数量是否是1
	if ScriptLib.GetGroupMonsterCount(context) ~= 1 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_422007(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304422, 3)
	
	-- 删除suite6的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133304422, 6)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_422013(context, evt)
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304422, 5)
