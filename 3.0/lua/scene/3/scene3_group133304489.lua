...
gadgets = {
	...
	{ config_id = 489005, gadget_id = 70210101, pos = { x = -1184.748, y = 283.865, z = 2527.904 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", area_id = 21 },
...
-- 触发器
triggers = {
	{ config_id = 1489012, name = "GROUP_LOAD_489012", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_489012", action = "action_EVENT_GROUP_LOAD_489012", trigger_count = 0 }
}
