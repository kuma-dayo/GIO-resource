...
gadgets = {
	...
	[289004] = { config_id = 289004, gadget_id = 70310440, pos = { x = -1009.478, y = 291.897, z = 3809.241 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 23 }
}
...
triggers = {
	...
	-- G键触发
	{ config_id = 1289012, name = "ENTER_REGION_289012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_289012", action = "action_EVENT_ENTER_REGION_289012" }
}
