...
triggers = {
	...
	{ config_id = 1078008, name = "GROUP_LOAD_78008", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_78008", action = "action_EVENT_GROUP_LOAD_78008" }
}
