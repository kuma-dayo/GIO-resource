...
-- 装置
gadgets = {
	{ config_id = 689001, gadget_id = 70330238, pos = { x = -182.406, y = 242.596, z = 3633.115 }, rot = { x = 4.929, y = 95.493, z = 346.752 }, level = 27, area_id = 29 },
	{ config_id = 689002, gadget_id = 70290561, pos = { x = -196.488, y = 245.637, z = 3640.427 }, rot = { x = 4.759, y = 72.097, z = 1.423 }, level = 27, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 29 },
	{ config_id = 689006, gadget_id = 70290561, pos = { x = -193.748, y = 245.352, z = 3647.555 }, rot = { x = 357.344, y = 174.840, z = 5.583 }, level = 27, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 29 },
	{ config_id = 689007, gadget_id = 70330238, pos = { x = -182.569, y = 246.023, z = 3654.076 }, rot = { x = 0.000, y = 21.551, z = 0.000 }, level = 27, area_id = 29 },
	{ config_id = 689008, gadget_id = 70230112, pos = { x = -195.175, y = 245.882, z = 3640.940 }, rot = { x = 350.180, y = 273.559, z = 100.918 }, level = 27, area_id = 29 },
	{ config_id = 689009, gadget_id = 70230112, pos = { x = -193.342, y = 245.584, z = 3644.743 }, rot = { x = 359.900, y = 359.858, z = 54.940 }, level = 27, area_id = 29 },
	{ config_id = 689010, gadget_id = 70230111, pos = { x = -194.781, y = 245.642, z = 3643.231 }, rot = { x = 0.005, y = 322.902, z = 88.846 }, level = 27, area_id = 29 },
	{ config_id = 689011, gadget_id = 70290561, pos = { x = -195.438, y = 245.338, z = 3644.844 }, rot = { x = 358.087, y = 151.647, z = 346.441 }, level = 27, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 29 },
	...
	{ config_id = 689013, gadget_id = 70330238, pos = { x = -205.419, y = 254.581, z = 3644.195 }, rot = { x = 36.406, y = 63.890, z = 359.401 }, level = 27, area_id = 29 },
	{ config_id = 689014, gadget_id = 70230111, pos = { x = -201.533, y = 253.424, z = 3643.893 }, rot = { x = 334.404, y = 256.608, z = 64.329 }, level = 27, area_id = 29 },
	{ config_id = 689015, gadget_id = 70230112, pos = { x = -185.686, y = 245.981, z = 3634.764 }, rot = { x = 334.478, y = 317.130, z = 72.995 }, level = 27, area_id = 29 },
	{ config_id = 689016, gadget_id = 70230112, pos = { x = -183.511, y = 247.480, z = 3652.847 }, rot = { x = 312.337, y = 270.868, z = 61.903 }, level = 27, area_id = 29 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_689003(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133301689, EntityType.GADGET, 689002 ) then
...
function action_EVENT_GROUP_LOAD_689004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301689, suite = 2 }) then
...
function action_EVENT_GADGET_STATE_CHANGE_689005(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133301689, EntityType.GADGET, 689006 ) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : remove_gadget_by_configid")
			return -1
		end
...
function action_EVENT_GADGET_STATE_CHANGE_689017(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133301689, EntityType.GADGET, 689011 ) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : remove_gadget_by_configid")
			return -1
		end
...
function action_EVENT_GADGET_STATE_CHANGE_689018(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133301689, 2)
