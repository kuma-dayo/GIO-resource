...
-- 怪物
monsters = {
	{ config_id = 675001, monster_id = 21010201, pos = { x = -515.367, y = 214.541, z = 2375.102 }, rot = { x = 0.000, y = 301.906, z = 0.000 }, level = 27, drop_tag = "丘丘人", disableWander = true, pose_id = 9015, area_id = 24 },
	...
	{ config_id = 675010, monster_id = 28030313, pos = { x = -517.782, y = 217.620, z = 2376.346 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 }
}
