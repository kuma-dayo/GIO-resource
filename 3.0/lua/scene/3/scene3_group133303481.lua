...
-- 怪物
monsters = {
	{ config_id = 481001, monster_id = 26090901, pos = { x = -1105.772, y = 186.644, z = 3739.140 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 481002, gadget_id = 70330199, pos = { x = -1105.902, y = 186.480, z = 3738.717 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
