...
monsters = {
	...
	[360011] = { config_id = 360011, monster_id = 25210302, pos = { x = -2007.424, y = 284.527, z = 3385.182 }, rot = { x = 0.000, y = 99.332, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 23 },
	...
	[360013] = { config_id = 360013, monster_id = 25210302, pos = { x = -1995.078, y = 283.013, z = 3370.318 }, rot = { x = 0.000, y = 97.167, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 23 },
...
gadgets = {
	...
	[360021] = { config_id = 360021, gadget_id = 70360286, pos = { x = -1989.474, y = 289.011, z = 3370.042 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 23 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1360022, name = "GROUP_LOAD_360022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_360022", action = "action_EVENT_GROUP_LOAD_360022" },
	-- 判断父任务完成则弄死group
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_360020", "GROUP_LOAD_360022", "GROUP_LOAD_360023", "ENTER_REGION_360024", "CHALLENGE_SUCCESS_360026", "CHALLENGE_FAIL_360027", "LEAVE_REGION_360029", "CHALLENGE_SUCCESS_360034", "CHALLENGE_SUCCESS_360039", "CHALLENGE_FAIL_360046", "GROUP_LOAD_360047", "TIME_AXIS_PASS_360052" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_360023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_360023(context, evt)
	ScriptLib.SetGroupDead(context, 133303360)
...
function condition_EVENT_SELECT_OPTION_360028(context, evt)
	-- 判断是gadgetid 360021 option_id 72
