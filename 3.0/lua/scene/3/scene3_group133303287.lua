...
gadgets = {
	...
	-- 22
	[287006] = { config_id = 287006, gadget_id = 70310195, pos = { x = -1315.927, y = 194.999, z = 3306.544 }, rot = { x = 9.340, y = 86.020, z = 355.597 }, level = 30, persistent = true, area_id = 23 },
	-- 23
	...
	[287034] = { config_id = 287034, gadget_id = 70310192, pos = { x = -1315.109, y = 195.137, z = 3309.686 }, rot = { x = 351.002, y = 108.071, z = 8.942 }, level = 30, persistent = true, area_id = 23 },
	...
	[287036] = { config_id = 287036, gadget_id = 70220020, pos = { x = -1314.388, y = 194.045, z = 3306.191 }, rot = { x = 11.495, y = 92.723, z = 356.827 }, level = 30, persistent = true, area_id = 23 },
...
suites = {
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "MONSTER_BATTLE_287003", "ANY_MONSTER_DIE_287010" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function action_EVENT_MONSTER_BATTLE_287003(context, evt)
	-- 将configid为 287012 的物件更改为状态 GadgetState.GearStop
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 287012, GadgetState.GearStop) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
	
	-- 将configid为 287038 的物件更改为状态 GadgetState.GearStop
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 287038, GadgetState.GearStop) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
-- 触发条件
function condition_EVENT_ANY_MONSTER_DIE_287010(context, evt)
	if 287002 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_287010(context, evt)
	...
	-- 将configid为 287038 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 287038, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
