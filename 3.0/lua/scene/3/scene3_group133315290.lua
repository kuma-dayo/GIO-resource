...
-- 怪物
monsters = {
	{ config_id = 290001, monster_id = 26010201, pos = { x = 159.286, y = 384.032, z = 2136.591 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "骗骗花", area_id = 20 }
}
...
-- 装置
gadgets = {
	{ config_id = 290002, gadget_id = 70330199, pos = { x = 159.301, y = 383.689, z = 2135.904 }, rot = { x = 10.854, y = 10.698, z = 1.044 }, level = 27, state = GadgetState.GearStop, persistent = true, area_id = 20 },
	{ config_id = 290003, gadget_id = 70330218, pos = { x = 159.574, y = 383.088, z = 2137.723 }, rot = { x = 0.000, y = 5.178, z = 0.000 }, level = 27, persistent = true, area_id = 20 },
	{ config_id = 290004, gadget_id = 70310198, pos = { x = 160.106, y = 381.404, z = 2145.715 }, rot = { x = 0.000, y = 241.350, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 290005, gadget_id = 70290484, pos = { x = 159.627, y = 384.381, z = 2137.219 }, rot = { x = 349.671, y = 166.283, z = 3.511 }, level = 27, persistent = true, area_id = 20 },
	...
	{ config_id = 290025, gadget_id = 70510014, pos = { x = 159.314, y = 384.025, z = 2136.605 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 27, isOneoff = true, persistent = true, worktop_config = { init_options = { 174 } }, area_id = 20 },
	{ config_id = 290036, gadget_id = 70310198, pos = { x = 136.230, y = 400.364, z = 2092.521 }, rot = { x = 0.000, y = 22.311, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 290037, gadget_id = 70330218, pos = { x = 158.147, y = 395.536, z = 2119.971 }, rot = { x = 345.984, y = 232.723, z = 348.536 }, level = 27, persistent = true, area_id = 20 },
	{ config_id = 290040, gadget_id = 70290009, pos = { x = 159.711, y = 383.633, z = 2137.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 290042, gadget_id = 70500000, pos = { x = 159.711, y = 383.633, z = 2137.800 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, point_type = 3005, owner = 290040, area_id = 20 }
}
...
triggers = {
	...
	-- 抬起可抬起石块
	{ config_id = 1290039, name = "GADGET_STATE_CHANGE_290039", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_290039", action = "action_EVENT_GADGET_STATE_CHANGE_290039" },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 290002, 290003, 290004, 290036, 290037, 290040, 290042 },
		regions = { },
		triggers = { "ANY_GADGET_DIE_290026", "GROUP_LOAD_290038" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { },
		gadgets = { 290005, 290020, 290021, 290023, 290024 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_290029", "GADGET_STATE_CHANGE_290030", "GADGET_STATE_CHANGE_290031", "GADGET_STATE_CHANGE_290039" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 290007, 290008, 290009, 290010, 290011, 290012, 290013, 290014, 290015, 290016, 290017, 290018, 290019 },
		regions = { },
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_290029(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_290029(context, evt)
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 290023 }) then
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_290030(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_290030(context, evt)
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 290024 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : kill_entity_by_configId")
		    return -1
		end
...
function action_EVENT_GROUP_LOAD_290038(context, evt)
	...
	-- 删除suite1的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133315290, 1)
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_290039(context, evt)
	-- 检测指定三态物件的grassState是否为对应状态，其中1为正常态、2为激化态、3为消亡态
	if 290002 ~= evt.param2 then
		return false
	end
	if 1<1 or 1>3 then
	  return false
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_290039(context, evt)
	-- 添加suite3的新内容
...
function action_EVENT_GADGET_STATE_CHANGE_290041(context, evt)
	...
	if 0 ~= ScriptLib.GoToGroupSuite(context, 133315290, 6) then
