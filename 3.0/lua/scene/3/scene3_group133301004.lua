...
monsters = {
	...
	{ config_id = 4009, monster_id = 23010101, pos = { x = -122.614, y = 231.435, z = 4019.142 }, rot = { x = 0.000, y = 305.632, z = 0.000 }, level = 1, drop_tag = "先遣队", area_id = 22 },
...
gadgets = {
	...
	{ config_id = 4023, gadget_id = 70310009, pos = { x = -163.007, y = 224.421, z = 3955.235 }, rot = { x = 6.478, y = 2.158, z = 5.254 }, level = 27, area_id = 22 }
}
