...
-- 装置
gadgets = {
	{ config_id = 650001, gadget_id = 70500000, pos = { x = -717.682, y = 206.880, z = 2740.691 }, rot = { x = 0.000, y = 17.914, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 24, is_enable_interact = false },
