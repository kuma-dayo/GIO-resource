...
triggers = {
	...
	{ config_id = 1010008, name = "QUEST_START_10008", event = EventType.EVENT_QUEST_START, source = "7300233", condition = "", action = "action_EVENT_QUEST_START_10008" }
}
...
suites = {
	...
	},
	{
		...
		gadgets = { 10002 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_10003", "QUEST_START_10008" },
		rand_weight = 100
	}
}
