...
function action_EVENT_GADGET_STATE_CHANGE_34005(context, evt)
	...
	-- 创建标识为"rmd2"，时间节点为{4,4}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "rmd2", {4,4}, false)
...
function action_EVENT_GADGET_STATE_CHANGE_34006(context, evt)
	...
	-- 创建标识为"rmd1"，时间节点为{4,4}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "rmd1", {4,4}, false)
