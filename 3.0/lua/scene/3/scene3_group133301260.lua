...
monsters = {
	...
	{ config_id = 260002, monster_id = 24030101, pos = { x = -603.060, y = 125.377, z = 3930.805 }, rot = { x = 0.000, y = 228.653, z = 0.000 }, level = 33, drop_tag = "遗迹龙兽", disableWander = true, affix = { 6117 }, pose_id = 102, area_id = 25, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
...
gadgets = {
	...
	{ config_id = 260006, gadget_id = 70310191, pos = { x = -605.899, y = 123.310, z = 3916.404 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, area_id = 25 }
}
