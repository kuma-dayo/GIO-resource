...
gadgets = {
	...
	{ config_id = 729009, gadget_id = 70211002, pos = { x = -171.195, y = 248.852, z = 3557.193 }, rot = { x = 0.000, y = 305.396, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 29 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_729003", "GADGET_CREATE_729005", "SELECT_OPTION_729006", "GADGET_CREATE_729008", "SELECT_OPTION_729010", "GADGET_STATE_CHANGE_729011" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_729011(context, evt)
	if 729007 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_729011(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133301729, 2)
