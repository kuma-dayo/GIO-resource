...
-- 装置
gadgets = {
	{ config_id = 427001, gadget_id = 70230107, pos = { x = -1192.913, y = 175.853, z = 2439.834 }, rot = { x = 33.697, y = 332.661, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 427002, gadget_id = 70230108, pos = { x = -1206.499, y = 209.752, z = 2551.560 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 427003, gadget_id = 70230109, pos = { x = -1187.602, y = 186.497, z = 2483.271 }, rot = { x = 9.356, y = 298.421, z = 343.280 }, level = 30, area_id = 21 },
	{ config_id = 427004, gadget_id = 70230110, pos = { x = -1127.041, y = 173.624, z = 2448.368 }, rot = { x = 45.878, y = 217.553, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 427005, gadget_id = 70230111, pos = { x = -1125.365, y = 174.547, z = 2451.637 }, rot = { x = 275.594, y = 199.962, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 427006, gadget_id = 70230112, pos = { x = -1124.764, y = 174.498, z = 2455.181 }, rot = { x = 275.421, y = 159.839, z = 0.003 }, level = 30, area_id = 21 },
...
regions = {
	...
	{ config_id = 427009, shape = RegionShape.SPHERE, radius = 5, pos = { x = -1187.602, y = 186.497, z = 2483.271 }, area_id = 21 },
...
-- 触发器
triggers = {
	{ config_id = 1427007, name = "ENTER_REGION_427007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427007", action = "action_EVENT_ENTER_REGION_427007" },
	{ config_id = 1427008, name = "ENTER_REGION_427008", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427008", action = "action_EVENT_ENTER_REGION_427008" },
	{ config_id = 1427009, name = "ENTER_REGION_427009", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427009", action = "action_EVENT_ENTER_REGION_427009" },
	{ config_id = 1427010, name = "ENTER_REGION_427010", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427010", action = "action_EVENT_ENTER_REGION_427010" },
	{ config_id = 1427011, name = "ENTER_REGION_427011", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427011", action = "action_EVENT_ENTER_REGION_427011" },
	{ config_id = 1427012, name = "ENTER_REGION_427012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_427012", action = "action_EVENT_ENTER_REGION_427012" },
	{ config_id = 1427013, name = "VARIABLE_CHANGE_427013", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_427013", action = "action_EVENT_VARIABLE_CHANGE_427013", trigger_count = 0 }
}
...
suites = {
	{
		...
		triggers = { "ENTER_REGION_427007", "ENTER_REGION_427008", "ENTER_REGION_427009", "ENTER_REGION_427010", "ENTER_REGION_427011", "ENTER_REGION_427012", "VARIABLE_CHANGE_427013" },
		rand_weight = 100
	}
}
...
function action_EVENT_ENTER_REGION_427007(context, evt)
	...
	if 0 ~= ScriptLib.ChangeGroupVariableValue(context, "active", 1) then
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_427013(context, evt)
	if evt.param1 == evt.param2 then return false end
	
	-- 判断变量"active"为6
	if ScriptLib.GetGroupVariableValue(context, "active") ~= 6 then
			return false
	end
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_427013(context, evt)
	-- 创建id为427014的gadget
