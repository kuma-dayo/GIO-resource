...
monsters = {
	...
	{ config_id = 63005, monster_id = 28030313, pos = { x = -788.002, y = 210.288, z = 2707.716 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 }
}
...
-- 装置
gadgets = {
	{ config_id = 63001, gadget_id = 70330199, pos = { x = -789.612, y = 207.941, z = 2699.983 }, rot = { x = 6.252, y = 318.205, z = 354.806 }, level = 27, state = GadgetState.GearStop, area_id = 24 }
}
