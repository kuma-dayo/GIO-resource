...
-- 装置
gadgets = {
	{ config_id = 161001, gadget_id = 70330199, pos = { x = -1713.999, y = 191.504, z = 3379.336 }, rot = { x = 4.102, y = 122.646, z = 2.513 }, level = 30, state = GadgetState.GearStop, persistent = true, area_id = 23 },
	...
	{ config_id = 161007, gadget_id = 70330197, pos = { x = -1713.802, y = 191.317, z = 3371.942 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 },
...
garbages = {
	monsters = {
		{ config_id = 161004, monster_id = 28030313, pos = { x = -1731.954, y = 229.376, z = 3385.834 }, rot = { x = 0.000, y = 101.038, z = 0.000 }, level = 30, drop_tag = "鸟类", area_id = 23 },
		{ config_id = 161005, monster_id = 28030313, pos = { x = -1730.872, y = 229.396, z = 3385.789 }, rot = { x = 0.000, y = 273.540, z = 0.000 }, level = 30, drop_tag = "鸟类", area_id = 23 }
	}
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_161003", "GADGET_STATE_CHANGE_161006" },
		rand_weight = 100
	}
}
