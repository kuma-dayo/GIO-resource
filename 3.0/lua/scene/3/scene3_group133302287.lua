...
-- 装置
gadgets = {
	{ config_id = 287002, gadget_id = 70211002, pos = { x = -797.318, y = 191.658, z = 2618.257 }, rot = { x = 350.830, y = 271.328, z = 1.054 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 },
	...
	{ config_id = 287011, gadget_id = 70330199, pos = { x = -794.530, y = 192.154, z = 2617.208 }, rot = { x = 0.000, y = 290.707, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 24 },
