...
-- 装置
gadgets = {
	{ config_id = 501001, gadget_id = 70710006, pos = { x = -85.697, y = 224.460, z = 2482.021 }, rot = { x = 0.000, y = 157.248, z = 0.000 }, level = 27, area_id = 20 },
	...
	{ config_id = 501003, gadget_id = 70710007, pos = { x = -85.803, y = 224.688, z = 2481.536 }, rot = { x = 359.984, y = 235.039, z = 5.507 }, level = 27, area_id = 20 },
	{ config_id = 501004, gadget_id = 70211101, pos = { x = -83.700, y = 223.633, z = 2481.430 }, rot = { x = 0.000, y = 168.387, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}
