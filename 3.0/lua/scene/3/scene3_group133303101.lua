...
-- 装置
gadgets = {
	{ config_id = 101002, gadget_id = 70211002, pos = { x = -1239.931, y = 227.872, z = 3970.696 }, rot = { x = 0.000, y = 285.898, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	...
	{ config_id = 101010, gadget_id = 70210101, pos = { x = -1264.903, y = 226.784, z = 3992.458 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 }
}
