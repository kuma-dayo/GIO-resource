...
monsters = {
	...
	{ config_id = 27022, monster_id = 26090501, pos = { x = -99.911, y = 174.984, z = 2147.759 }, rot = { x = 0.000, y = 306.072, z = 0.000 }, level = 27, drop_tag = "蕈兽", pose_id = 104, area_id = 20 },
	{ config_id = 27023, monster_id = 26090501, pos = { x = -101.656, y = 175.279, z = 2148.573 }, rot = { x = 0.000, y = 306.072, z = 0.000 }, level = 27, drop_tag = "蕈兽", pose_id = 104, area_id = 20 },
...
-- 装置
gadgets = {
	{ config_id = 27001, gadget_id = 70310198, pos = { x = -121.247, y = 174.068, z = 2133.885 }, rot = { x = 0.000, y = 69.089, z = 0.000 }, level = 27, persistent = true, area_id = 20 },
	...
	{ config_id = 27007, gadget_id = 70330199, pos = { x = -100.747, y = 175.616, z = 2151.235 }, rot = { x = 0.000, y = 38.659, z = 0.000 }, level = 27, state = GadgetState.GearStop, area_id = 20 },
	...
	{ config_id = 27016, gadget_id = 70217020, pos = { x = -100.611, y = 176.088, z = 2151.346 }, rot = { x = 0.000, y = 160.238, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 20 },
	...
	{ config_id = 27026, gadget_id = 70500000, pos = { x = -86.889, y = 174.424, z = 2118.333 }, rot = { x = 0.000, y = 339.360, z = 0.000 }, level = 27, point_type = 3008, owner = 27025, area_id = 20 },
...
garbages = {
	monsters = {
		{ config_id = 27015, monster_id = 28010304, pos = { x = -99.951, y = 176.922, z = 2150.465 }, rot = { x = 0.000, y = 156.775, z = 0.000 }, level = 27, drop_tag = "采集动物", area_id = 20 }
	},
	gadgets = {
...
suites = {
	{
		...
		gadgets = { 27002, 27003, 27004, 27005, 27006, 27007, 27012, 27025, 27026, 27027, 27028, 27029, 27030 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_27009", "GADGET_STATE_CHANGE_27010", "GADGET_STATE_CHANGE_27011", "GADGET_STATE_CHANGE_27033", "GADGET_STATE_CHANGE_27034", "GROUP_LOAD_27035", "GROUP_LOAD_27036" },
		rand_weight = 100
	}
}
