...
-- 装置
gadgets = {
	{ config_id = 608001, gadget_id = 70330218, pos = { x = -1166.198, y = 266.908, z = 3278.571 }, rot = { x = 0.000, y = 325.232, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 608002, gadget_id = 70330219, pos = { x = -1156.943, y = 266.551, z = 3295.297 }, rot = { x = 0.000, y = 271.672, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 608003, gadget_id = 70217020, pos = { x = -1167.450, y = 267.177, z = 3279.856 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
	...
	{ config_id = 608011, gadget_id = 70210101, pos = { x = -1165.677, y = 264.514, z = 3317.452 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 23 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 608001, 608002, 608003, 608008, 608011 },
		regions = { 608010 },
...
function action_EVENT_ANY_GADGET_DIE_608004(context, evt)
	-- 将configid为 608003 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 608003, GadgetState.Default) then
