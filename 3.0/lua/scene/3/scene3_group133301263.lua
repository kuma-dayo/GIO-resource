...
-- 怪物
monsters = {
	{ config_id = 263001, monster_id = 26090901, pos = { x = -632.311, y = 125.280, z = 3811.380 }, rot = { x = 0.000, y = 343.666, z = 0.000 }, level = 33, drop_tag = "蕈兽", affix = { 6116 }, pose_id = 101, area_id = 25 },
	{ config_id = 263002, monster_id = 26090901, pos = { x = -635.058, y = 125.002, z = 3812.087 }, rot = { x = 0.000, y = 35.296, z = 0.000 }, level = 33, drop_tag = "蕈兽", disableWander = true, affix = { 6117 }, pose_id = 104, area_id = 25 },
...
-- 装置
gadgets = {
	{ config_id = 263003, gadget_id = 70210101, pos = { x = -632.004, y = 125.863, z = 3810.383 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
	{ config_id = 263005, gadget_id = 70210101, pos = { x = -644.377, y = 127.025, z = 3804.686 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
	{ config_id = 263006, gadget_id = 70210101, pos = { x = -648.081, y = 140.574, z = 4004.394 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
