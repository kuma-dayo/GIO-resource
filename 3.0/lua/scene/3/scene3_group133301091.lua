...
gadgets = {
	...
	{ config_id = 91017, gadget_id = 70500000, pos = { x = -274.430, y = 106.107, z = 3948.937 }, rot = { x = 353.628, y = 254.735, z = 10.140 }, level = 33, point_type = 2045, area_id = 22 },
	...
	{ config_id = 91021, gadget_id = 70500000, pos = { x = -277.003, y = 120.810, z = 3947.037 }, rot = { x = 349.732, y = 176.231, z = 341.530 }, level = 27, point_type = 2046, area_id = 22 }
}
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 91001, 91002, 91011, 91012, 91013 },
