...
gadgets = {
	...
	{ config_id = 602002, gadget_id = 70330199, pos = { x = -747.769, y = 129.709, z = 3426.146 }, rot = { x = 5.556, y = 45.634, z = 358.878 }, level = 27, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_602003", "GADGET_STATE_CHANGE_602004" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
