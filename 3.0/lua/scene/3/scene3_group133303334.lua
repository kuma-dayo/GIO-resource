...
-- 装置
gadgets = {
	{ config_id = 334001, gadget_id = 70310201, pos = { x = -1797.973, y = 92.448, z = 3383.004 }, rot = { x = 0.000, y = 144.241, z = 0.000 }, level = 30, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 23 },
	...
	{ config_id = 334006, gadget_id = 70211001, pos = { x = -1793.088, y = 93.231, z = 3390.632 }, rot = { x = 7.736, y = 263.079, z = 357.279 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
-- 触发器
triggers = {
	{ config_id = 1334003, name = "GADGET_STATE_CHANGE_334003", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_334003", action = "action_EVENT_GADGET_STATE_CHANGE_334003" },
	{ config_id = 1334005, name = "GROUP_LOAD_334005", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_334005", action = "action_EVENT_GROUP_LOAD_334005" }
}
