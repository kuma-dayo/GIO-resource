...
triggers = {
	...
	{ config_id = 1116026, name = "GADGET_STATE_CHANGE_116026", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_116026", action = "action_EVENT_GADGET_STATE_CHANGE_116026" },
	{ config_id = 1116027, name = "GADGET_STATE_CHANGE_116027", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_116027", action = "action_EVENT_GADGET_STATE_CHANGE_116027" },
	...
	{ config_id = 1116031, name = "GADGET_STATE_CHANGE_116031", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_116031", action = "action_EVENT_GADGET_STATE_CHANGE_116031" },
	{ config_id = 1116032, name = "GADGET_STATE_CHANGE_116032", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_116032", action = "action_EVENT_GADGET_STATE_CHANGE_116032" },
	{ config_id = 1116053, name = "GADGET_STATE_CHANGE_116053", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_116053", action = "action_EVENT_GADGET_STATE_CHANGE_116053" },
