...
-- 装置
gadgets = {
	{ config_id = 265001, gadget_id = 70211101, pos = { x = -1631.762, y = 309.880, z = 3661.026 }, rot = { x = 0.000, y = 52.823, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	{ config_id = 265002, gadget_id = 70350093, pos = { x = -1597.148, y = 285.701, z = 3735.074 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 23 },
