...
-- 怪物
monsters = {
	{ config_id = 480001, monster_id = 26090201, pos = { x = -1057.580, y = 188.499, z = 3748.950 }, rot = { x = 0.000, y = 307.788, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 480002, gadget_id = 70330199, pos = { x = -1057.325, y = 188.334, z = 3748.588 }, rot = { x = 0.000, y = 307.788, z = 0.000 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
