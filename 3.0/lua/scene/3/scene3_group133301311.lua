...
gadgets = {
	...
	{ config_id = 311008, gadget_id = 70330199, pos = { x = -814.137, y = -42.033, z = 3167.450 }, rot = { x = 9.191, y = 354.148, z = 9.189 }, level = 30, area_id = 23 },
...
triggers = {
	...
	{ config_id = 1311020, name = "GADGET_CREATE_311020", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_311020", action = "action_EVENT_GADGET_CREATE_311020" },
	-- 保底
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_311010", "GADGET_STATE_CHANGE_311011", "GADGET_STATE_CHANGE_311012", "GADGET_STATE_CHANGE_311013", "GADGET_STATE_CHANGE_311014", "GADGET_STATE_CHANGE_311015", "GADGET_STATE_CHANGE_311016", "GADGET_STATE_CHANGE_311017", "GADGET_STATE_CHANGE_311018", "GADGET_STATE_CHANGE_311019", "GROUP_LOAD_311021" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { },
		gadgets = { 311001, 311002, 311003, 311006, 311007, 311008, 311009 },
		regions = { },
		triggers = { "GADGET_CREATE_311020" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_311020(context, evt)
...
-- 触发操作
function action_EVENT_GADGET_CREATE_311020(context, evt)
	-- 将configid为 311001 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 311001, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
