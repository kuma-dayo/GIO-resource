...
gadgets = {
	...
	[461003] = { config_id = 461003, gadget_id = 70290264, pos = { x = -820.938, y = -41.778, z = 3180.848 }, rot = { x = 359.394, y = 158.892, z = 358.215 }, level = 30, area_id = 23 },
	-- 2号门trigger 下面参数为传送后坐标
	[461004] = { config_id = 461004, gadget_id = 70290264, pos = { x = -815.891, y = 11.716, z = 3186.120 }, rot = { x = 0.000, y = 60.153, z = 0.000 }, level = 30, area_id = 23 }
}
