...
gadgets = {
	...
	{ config_id = 158005, gadget_id = 70220036, pos = { x = -241.383, y = 183.559, z = 2422.962 }, rot = { x = 37.414, y = 86.316, z = 249.421 }, level = 1, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, area_id = 24 }
}
