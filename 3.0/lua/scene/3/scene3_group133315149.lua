...
-- 装置
gadgets = {
	[149001] = { config_id = 149001, gadget_id = 70330236, pos = { x = 144.844, y = 249.768, z = 2787.083 }, rot = { x = 359.984, y = 235.728, z = 359.956 }, level = 27, persistent = true, area_id = 20 },
	[149002] = { config_id = 149002, gadget_id = 70330236, pos = { x = 173.160, y = 200.287, z = 2797.221 }, rot = { x = -0.001, y = 257.270, z = 0.047 }, level = 27, persistent = true, area_id = 20 },
...
function action_EVENT_GADGET_STATE_CHANGE_149008(context, evt)
	-- 触发镜头注目，注目位置为坐标（139，209，2793），持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=139, y=209, z=2793}
