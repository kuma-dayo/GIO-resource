...
monsters = {
	...
	{ config_id = 524003, monster_id = 28050106, pos = { x = -1348.696, y = 154.142, z = 3385.915 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 524005, gadget_id = 70217020, pos = { x = -1348.841, y = 154.138, z = 3385.874 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
