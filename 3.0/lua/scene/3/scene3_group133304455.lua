...
gadgets = {
	...
	{ config_id = 455005, gadget_id = 70217020, pos = { x = -1621.624, y = 129.706, z = 2078.336 }, rot = { x = 0.000, y = 326.741, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 21 }
}
...
-- 触发器
triggers = {
	{ config_id = 1455004, name = "ANY_GADGET_DIE_455004", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_455004", action = "action_EVENT_ANY_GADGET_DIE_455004", trigger_count = 0 }
}
