...
suites = {
	{
		...
		gadgets = { 435001 },
		regions = { },
		triggers = { "VARIABLE_CHANGE_435002", "VARIABLE_CHANGE_435004" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_435004(context, evt)
	if evt.param1 == evt.param2 then return false end
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_435004(context, evt)
	-- 将本组内变量名为 "suit2" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "suit2", 1, 133301435) then
