...
-- 怪物
monsters = {
	{ config_id = 286001, monster_id = 22010401, pos = { x = -908.603, y = 333.655, z = 3352.152 }, rot = { x = 0.000, y = 123.448, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 9013, area_id = 23 },
	{ config_id = 286007, monster_id = 21030201, pos = { x = -905.106, y = 334.568, z = 3352.306 }, rot = { x = 0.000, y = 249.047, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 9012, area_id = 23 },
	{ config_id = 286008, monster_id = 21030601, pos = { x = -905.875, y = 333.887, z = 3348.223 }, rot = { x = 0.000, y = 345.686, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, pose_id = 9012, area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 286009, gadget_id = 70211001, pos = { x = -908.945, y = 335.051, z = 3356.157 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
