...
-- 怪物
monsters = {
	{ config_id = 180001, monster_id = 24021101, pos = { x = -905.485, y = -5.517, z = 3142.707 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 180002, gadget_id = 70211031, pos = { x = -921.445, y = -5.634, z = 3145.250 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 26, drop_tag = "战斗超级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	{ config_id = 180003, gadget_id = 70360001, pos = { x = -912.085, y = -5.558, z = 3130.830 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 }
}
