...
monsters = {
	...
	{ config_id = 207010, monster_id = 28030313, pos = { x = -422.359, y = 209.188, z = 3144.103 }, rot = { x = 0.000, y = 199.696, z = 0.000 }, level = 33, drop_tag = "鸟类", area_id = 22 },
	{ config_id = 207011, monster_id = 28030313, pos = { x = -408.892, y = 213.136, z = 3134.286 }, rot = { x = 0.000, y = 247.588, z = 0.000 }, level = 33, drop_tag = "鸟类", area_id = 22 },
	{ config_id = 207012, monster_id = 28030313, pos = { x = -472.182, y = 209.690, z = 3122.134 }, rot = { x = 0.000, y = 153.617, z = 0.000 }, level = 33, drop_tag = "鸟类", area_id = 22 }
}
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 207001, 207002, 207003, 207004, 207005, 207006, 207007, 207008, 207009, 207010, 207011, 207012 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
