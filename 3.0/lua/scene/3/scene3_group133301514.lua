...
-- 装置
gadgets = {
	{ config_id = 514002, gadget_id = 70210101, pos = { x = -379.669, y = 213.920, z = 3685.537 }, rot = { x = 0.000, y = 148.757, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜武器须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 514003, gadget_id = 70210101, pos = { x = -380.830, y = 213.878, z = 3687.244 }, rot = { x = 0.000, y = 148.757, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 514004, gadget_id = 70210101, pos = { x = -379.431, y = 214.179, z = 3688.831 }, rot = { x = 0.000, y = 148.757, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜武器须弥", isOneoff = true, persistent = true, area_id = 22 },
	...
	{ config_id = 514007, gadget_id = 70330219, pos = { x = -365.500, y = 207.244, z = 3634.823 }, rot = { x = 0.000, y = 277.373, z = 0.000 }, level = 27, isOneoff = true, area_id = 22 }
}
...
suites = {
	{
		...
		gadgets = { 514002, 514003, 514004, 514005, 514007 },
		regions = { },
...
function action_EVENT_ANY_GADGET_DIE_514011(context, evt)
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 514008, delay_time = 0 }) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : create_monster")
	  return -1
	end
	
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 514009, delay_time = 0 }) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : create_monster")
	  return -1
	end
	
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 514010, delay_time = 0 }) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : create_monster")
	  return -1
	end
