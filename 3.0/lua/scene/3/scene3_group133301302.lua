...
-- 怪物
monsters = {
	[302001] = { config_id = 302001, monster_id = 26090501, pos = { x = -284.909, y = 192.300, z = 3303.440 }, rot = { x = 0.000, y = 292.562, z = 0.000 }, level = 27, drop_tag = "蕈兽", affix = { 6117 }, pose_id = 101, area_id = 22 },
	[302002] = { config_id = 302002, monster_id = 26120201, pos = { x = -288.058, y = 192.300, z = 3304.550 }, rot = { x = 0.000, y = 293.567, z = 0.000 }, level = 27, drop_tag = "大蕈兽", affix = { 6116, 6117, 1009, 1007 }, isElite = true, pose_id = 201, area_id = 22 },
	[302003] = { config_id = 302003, monster_id = 26090501, pos = { x = -292.748, y = 192.300, z = 3302.328 }, rot = { x = 0.000, y = 292.562, z = 0.000 }, level = 27, drop_tag = "蕈兽", affix = { 6117 }, pose_id = 101, area_id = 22 },
	[302016] = { config_id = 302016, monster_id = 26120201, pos = { x = -269.940, y = 192.300, z = 3307.773 }, rot = { x = 0.000, y = 248.853, z = 0.000 }, level = 27, drop_tag = "大蕈兽", affix = { 6117 }, pose_id = 201, area_id = 22 }
}
...
-- 装置
gadgets = {
	[302004] = { config_id = 302004, gadget_id = 70211121, pos = { x = -300.299, y = 192.414, z = 3303.016 }, rot = { x = 357.600, y = 296.574, z = 3.743 }, level = 26, drop_tag = "解谜高级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 22 },
	...
	[302012] = { config_id = 302012, gadget_id = 70310191, pos = { x = -297.742, y = 192.300, z = 3310.437 }, rot = { x = 0.000, y = 273.591, z = 0.000 }, level = 27, persistent = true, area_id = 22 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "LUA_NOTIFY_302013", "VARIABLE_CHANGE_302015", "ANY_GADGET_DIE_302023", "ANY_GADGET_DIE_302024", "ANY_GADGET_DIE_302025", "ANY_GADGET_DIE_302026" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 302004, 302012, 302017, 302018 },
		regions = { },
		triggers = { },
		rand_weight = 100
	},
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_302015(context, evt)
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_302015(context, evt)
	-- 改变指定group组133301640中， configid为640002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 133301640, 640002, GadgetState.Default) then
