...
-- 触发器
triggers = {
	{ config_id = 1265002, name = "GADGET_STATE_CHANGE_265002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "265001", condition = "condition_EVENT_GADGET_STATE_CHANGE_265002", action = "action_EVENT_GADGET_STATE_CHANGE_265002" }
}
