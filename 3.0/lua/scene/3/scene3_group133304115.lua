...
triggers = {
	...
	{ config_id = 1115028, name = "VARIABLE_CHANGE_115028", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_115028", action = "action_EVENT_VARIABLE_CHANGE_115028" },
	{ config_id = 1115029, name = "VARIABLE_CHANGE_115029", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_115029", action = "action_EVENT_VARIABLE_CHANGE_115029" },
	{ config_id = 1115030, name = "VARIABLE_CHANGE_115030", event = EventType.EVENT_VARIABLE_CHANGE, source = "", condition = "condition_EVENT_VARIABLE_CHANGE_115030", action = "action_EVENT_VARIABLE_CHANGE_115030" }
}
