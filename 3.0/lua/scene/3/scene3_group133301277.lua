...
-- 装置
gadgets = {
	{ config_id = 277002, gadget_id = 70360001, pos = { x = -241.533, y = 238.713, z = 3473.828 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 29 },
	{ config_id = 277003, gadget_id = 70360001, pos = { x = -239.349, y = 238.311, z = 3476.861 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 29 },
	{ config_id = 277005, gadget_id = 70360001, pos = { x = -270.560, y = 193.485, z = 3228.330 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 22 },
	{ config_id = 277008, gadget_id = 70360001, pos = { x = -270.560, y = 193.485, z = 3228.330 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 22 }
}
...
regions = {
	...
	-- 8
	{ config_id = 277007, shape = RegionShape.SPHERE, radius = 8, pos = { x = -279.814, y = 196.371, z = 3234.118 }, area_id = 22 }
}
...
triggers = {
	...
	-- 8
	{ config_id = 1277007, name = "ENTER_REGION_277007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "", action = "action_EVENT_ENTER_REGION_277007" },
	{ config_id = 1277009, name = "TIME_AXIS_PASS_277009", event = EventType.EVENT_TIME_AXIS_PASS, source = "", condition = "condition_EVENT_TIME_AXIS_PASS_277009", action = "action_EVENT_TIME_AXIS_PASS_277009" }
}
...
suites = {
	...
	},
	{
		...
		regions = { 277007 },
		triggers = { "ENTER_REGION_277007", "TIME_AXIS_PASS_277009" },
		rand_weight = 100
	}
}
...
function action_EVENT_ENTER_REGION_277007(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-288.6656, y=193.9757, z=3218.984}，持续时间为1.5秒，并且为强制注目形式，不广播其他玩家
	...
	-- 创建标识为"add"，时间节点为{3}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "add", {3}, false)
...
-- 触发条件
function condition_EVENT_TIME_AXIS_PASS_277009(context, evt)
...
-- 触发操作
function action_EVENT_TIME_AXIS_PASS_277009(context, evt)
