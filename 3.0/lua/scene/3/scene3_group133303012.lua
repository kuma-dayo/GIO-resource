...
gadgets = {
	...
	{ config_id = 12004, gadget_id = 70217020, pos = { x = -1743.877, y = 5.697, z = 3241.295 }, rot = { x = 0.000, y = 46.175, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
