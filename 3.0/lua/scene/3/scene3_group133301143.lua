...
gadgets = {
	...
	{ config_id = 143011, gadget_id = 70210101, pos = { x = -772.327, y = 151.018, z = 4012.452 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
	{ config_id = 143012, gadget_id = 70210101, pos = { x = -756.136, y = 149.370, z = 4016.041 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
	{ config_id = 143013, gadget_id = 70210101, pos = { x = -771.512, y = 151.075, z = 4015.062 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 },
	{ config_id = 143014, gadget_id = 70210101, pos = { x = -761.853, y = 149.100, z = 4020.118 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 25 }
}
...
-- 触发器
triggers = {
	{ config_id = 1143003, name = "QUEST_FINISH_143003", event = EventType.EVENT_QUEST_FINISH, source = "7303510", condition = "", action = "action_EVENT_QUEST_FINISH_143003", trigger_count = 0 }
}
