...
triggers = {
	...
	{ config_id = 1684010, name = "ANY_MONSTER_DIE_684010", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_684010", action = "action_EVENT_ANY_MONSTER_DIE_684010" }
}
...
suites = {
	{
		...
		gadgets = { 684002 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_684003", "ANY_MONSTER_DIE_684010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_ANY_MONSTER_DIE_684010(context, evt)
	-- 判断剩余怪物数量是否是3
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_684010(context, evt)
	-- 添加suite2的新内容
