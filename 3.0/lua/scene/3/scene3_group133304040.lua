...
-- 装置
gadgets = {
	{ config_id = 40001, gadget_id = 70350432, pos = { x = -1574.757, y = 269.465, z = 2322.990 }, rot = { x = 23.130, y = 65.854, z = 4.222 }, level = 30, state = GadgetState.Action01, persistent = true, area_id = 21 },
	-- 通知任务
	...
	{ config_id = 40011, gadget_id = 70350432, pos = { x = -1574.757, y = 269.465, z = 2322.990 }, rot = { x = 23.130, y = 65.854, z = 4.222 }, level = 19, state = GadgetState.GearStart, persistent = true, area_id = 21 }
}
