...
-- 装置
gadgets = {
	{ config_id = 269006, gadget_id = 70210101, pos = { x = -1091.847, y = 273.913, z = 2154.947 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 21 },
