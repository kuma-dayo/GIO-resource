...
monsters = {
	...
	{ config_id = 3002, monster_id = 24030101, pos = { x = -482.288, y = 225.902, z = 4000.293 }, rot = { x = 0.000, y = 109.478, z = 0.000 }, level = 33, drop_tag = "遗迹龙兽", disableWander = true, pose_id = 102, area_id = 22 },
...
-- 触发器
triggers = {
	{ config_id = 1003007, name = "MONSTER_BATTLE_3007", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_3007", action = "action_EVENT_MONSTER_BATTLE_3007", trigger_count = 0 }
}
