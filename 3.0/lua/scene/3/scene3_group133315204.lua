...
gadgets = {
	...
	{ config_id = 204004, gadget_id = 70211101, pos = { x = 155.164, y = 197.808, z = 2786.442 }, rot = { x = 4.817, y = 341.255, z = 358.368 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}
