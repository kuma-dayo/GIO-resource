...
gadgets = {
	...
	{ config_id = 238004, gadget_id = 70211102, pos = { x = 287.945, y = 225.182, z = 2522.843 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 },
