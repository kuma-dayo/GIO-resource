...
monsters = {
	...
	{ config_id = 567003, monster_id = 28050106, pos = { x = -1655.161, y = 105.660, z = 3187.833 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 567005, gadget_id = 70217020, pos = { x = -1655.306, y = 105.672, z = 3187.792 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
