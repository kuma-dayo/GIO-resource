...
-- 装置
gadgets = {
	{ config_id = 616001, gadget_id = 70330199, pos = { x = -820.926, y = 162.178, z = 2297.589 }, rot = { x = 1.747, y = 228.427, z = 7.866 }, level = 27, state = GadgetState.GearStop, area_id = 24 },
	{ config_id = 616002, gadget_id = 70217020, pos = { x = -821.202, y = 162.457, z = 2297.542 }, rot = { x = 0.000, y = 47.739, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 24 }
}
