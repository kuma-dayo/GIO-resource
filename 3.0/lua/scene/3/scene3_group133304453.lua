...
-- 装置
gadgets = {
	{ config_id = 453001, gadget_id = 70710006, pos = { x = -1453.901, y = 227.923, z = 2768.723 }, rot = { x = 357.955, y = 88.751, z = 0.111 }, level = 30, area_id = 21 },
	...
	{ config_id = 453003, gadget_id = 70710007, pos = { x = -1450.264, y = 227.713, z = 2768.248 }, rot = { x = 3.951, y = 280.727, z = 0.000 }, level = 30, area_id = 21 },
	{ config_id = 453004, gadget_id = 70211101, pos = { x = -1453.595, y = 231.055, z = 2776.311 }, rot = { x = 0.000, y = 0.000, z = 7.380 }, level = 26, drop_tag = "解谜低级须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
