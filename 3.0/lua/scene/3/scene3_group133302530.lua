...
-- 装置
gadgets = {
	{ config_id = 530001, gadget_id = 70310479, pos = { x = -377.890, y = 240.105, z = 2703.902 }, rot = { x = 0.000, y = 44.727, z = 0.000 }, level = 27, state = GadgetState.GearStart, area_id = 24 },
	{ config_id = 530002, gadget_id = 70310479, pos = { x = -383.408, y = 240.105, z = 2697.061 }, rot = { x = 0.000, y = 44.727, z = 0.000 }, level = 27, state = GadgetState.GearStart, area_id = 24 },
