...
monsters = {
	...
	{ config_id = 186006, monster_id = 28030313, pos = { x = 24.695, y = 459.361, z = 2042.674 }, rot = { x = 0.000, y = 321.053, z = 0.000 }, level = 27, drop_tag = "鸟类", disableWander = true, area_id = 20 },
	{ config_id = 186007, monster_id = 28030313, pos = { x = 55.860, y = 456.662, z = 2040.660 }, rot = { x = 0.000, y = 112.606, z = 0.000 }, level = 27, drop_tag = "鸟类", disableWander = true, area_id = 20 },
	{ config_id = 186008, monster_id = 28030313, pos = { x = 55.342, y = 457.125, z = 2038.709 }, rot = { x = 0.000, y = 240.746, z = 0.000 }, level = 27, drop_tag = "鸟类", disableWander = true, area_id = 20 },
...
-- 装置
gadgets = {
	{ config_id = 186001, gadget_id = 70500000, pos = { x = 41.795, y = 468.567, z = 2058.874 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, point_type = 4014, isOneoff = true, explore = { name = "gather", exp = 30 }, area_id = 20 },
	...
	{ config_id = 186018, gadget_id = 70500000, pos = { x = 46.490, y = 458.389, z = 2058.813 }, rot = { x = 0.000, y = 40.703, z = 0.000 }, level = 27, point_type = 3003, area_id = 20 },
	{ config_id = 186019, gadget_id = 70500000, pos = { x = 46.314, y = 458.495, z = 2059.111 }, rot = { x = 0.000, y = 167.542, z = 0.000 }, level = 27, point_type = 3003, area_id = 20 }
}
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 186002, 186003, 186004, 186005, 186006, 186007, 186008, 186020, 186021, 186022 },
