...
monsters = {
	...
	{ config_id = 109004, monster_id = 25210501, pos = { x = -1450.529, y = 283.359, z = 3718.046 }, rot = { x = 0.000, y = 18.837, z = 0.000 }, level = 30, drop_tag = "镀金旅团", disableWander = true, pose_id = 9001, area_id = 23 },
	...
	{ config_id = 109008, monster_id = 25210402, pos = { x = -1450.638, y = 283.312, z = 3720.587 }, rot = { x = 0.000, y = 163.486, z = 0.000 }, level = 30, drop_tag = "镀金旅团", disableWander = true, pose_id = 9511, area_id = 23 },
...
gadgets = {
	...
	{ config_id = 109006, gadget_id = 70220128, pos = { x = -1450.308, y = 283.302, z = 3719.004 }, rot = { x = 359.494, y = 256.089, z = 357.369 }, level = 30, area_id = 23 },
	{ config_id = 109007, gadget_id = 70220048, pos = { x = -1455.576, y = 279.340, z = 3729.871 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 },
	{ config_id = 109010, gadget_id = 70210101, pos = { x = -1455.532, y = 279.353, z = 3731.323 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 }
}
