...
-- 装置
gadgets = {
	[462001] = { config_id = 462001, gadget_id = 70330236, pos = { x = -837.008, y = 10.754, z = 3134.763 }, rot = { x = 0.018, y = 190.328, z = 359.957 }, level = 30, persistent = true, area_id = 23 },
	...
	[462003] = { config_id = 462003, gadget_id = 70290264, pos = { x = -837.148, y = 10.543, z = 3131.439 }, rot = { x = 0.000, y = 187.662, z = 0.000 }, level = 30, area_id = 23 },
	-- 2号门trigger 下面参数为传送后坐标
	[462004] = { config_id = 462004, gadget_id = 70290264, pos = { x = -836.678, y = -33.673, z = 3140.729 }, rot = { x = 2.147, y = 18.489, z = 358.874 }, level = 30, area_id = 23 }
}
