...
-- 装置
gadgets = {
	{ config_id = 120004, gadget_id = 70211102, pos = { x = -1528.888, y = 243.366, z = 3757.049 }, rot = { x = 2.408, y = 71.249, z = 13.334 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestTrap, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}

-- 区域
regions = {
	{ config_id = 120005, shape = RegionShape.SPHERE, radius = 5, pos = { x = -1532.965, y = 240.257, z = 3761.656 }, area_id = 23 }
}
