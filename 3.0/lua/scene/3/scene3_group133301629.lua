...
-- 装置
gadgets = {
	{ config_id = 629001, gadget_id = 70210101, pos = { x = -867.008, y = 177.213, z = 3673.415 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 23 }
}
