...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_160005", "QUEST_START_160006", "QUEST_START_160008", "GADGET_STATE_CHANGE_160011", "QUEST_FINISH_160012", "QUEST_START_160013", "QUEST_FINISH_160014", "QUEST_START_160015", "SELECT_OPTION_160017" },
		rand_weight = 100
	}
}
...
function action_EVENT_QUEST_FINISH_160014(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133302160, EntityType.GADGET, 160016 ) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : remove_gadget_by_configid")
			return -1
		end
