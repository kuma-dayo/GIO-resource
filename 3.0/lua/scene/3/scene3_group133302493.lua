...
monsters = {
	...
	{ config_id = 493010, monster_id = 21010401, pos = { x = -397.250, y = 200.317, z = 2943.824 }, rot = { x = 0.000, y = 348.039, z = 0.000 }, level = 27, drop_tag = "远程丘丘人", pose_id = 9011, area_id = 24 },
...
suites = {
	{
		...
		gadgets = { 493002, 493003, 493004, 493005, 493006, 493007, 493011, 493013, 493015, 493016 },
		regions = { },
