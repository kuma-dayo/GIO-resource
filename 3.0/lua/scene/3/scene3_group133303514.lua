...
monsters = {
	...
	{ config_id = 514003, monster_id = 28050106, pos = { x = -1268.728, y = 152.968, z = 3415.752 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 514005, gadget_id = 70217020, pos = { x = -1268.873, y = 152.924, z = 3415.711 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
