...
-- 装置
gadgets = {
	{ config_id = 101002, gadget_id = 70211002, pos = { x = 213.243, y = 272.872, z = 2291.981 }, rot = { x = 0.000, y = 309.043, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}
