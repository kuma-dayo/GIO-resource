...
-- 装置
gadgets = {
	{ config_id = 102002, gadget_id = 70211002, pos = { x = -280.760, y = 301.554, z = 1982.074 }, rot = { x = 0.000, y = 44.905, z = 0.000 }, level = 26, drop_tag = "战斗低级璃月", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 6 },
	{ config_id = 102006, gadget_id = 70300089, pos = { x = -268.466, y = 300.078, z = 1988.449 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 6 },
	...
	{ config_id = 102008, gadget_id = 70220013, pos = { x = -269.536, y = 301.259, z = 1979.115 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 6 },
