...
monsters = {
	...
	{ config_id = 269003, monster_id = 25020201, pos = { x = -509.463, y = 206.276, z = 3427.978 }, rot = { x = 0.000, y = 28.412, z = 0.000 }, level = 33, drop_tag = "盗宝团", disableWander = true, pose_id = 9004, area_id = 22 },
...
gadgets = {
	...
	{ config_id = 269008, gadget_id = 70210101, pos = { x = -491.200, y = 211.528, z = 3434.448 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜武器须弥", isOneoff = true, persistent = true, area_id = 22 }
}
...
triggers = {
	...
	{ config_id = 1269009, name = "MONSTER_BATTLE_269009", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_269009", action = "action_EVENT_MONSTER_BATTLE_269009", trigger_count = 0 }
}
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 269002, 269003, 269004 },
		gadgets = { 269005, 269006, 269008 },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_269007", "MONSTER_BATTLE_269009" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_MONSTER_BATTLE_269009(context, evt)
	if 269004 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_MONSTER_BATTLE_269009(context, evt)
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 269001, delay_time = 0 }) then
