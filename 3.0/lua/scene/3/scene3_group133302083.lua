...
-- 怪物
monsters = {
	{ config_id = 83020, monster_id = 28030313, pos = { x = -565.756, y = 131.772, z = 2268.075 }, rot = { x = 0.000, y = 199.002, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 83021, monster_id = 28030313, pos = { x = -651.059, y = 132.255, z = 2263.521 }, rot = { x = 0.000, y = 114.947, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 83022, monster_id = 28030313, pos = { x = -644.980, y = 148.084, z = 2296.782 }, rot = { x = 0.000, y = 114.947, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 }
}
...
gadgets = {
	...
	{ config_id = 83007, gadget_id = 70217020, pos = { x = -671.051, y = 130.243, z = 2314.468 }, rot = { x = 0.000, y = 320.499, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 24 },
