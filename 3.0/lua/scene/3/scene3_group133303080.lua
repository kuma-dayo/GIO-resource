...
triggers = {
	...
	{ config_id = 1080008, name = "GROUP_LOAD_80008", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_80008", action = "action_EVENT_GROUP_LOAD_80008" }
}
