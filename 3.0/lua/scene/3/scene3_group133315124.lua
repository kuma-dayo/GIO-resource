...
-- 怪物
monsters = {
	{ config_id = 124001, monster_id = 25210502, pos = { x = 102.256, y = 285.001, z = 2346.305 }, rot = { x = 0.000, y = 304.292, z = 0.000 }, level = 27, drop_tag = "镀金旅团", disableWander = true, pose_id = 9512, area_id = 20 },
	{ config_id = 124004, monster_id = 25210303, pos = { x = 100.555, y = 284.819, z = 2347.222 }, rot = { x = 0.000, y = 119.736, z = 0.000 }, level = 27, drop_tag = "镀金旅团", pose_id = 9511, area_id = 20 },
...
gadgets = {
	...
	{ config_id = 124010, gadget_id = 70210101, pos = { x = 105.668, y = 285.285, z = 2347.748 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 124011, gadget_id = 70210101, pos = { x = 104.003, y = 284.990, z = 2350.618 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 124012, gadget_id = 70210101, pos = { x = 106.848, y = 284.863, z = 2346.583 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 20 }
}
