...
gadgets = {
	...
	{ config_id = 287002, gadget_id = 70710010, pos = { x = -1078.204, y = 216.325, z = 2261.500 }, rot = { x = 0.000, y = 133.053, z = 0.000 }, level = 27, route_id = 330400029, area_id = 21 },
	{ config_id = 287003, gadget_id = 70710007, pos = { x = -1056.324, y = 219.838, z = 2224.418 }, rot = { x = 0.000, y = 185.935, z = 0.000 }, level = 27, area_id = 24 },
...
-- 区域
regions = {
	{ config_id = 287007, shape = RegionShape.SPHERE, radius = 2, pos = { x = -1077.771, y = 216.368, z = 2261.501 }, area_id = 21 }
}
...
function action_EVENT_PLATFORM_REACH_POINT_287024(context, evt)
	...
	-- 将本组内变量名为 "allowActive" 的变量设置为 1
	if 0 ~= ScriptLib.SetGroupVariableValueByGroup(context, "allowActive", 1, 133304291) then
