...
gadgets = {
	...
	{ config_id = 113014, gadget_id = 70211001, pos = { x = -246.511, y = 302.453, z = 2114.832 }, rot = { x = 0.548, y = 259.334, z = 358.075 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 }
}
...
suites = {
	...
	},
	{
		...
		regions = { 113012 },
		triggers = { "ANY_GADGET_DIE_113007", "TIME_AXIS_PASS_113011", "ENTER_REGION_113012" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
