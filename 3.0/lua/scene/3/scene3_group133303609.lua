...
-- 装置
gadgets = {
	{ config_id = 609001, gadget_id = 70217020, pos = { x = -1333.920, y = 202.009, z = 3263.406 }, rot = { x = 0.000, y = 216.960, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
	{ config_id = 609002, gadget_id = 70330199, pos = { x = -1333.982, y = 201.189, z = 3263.271 }, rot = { x = 0.000, y = 13.144, z = 0.000 }, level = 30, state = GadgetState.GearStop, area_id = 23 }
}
