...
gadgets = {
	...
	{ config_id = 134008, gadget_id = 70310216, pos = { x = 461.239, y = 154.834, z = 2339.115 }, rot = { x = 0.000, y = 226.883, z = 0.000 }, level = 27, area_id = 20 }
}
...
suites = {
	{
		...
		gadgets = { 134008 },
		regions = { 134001 },
		triggers = { "ENTER_REGION_134001", "ANY_GADGET_DIE_134009" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
