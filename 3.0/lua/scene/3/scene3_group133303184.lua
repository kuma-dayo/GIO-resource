...
-- 装置
gadgets = {
	{ config_id = 184001, gadget_id = 70330216, pos = { x = -1696.278, y = 254.569, z = 3130.110 }, rot = { x = 4.102, y = 122.646, z = 2.513 }, level = 30, state = GadgetState.GearStop, persistent = true, area_id = 23 },
