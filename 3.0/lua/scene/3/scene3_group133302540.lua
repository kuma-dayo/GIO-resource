...
gadgets = {
	...
	{ config_id = 540003, gadget_id = 70217020, pos = { x = -33.318, y = 284.182, z = 2779.021 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 20 },
	...
	{ config_id = 540005, gadget_id = 70217020, pos = { x = -387.774, y = 201.427, z = 2981.250 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 24 }
}
