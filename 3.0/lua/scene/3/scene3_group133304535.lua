...
-- 装置
gadgets = {
	{ config_id = 535001, gadget_id = 70330238, pos = { x = -1862.460, y = 226.329, z = 2348.727 }, rot = { x = 9.744, y = 319.889, z = 356.451 }, level = 30, persistent = true, area_id = 21 },
	{ config_id = 535002, gadget_id = 70290559, pos = { x = -1860.388, y = 227.119, z = 2344.932 }, rot = { x = 355.975, y = 112.270, z = 5.095 }, level = 30, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 21 },
	{ config_id = 535006, gadget_id = 70290485, pos = { x = -1860.515, y = 229.180, z = 2343.286 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 21 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_535003", "GROUP_LOAD_535004", "GADGET_STATE_CHANGE_535005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_GADGET_STATE_CHANGE_535003(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133304535, EntityType.GADGET, 535002 ) then
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_535004(context, evt)
	if GadgetState.GearStop ~= ScriptLib.GetGadgetStateByConfigId(context, 133304535, 535001) then
		return false
	end
...
-- 触发操作
function action_EVENT_GROUP_LOAD_535004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133304535, suite = 2 }) then
