...
-- 装置
gadgets = {
	{ config_id = 349001, gadget_id = 70360363, pos = { x = -1783.901, y = 283.336, z = 2838.895 }, rot = { x = 0.000, y = 8.091, z = 0.000 }, level = 30, isOneoff = true, persistent = true, interact_id = 123, explore = { name = "temple", exp = 140 }, area_id = 21 },
	{ config_id = 349002, gadget_id = 70211131, pos = { x = -1783.691, y = 284.342, z = 2839.149 }, rot = { x = 0.000, y = 10.585, z = 0.000 }, level = 26, drop_tag = "灵龛须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
