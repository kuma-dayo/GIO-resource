...
monsters = {
	...
	{ config_id = 501005, monster_id = 26090401, pos = { x = -1073.647, y = 222.312, z = 2329.972 }, rot = { x = 0.000, y = 294.830, z = 0.000 }, level = 27, drop_tag = "蕈兽", pose_id = 101, area_id = 21 },
	{ config_id = 501009, monster_id = 20011301, pos = { x = -1071.160, y = 221.251, z = 2328.924 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "大史莱姆", area_id = 21 },
...
gadgets = {
	...
	{ config_id = 501006, gadget_id = 70330216, pos = { x = -1074.504, y = 222.950, z = 2331.033 }, rot = { x = 0.000, y = 262.526, z = 0.000 }, level = 27, area_id = 21 },
...
triggers = {
	...
	{ config_id = 1501008, name = "ANY_MONSTER_DIE_501008", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_501008", action = "action_EVENT_ANY_MONSTER_DIE_501008", trigger_count = 0 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "GROUP_LOAD_501012" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 501009, 501010, 501011 },
		gadgets = { },
		regions = { },
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_501008" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_ANY_MONSTER_DIE_501008(context, evt)
	-- 判断剩余怪物数量是否是0
	if ScriptLib.GetGroupMonsterCount(context) ~= 0 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_501008(context, evt)
	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304501, 2)
	
	-- 删除suite3的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133304501, 3)
	
	return 0
end

-- 触发操作
function action_EVENT_GROUP_LOAD_501012(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133304501, 3)
