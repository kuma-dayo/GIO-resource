...
-- 装置
gadgets = {
	{ config_id = 545001, gadget_id = 70710289, pos = { x = -108.600, y = 249.048, z = 3432.185 }, rot = { x = 359.725, y = 263.389, z = 177.624 }, level = 27, area_id = 29 },
...
triggers = {
	...
	{ config_id = 1545005, name = "GROUP_LOAD_545005", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "", action = "action_EVENT_GROUP_LOAD_545005", trigger_count = 0 }
}
