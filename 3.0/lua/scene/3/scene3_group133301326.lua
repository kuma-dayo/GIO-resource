...
gadgets = {
	...
	{ config_id = 326003, gadget_id = 70217020, pos = { x = -893.715, y = 305.829, z = 3136.155 }, rot = { x = 351.686, y = 181.027, z = 347.904 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
