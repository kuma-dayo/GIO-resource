...
-- 装置
gadgets = {
	{ config_id = 298001, gadget_id = 70500000, pos = { x = -931.629, y = 317.951, z = 3296.416 }, rot = { x = 4.900, y = 0.000, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 23, is_enable_interact = false },
	{ config_id = 298002, gadget_id = 70330199, pos = { x = -931.737, y = 317.042, z = 3295.882 }, rot = { x = 18.156, y = 0.000, z = 0.000 }, level = 10, state = GadgetState.GearStop, area_id = 23 }
}
