...
gadgets = {
	...
	{ config_id = 738003, gadget_id = 70710007, pos = { x = -245.170, y = 278.959, z = 3479.769 }, rot = { x = 28.457, y = 178.501, z = 23.250 }, level = 27, area_id = 29 },
	{ config_id = 738010, gadget_id = 70230111, pos = { x = -245.042, y = 277.074, z = 3476.656 }, rot = { x = 335.857, y = 359.994, z = 81.478 }, level = 27, area_id = 29 }
}
...
garbages = {
	gadgets = {
		{ config_id = 738001, gadget_id = 70710006, pos = { x = -254.614, y = 265.303, z = 3493.248 }, rot = { x = 0.000, y = 317.813, z = 0.000 }, level = 27, area_id = 29 },
...
function condition_EVENT_GADGET_STATE_CHANGE_738008(context, evt)
	if 738010 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
