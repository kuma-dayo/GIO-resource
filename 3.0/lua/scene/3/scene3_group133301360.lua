...
-- 装置
gadgets = {
	[360004] = { config_id = 360004, gadget_id = 70211111, pos = { x = -716.525, y = 224.400, z = 3528.986 }, rot = { x = 0.000, y = 48.461, z = 0.000 }, level = 26, drop_tag = "解谜中级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 22 },
