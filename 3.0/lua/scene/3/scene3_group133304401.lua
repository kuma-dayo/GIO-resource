...
-- 触发器
triggers = {
	{ config_id = 1401006, name = "ANY_GADGET_DIE_401006", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_401006", action = "action_EVENT_ANY_GADGET_DIE_401006", trigger_count = 0 }
}
