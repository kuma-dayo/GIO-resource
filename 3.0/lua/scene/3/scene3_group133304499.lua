...
-- 装置
gadgets = {
	{ config_id = 499001, gadget_id = 70310198, pos = { x = -1418.226, y = 204.245, z = 2519.938 }, rot = { x = 0.000, y = 223.504, z = 0.000 }, level = 30, area_id = 21 },
	...
	{ config_id = 499014, gadget_id = 70310198, pos = { x = -1476.812, y = 209.579, z = 2527.615 }, rot = { x = 0.000, y = 174.723, z = 0.000 }, level = 30, area_id = 21 }
}
