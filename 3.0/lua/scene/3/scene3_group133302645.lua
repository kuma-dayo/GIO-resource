...
gadgets = {
	...
	{ config_id = 645005, gadget_id = 70211102, pos = { x = -649.190, y = 200.564, z = 2865.155 }, rot = { x = 0.000, y = 193.563, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 24 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_645009" },
		rand_weight = 100
	}
}
