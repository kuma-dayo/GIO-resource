...
npcs = {
	...
	{ config_id = 209013, npc_id = 12739, pos = { x = -466.574, y = 241.653, z = 2712.518 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, area_id = 24 },
	{ config_id = 209014, npc_id = 4287, pos = { x = -340.006, y = 315.422, z = 2879.775 }, rot = { x = 0.000, y = 30.000, z = 0.000 }, area_id = 24 }
}
...
gadgets = {
	...
	{ config_id = 209008, gadget_id = 71700401, pos = { x = -340.006, y = 314.189, z = 2879.775 }, rot = { x = 0.000, y = 30.000, z = 0.000 }, level = 27, area_id = 24 },
	{ config_id = 209011, gadget_id = 71700401, pos = { x = -475.380, y = 226.541, z = 2777.808 }, rot = { x = 0.000, y = 331.000, z = 0.000 }, level = 27, area_id = 24 },
	{ config_id = 209012, gadget_id = 71700401, pos = { x = -466.636, y = 240.290, z = 2712.533 }, rot = { x = 0.000, y = 120.000, z = 0.000 }, level = 27, area_id = 24 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 209001, 209002, 209003, 209004, 209005, 209008, 209011, 209012 },
		regions = { },
		triggers = { },
		npcs = { 209006, 209007, 209009, 209010, 209013, 209014 },
		rand_weight = 100
	}
}
