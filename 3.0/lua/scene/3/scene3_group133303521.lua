...
monsters = {
	...
	{ config_id = 521003, monster_id = 28050106, pos = { x = -1319.190, y = 178.562, z = 3444.604 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 521005, gadget_id = 70211150, pos = { x = -1319.335, y = 178.543, z = 3444.563 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, chest_drop_id = 21910069, drop_count = 1, showcutscene = true, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
