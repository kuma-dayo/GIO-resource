...
-- 触发器
triggers = {
	{ config_id = 1118001, name = "GADGET_STATE_CHANGE_118001", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_118001", action = "action_EVENT_GADGET_STATE_CHANGE_118001" },
	{ config_id = 1118002, name = "GADGET_STATE_CHANGE_118002", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_118002", action = "action_EVENT_GADGET_STATE_CHANGE_118002" }
}
