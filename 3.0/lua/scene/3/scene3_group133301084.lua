...
-- 装置
gadgets = {
	{ config_id = 84001, gadget_id = 70220128, pos = { x = -803.587, y = 190.120, z = 3795.542 }, rot = { x = 0.000, y = 331.442, z = 0.000 }, level = 33, area_id = 23 },
	{ config_id = 84002, gadget_id = 70211012, pos = { x = -815.484, y = 190.315, z = 3798.905 }, rot = { x = 358.524, y = 137.502, z = 2.035 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	...
	{ config_id = 84011, gadget_id = 70310001, pos = { x = -801.718, y = 189.696, z = 3799.745 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, state = GadgetState.GearStart, area_id = 23 },
	...
	{ config_id = 84017, gadget_id = 70210101, pos = { x = -804.010, y = 191.131, z = 3804.628 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 23 },
	{ config_id = 84018, gadget_id = 70210101, pos = { x = -810.056, y = 190.753, z = 3802.358 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 23 }
}
