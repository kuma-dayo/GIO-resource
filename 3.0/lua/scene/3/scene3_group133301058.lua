...
-- 装置
gadgets = {
	{ config_id = 58001, gadget_id = 70220021, pos = { x = -224.038, y = 223.653, z = 3541.957 }, rot = { x = 357.811, y = 221.017, z = 5.522 }, level = 27, area_id = 29 },
	{ config_id = 58003, gadget_id = 70360001, pos = { x = -224.435, y = 230.104, z = 3540.639 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 29 },
	{ config_id = 58006, gadget_id = 70217020, pos = { x = -228.603, y = 227.830, z = 3539.440 }, rot = { x = 0.000, y = 94.004, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 29 }
}
