...
gadgets = {
	...
	[295035] = { config_id = 295035, gadget_id = 70217020, pos = { x = -1407.360, y = 260.595, z = 3847.191 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
	...
	[295038] = { config_id = 295038, gadget_id = 70220021, pos = { x = -1387.752, y = 263.405, z = 3853.630 }, rot = { x = 22.595, y = 48.857, z = 348.978 }, level = 30, persistent = true, area_id = 23 },
...
suites = {
	...
	},
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 295004, 295012, 295017, 295018, 295043 },
		regions = { },
		triggers = { },
		rand_weight = 100
	},
