...
gadgets = {
	...
	{ config_id = 672010, gadget_id = 70710221, pos = { x = -839.516, y = 212.865, z = 3263.217 }, rot = { x = 316.011, y = 64.231, z = 69.973 }, level = 30, persistent = true, area_id = 23 },
	{ config_id = 672011, gadget_id = 70950145, pos = { x = -839.185, y = 213.274, z = 3264.802 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 1 } }, area_id = 23 },
...
-- 区域
regions = {
	{ config_id = 672007, shape = RegionShape.SPHERE, radius = 2, pos = { x = -840.143, y = 212.679, z = 3264.143 }, area_id = 23 }
}
...
triggers = {
	...
	{ config_id = 1672007, name = "ENTER_REGION_672007", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_672007", action = "action_EVENT_ENTER_REGION_672007", trigger_count = 0 },
	...
	{ config_id = 1672016, name = "GADGET_CREATE_672016", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_672016", action = "action_EVENT_GADGET_CREATE_672016" },
...
suites = {
	{
		...
		-- description = ,
		monsters = { },
		gadgets = { 672001, 672002, 672003, 672010, 672011, 672012, 672014, 672017 },
		regions = { 672007 },
		triggers = { "PLATFORM_REACH_POINT_672005", "AVATAR_NEAR_PLATFORM_672006", "ENTER_REGION_672007", "GADGET_STATE_CHANGE_672008", "GADGET_STATE_CHANGE_672015", "GADGET_CREATE_672018" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { },
		gadgets = { 672001, 672004, 672010, 672012, 672014 },
		regions = { },
		triggers = { "GADGET_CREATE_672009", "GADGET_STATE_CHANGE_672015" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { },
		gadgets = { 672001, 672002, 672003, 672010, 672011, 672012, 672014 },
		regions = { },
		triggers = { "SELECT_OPTION_672013", "GADGET_CREATE_672016" },
		rand_weight = 100
	}
}
...
function action_EVENT_PLATFORM_REACH_POINT_672005(context, evt)
	...
	-- 将configid为 672012 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 672012, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
-- 触发条件
function condition_EVENT_ENTER_REGION_672007(context, evt)
	if evt.param1 ~= 672007 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_672007(context, evt)
	-- 设置移动平台路径
...
function action_EVENT_SELECT_OPTION_672013(context, evt)
	...
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 133301672, 672011, 769) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301672, suite = 1 }) then
...
function condition_EVENT_GADGET_STATE_CHANGE_672015(context, evt)
	if 672012 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
function action_EVENT_GADGET_STATE_CHANGE_672015(context, evt)
	-- 将configid为 672014 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 672014, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
	
	-- 创建id为672004的gadget
	if 0 ~= ScriptLib.CreateGadget(context, { config_id = 672004 }) then
...
-- 触发条件
function condition_EVENT_GADGET_CREATE_672018(context, evt)
	if 672017 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_CREATE_672018(context, evt)
