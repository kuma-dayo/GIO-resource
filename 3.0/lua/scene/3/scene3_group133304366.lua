...
-- 怪物
monsters = {
	{ config_id = 366003, monster_id = 26090201, pos = { x = -1813.211, y = 255.380, z = 2734.320 }, rot = { x = 0.000, y = 33.162, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 21 },
	{ config_id = 366004, monster_id = 26090201, pos = { x = -1814.189, y = 254.810, z = 2742.965 }, rot = { x = 0.000, y = 80.670, z = 0.000 }, level = 30, drop_tag = "蕈兽", pose_id = 101, area_id = 21 },
	{ config_id = 366005, monster_id = 26120101, pos = { x = -1816.585, y = 256.994, z = 2738.911 }, rot = { x = 0.000, y = 87.872, z = 0.000 }, level = 30, drop_tag = "大蕈兽", pose_id = 201, area_id = 21 }
}
...
-- 装置
gadgets = {
	{ config_id = 366001, gadget_id = 70211002, pos = { x = -1811.312, y = 255.447, z = 2738.574 }, rot = { x = 0.000, y = 0.000, z = 354.302 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 21 }
}
