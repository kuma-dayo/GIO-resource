...
monsters = {
	...
	[420005] = { config_id = 420005, monster_id = 25310201, pos = { x = -392.187, y = 282.873, z = 4013.565 }, rot = { x = 0.000, y = 238.538, z = 0.000 }, level = 30, drop_id = 1000100, affix = { 4165 }, isElite = true, pose_id = 1, area_id = 22 },
	[420006] = { config_id = 420006, monster_id = 25210102, pos = { x = -390.088, y = 282.880, z = 4012.700 }, rot = { x = 0.000, y = 270.950, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 22 },
	[420008] = { config_id = 420008, monster_id = 25210402, pos = { x = -391.712, y = 282.880, z = 4011.527 }, rot = { x = 0.000, y = 249.452, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 22 },
	...
	[420010] = { config_id = 420010, monster_id = 25210201, pos = { x = -388.541, y = 282.873, z = 4010.963 }, rot = { x = 0.000, y = 62.267, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 22 },
	[420011] = { config_id = 420011, monster_id = 25210302, pos = { x = -381.632, y = 282.873, z = 4008.742 }, rot = { x = 0.000, y = 351.180, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 22 },
	...
	[420013] = { config_id = 420013, monster_id = 25210302, pos = { x = -403.100, y = 277.373, z = 3999.500 }, rot = { x = 0.000, y = 26.182, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 22 },
...
gadgets = {
	...
	[420021] = { config_id = 420021, gadget_id = 70360286, pos = { x = -409.540, y = 283.989, z = 4004.859 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 22 }
}
...
triggers = {
	-- 任务通知和刷宝箱保底
	{ config_id = 1420022, name = "GROUP_LOAD_420022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_420022", action = "action_EVENT_GROUP_LOAD_420022" },
	-- 判断父任务完成则弄死group
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_420022", "GROUP_LOAD_420023", "ENTER_REGION_420024", "CHALLENGE_SUCCESS_420026", "CHALLENGE_FAIL_420027", "LEAVE_REGION_420029", "CHALLENGE_SUCCESS_420034", "CHALLENGE_SUCCESS_420039", "GROUP_LOAD_420046", "CHALLENGE_FAIL_420047", "GROUP_LOAD_420048", "TIME_AXIS_PASS_420053" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		regions = { 420033 },
		triggers = { "GROUP_LOAD_420022", "GROUP_LOAD_420023", "CHALLENGE_SUCCESS_420026", "CHALLENGE_FAIL_420027", "SELECT_OPTION_420028", "CHALLENGE_SUCCESS_420030", "CHALLENGE_FAIL_420031", "GADGET_STATE_CHANGE_420032", "LEAVE_REGION_420033", "CHALLENGE_SUCCESS_420034", "SELECT_OPTION_420035", "CHALLENGE_SUCCESS_420036", "LUA_NOTIFY_420037", "LUA_NOTIFY_420038", "CHALLENGE_SUCCESS_420039", "LUA_NOTIFY_420043", "LUA_NOTIFY_420044", "LUA_NOTIFY_420045", "CHALLENGE_FAIL_420047", "GROUP_LOAD_420049" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_420023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_420023(context, evt)
	ScriptLib.SetGroupDead(context, 133301420)
...
function condition_EVENT_SELECT_OPTION_420028(context, evt)
	-- 判断是gadgetid 420021 option_id 72
