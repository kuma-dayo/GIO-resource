...
monsters = {
	...
	[278013] = { config_id = 278013, monster_id = 25210302, pos = { x = -1046.494, y = 342.779, z = 4011.489 }, rot = { x = 0.000, y = 26.182, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 23 },
...
gadgets = {
	...
	[278021] = { config_id = 278021, gadget_id = 70360286, pos = { x = -1067.267, y = 341.401, z = 3990.883 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 23 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1278022, name = "GROUP_LOAD_278022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_278022", action = "action_EVENT_GROUP_LOAD_278022" },
	-- 判断父任务完成则弄死group
...
suites = {
	{
		...
		triggers = { "CHALLENGE_FAIL_278011", "GROUP_LOAD_278022", "GROUP_LOAD_278023", "ENTER_REGION_278024", "CHALLENGE_SUCCESS_278026", "CHALLENGE_FAIL_278027", "LEAVE_REGION_278029", "CHALLENGE_SUCCESS_278034", "CHALLENGE_SUCCESS_278039", "GROUP_LOAD_278046", "GROUP_LOAD_278047", "TIME_AXIS_PASS_278052" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_278023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_278023(context, evt)
	ScriptLib.SetGroupDead(context, 133301278)
...
function condition_EVENT_SELECT_OPTION_278028(context, evt)
	-- 判断是gadgetid 278021 option_id 72
