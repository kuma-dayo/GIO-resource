...
-- 装置
gadgets = {
	{ config_id = 423001, gadget_id = 70330238, pos = { x = -1171.356, y = 254.609, z = 3926.848 }, rot = { x = 0.000, y = 209.701, z = 0.000 }, level = 30, area_id = 23 },
	-- beta反馈增加宝箱奖励
	{ config_id = 423002, gadget_id = 70211101, pos = { x = -1172.674, y = 256.218, z = 3934.244 }, rot = { x = 18.366, y = 196.580, z = 352.998 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	{ config_id = 423006, gadget_id = 70290556, pos = { x = -1172.244, y = 256.398, z = 3934.197 }, rot = { x = 0.000, y = 33.115, z = 0.000 }, level = 30, area_id = 23 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_423003(context, evt)
		-- 卸载指定gadget
		if 0 ~= ScriptLib.RemoveEntityByConfigId(context, 133303423, EntityType.GADGET, 423006 ) then
...
function action_EVENT_GROUP_LOAD_423004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133303423, suite = 2 }) then
