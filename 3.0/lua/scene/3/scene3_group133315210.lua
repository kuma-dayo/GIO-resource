...
-- 装置
gadgets = {
	{ config_id = 210002, gadget_id = 70350082, pos = { x = 534.549, y = 97.729, z = 2497.181 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, persistent = true, area_id = 20 },
	{ config_id = 210003, gadget_id = 70211001, pos = { x = 534.583, y = 97.733, z = 2500.424 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 },
	{ config_id = 210004, gadget_id = 70360001, pos = { x = 534.539, y = 98.556, z = 2497.167 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 }
}
