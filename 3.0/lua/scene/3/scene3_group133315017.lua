...
gadgets = {
	...
	{ config_id = 17006, gadget_id = 70310228, pos = { x = 152.104, y = 115.802, z = 2953.183 }, rot = { x = 3.500, y = 0.000, z = 0.000 }, level = 27, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 20 },
	...
	{ config_id = 17010, gadget_id = 70500000, pos = { x = 152.104, y = 115.802, z = 2953.183 }, rot = { x = 3.500, y = 0.000, z = 0.000 }, level = 27, point_type = 9301, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE, area_id = 20 },
	-- 保底工具
	{ config_id = 17015, gadget_id = 70360001, pos = { x = 150.012, y = 115.461, z = 2953.213 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
	{ config_id = 17016, gadget_id = 70220103, pos = { x = 151.887, y = 120.896, z = 2951.951 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 20 },
	-- 左侧石块   藏封印机关
...
triggers = {
	...
	-- 水冲下来 所有石块都干掉
	{ config_id = 1017034, name = "QUEST_START_17034", event = EventType.EVENT_QUEST_START, source = "7306334", condition = "", action = "action_EVENT_QUEST_START_17034", trigger_count = 0 }
}
...
suites = {
	{
		...
		triggers = { "GADGET_STATE_CHANGE_17004", "GADGET_STATE_CHANGE_17005", "ENTER_REGION_17008", "ANY_GADGET_DIE_17009", "VARIABLE_CHANGE_17011", "GADGET_STATE_CHANGE_17012", "VARIABLE_CHANGE_17013", "VARIABLE_CHANGE_17014", "ENTER_REGION_17018", "ENTER_REGION_17022", "ANY_GADGET_DIE_17023", "ENTER_REGION_17024", "ANY_GADGET_DIE_17025", "ENTER_REGION_17028", "ANY_GADGET_DIE_17029", "TIME_AXIS_PASS_17031", "QUEST_START_17034" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发操作
function action_EVENT_QUEST_START_17034(context, evt)
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 17021 }) then
