...
-- 怪物
monsters = {
	{ config_id = 105001, monster_id = 26120101, pos = { x = -1367.205, y = 253.655, z = 2737.831 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 201, area_id = 21 },
	{ config_id = 105008, monster_id = 26090201, pos = { x = -1364.707, y = 253.646, z = 2736.567 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 101, area_id = 21 },
	{ config_id = 105009, monster_id = 26090201, pos = { x = -1369.791, y = 253.396, z = 2739.087 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_id = 1000100, pose_id = 101, area_id = 21 }
}
...
gadgets = {
	...
	{ config_id = 105004, gadget_id = 70310229, pos = { x = -1367.515, y = 254.247, z = 2742.753 }, rot = { x = 0.000, y = 175.392, z = 0.000 }, level = 1, state = GadgetState.GearStart, persistent = true, area_id = 21 },
	{ config_id = 105006, gadget_id = 70310467, pos = { x = -1368.701, y = 253.877, z = 2741.202 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 21 },
