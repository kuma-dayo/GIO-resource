...
-- 触发器
triggers = {
	{ config_id = 1146003, name = "ANY_GADGET_DIE_146003", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "", action = "action_EVENT_ANY_GADGET_DIE_146003" },
	{ config_id = 1146004, name = "GADGET_STATE_CHANGE_146004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_146004", action = "action_EVENT_GADGET_STATE_CHANGE_146004" }
}
