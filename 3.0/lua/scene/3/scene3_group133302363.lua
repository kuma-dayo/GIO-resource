...
-- 怪物
monsters = {
	[363002] = { config_id = 363002, monster_id = 25210303, pos = { x = -89.501, y = 251.893, z = 2886.829 }, rot = { x = 0.000, y = 284.479, z = 0.000 }, level = 27, drop_id = 1000100, area_id = 20 },
	...
	[363004] = { config_id = 363004, monster_id = 25210301, pos = { x = -91.361, y = 251.893, z = 2895.294 }, rot = { x = 0.000, y = 26.703, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 20 },
	...
	[363031] = { config_id = 363031, monster_id = 25210303, pos = { x = -84.819, y = 251.862, z = 2886.616 }, rot = { x = 0.000, y = 284.479, z = 0.000 }, level = 27, drop_id = 1000100, area_id = 20 }
}
...
gadgets = {
	...
	[363015] = { config_id = 363015, gadget_id = 70360286, pos = { x = -83.579, y = 252.439, z = 2905.124 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 20 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1363022, name = "GROUP_LOAD_363022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_363022", action = "action_EVENT_GROUP_LOAD_363022" },
	-- 判断父任务完成则弄死group
...
suites = {
	{
		...
		triggers = { "CHALLENGE_SUCCESS_363009", "TIME_AXIS_PASS_363021", "GROUP_LOAD_363022", "GROUP_LOAD_363023", "ENTER_REGION_363024", "CHALLENGE_SUCCESS_363026", "CHALLENGE_FAIL_363027", "LEAVE_REGION_363029", "CHALLENGE_SUCCESS_363035", "CHALLENGE_FAIL_363042", "GROUP_LOAD_363043", "GROUP_LOAD_363044", "CHALLENGE_FAIL_363050" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		regions = { 363034 },
		triggers = { "CHALLENGE_SUCCESS_363009", "LUA_NOTIFY_363010", "LUA_NOTIFY_363014", "LUA_NOTIFY_363018", "GROUP_LOAD_363022", "GROUP_LOAD_363023", "CHALLENGE_SUCCESS_363026", "CHALLENGE_FAIL_363027", "SELECT_OPTION_363028", "CHALLENGE_SUCCESS_363030", "CHALLENGE_FAIL_363032", "GADGET_STATE_CHANGE_363033", "LEAVE_REGION_363034", "CHALLENGE_SUCCESS_363035", "SELECT_OPTION_363036", "CHALLENGE_SUCCESS_363037", "LUA_NOTIFY_363038", "LUA_NOTIFY_363039", "CHALLENGE_FAIL_363042", "GROUP_LOAD_363045" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_363023(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_363023(context, evt)
	ScriptLib.SetGroupDead(context, 133302363)
...
function condition_EVENT_SELECT_OPTION_363028(context, evt)
	-- 判断是gadgetid 363015 option_id 72
