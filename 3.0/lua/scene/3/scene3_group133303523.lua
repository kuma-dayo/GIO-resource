...
monsters = {
	...
	{ config_id = 523003, monster_id = 28050106, pos = { x = -1599.528, y = 166.892, z = 3384.907 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, drop_tag = "魔法生物", area_id = 23 }
}
...
gadgets = {
	...
	{ config_id = 523005, gadget_id = 70217020, pos = { x = -1599.673, y = 166.826, z = 3384.866 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
