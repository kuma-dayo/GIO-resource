...
function condition_EVENT_GROUP_LOAD_89015(context, evt)
	if GadgetState.GearAction1 ~= ScriptLib.GetGadgetStateByConfigId(context, 133315229, 229001) then
		return false
	end
	
	if GadgetState.GearAction1 ~= ScriptLib.GetGadgetStateByConfigId(context, 133315107, 107001) then
		return false
	end
