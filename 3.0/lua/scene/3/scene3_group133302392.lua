...
-- 装置
gadgets = {
	{ config_id = 392007, gadget_id = 70210101, pos = { x = -199.710, y = 335.817, z = 2080.614 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 20 }
}
...
function action_EVENT_ENTER_REGION_392004(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-202.4768, y=336.3955, z=2078.741}，持续时间为1秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-202.4768, y=336.3955, z=2078.741}
