...
gadgets = {
	...
	{ config_id = 10003, gadget_id = 70290538, pos = { x = -1139.212, y = 155.681, z = 2197.820 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, route_id = 330400019, start_route = false, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, area_id = 21 },
	-- 中水位特效
	{ config_id = 10007, gadget_id = 70290470, pos = { x = -1132.421, y = 155.681, z = 2123.626 }, rot = { x = 0.000, y = 0.423, z = 0.000 }, level = 30, area_id = 21 },
	-- 低水位特效
	{ config_id = 10008, gadget_id = 70290470, pos = { x = -1132.728, y = 150.847, z = 2124.211 }, rot = { x = 359.333, y = 3.586, z = 355.766 }, level = 30, area_id = 21 },
	-- 高水位特效
...
suites = {
	{
		...
		gadgets = { 10001, 10014 },
		regions = { },
		triggers = { "VARIABLE_CHANGE_10004", "GROUP_LOAD_10006", "PLATFORM_REACH_POINT_10010", "VARIABLE_CHANGE_10011", "PLATFORM_REACH_POINT_10012", "GROUP_LOAD_10013" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_VARIABLE_CHANGE_10011(context, evt)
	-- 设置移动平台路径
	if 0 ~= ScriptLib.SetPlatformRouteId(context, 10001, 330400019) then
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_10012(context, evt)
	-- 判断是gadgetid 为 10001的移动平台，是否到达了330400019 的路线中的 1 点
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_10012(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133304010, suite = 2 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
