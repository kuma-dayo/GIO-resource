...
-- 怪物
monsters = {
	{ config_id = 295001, monster_id = 26010301, pos = { x = -914.699, y = 212.193, z = 2643.542 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "骗骗花", area_id = 24 }
}
...
-- 装置
gadgets = {
	{ config_id = 295002, gadget_id = 70510013, pos = { x = -914.699, y = 212.193, z = 2643.542 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 27, persistent = true, area_id = 24 }
}
