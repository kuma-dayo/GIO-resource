...
-- 装置
gadgets = {
	{ config_id = 510002, gadget_id = 70330199, pos = { x = -988.762, y = 197.680, z = 3600.574 }, rot = { x = 0.000, y = 86.039, z = 0.000 }, level = 27, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
