...
monsters = {
	...
	[1010] = { config_id = 1010, monster_id = 25210301, pos = { x = -1919.313, y = 209.636, z = 2914.208 }, rot = { x = 0.000, y = 117.766, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 21 },
	[1011] = { config_id = 1011, monster_id = 25210302, pos = { x = -1919.348, y = 209.924, z = 2907.047 }, rot = { x = 0.000, y = 49.424, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 21 },
...
gadgets = {
	...
	[1021] = { config_id = 1021, gadget_id = 70360286, pos = { x = -1930.731, y = 210.339, z = 2906.197 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 21 }
}
...
triggers = {
	...
	-- 任务通知和刷宝箱保底
	{ config_id = 1001022, name = "GROUP_LOAD_1022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_1022", action = "action_EVENT_GROUP_LOAD_1022" },
	-- 判断父任务完成则弄死group
	...
	-- 挑战失败重置门的变量
	{ config_id = 1001053, name = "CHALLENGE_FAIL_1053", event = EventType.EVENT_CHALLENGE_FAIL, source = "458", condition = "", action = "action_EVENT_CHALLENGE_FAIL_1053" }
}
...
suites = {
	{
		...
		gadgets = { 1017 },
		regions = { 1024, 1029 },
		triggers = { "GROUP_LOAD_1020", "GROUP_LOAD_1022", "GROUP_LOAD_1023", "ENTER_REGION_1024", "CHALLENGE_SUCCESS_1026", "CHALLENGE_FAIL_1027", "LEAVE_REGION_1029", "CHALLENGE_SUCCESS_1034", "CHALLENGE_SUCCESS_1039", "CHALLENGE_FAIL_1046", "GROUP_LOAD_1047", "TIME_AXIS_PASS_1052" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		gadgets = { 1017, 1021 },
		regions = { 1033 },
		triggers = { "GROUP_LOAD_1022", "GROUP_LOAD_1023", "CHALLENGE_SUCCESS_1026", "CHALLENGE_FAIL_1027", "SELECT_OPTION_1028", "CHALLENGE_SUCCESS_1030", "CHALLENGE_FAIL_1031", "GADGET_STATE_CHANGE_1032", "LEAVE_REGION_1033", "CHALLENGE_SUCCESS_1034", "SELECT_OPTION_1035", "CHALLENGE_SUCCESS_1036", "LUA_NOTIFY_1037", "LUA_NOTIFY_1038", "CHALLENGE_SUCCESS_1039", "LUA_NOTIFY_1043", "LUA_NOTIFY_1044", "LUA_NOTIFY_1045", "CHALLENGE_FAIL_1046", "GROUP_LOAD_1048", "CHALLENGE_FAIL_1053" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
function action_EVENT_GROUP_LOAD_1023(context, evt)
	ScriptLib.SetGroupDead(context, 133304001)
