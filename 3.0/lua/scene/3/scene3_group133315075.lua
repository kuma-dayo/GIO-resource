...
-- 怪物
monsters = {
	{ config_id = 75001, monster_id = 26010101, pos = { x = 143.227, y = 260.235, z = 2891.396 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "骗骗花", area_id = 20 }
}
...
-- 装置
gadgets = {
	{ config_id = 75002, gadget_id = 70510013, pos = { x = 143.227, y = 260.235, z = 2891.396 }, rot = { x = 0.000, y = 319.800, z = 0.000 }, level = 27, persistent = true, area_id = 20 },
