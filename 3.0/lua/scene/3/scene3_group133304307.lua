...
-- 装置
gadgets = {
	{ config_id = 307006, gadget_id = 70310479, pos = { x = -1169.231, y = 292.892, z = 2150.563 }, rot = { x = 0.000, y = 328.887, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 21 },
	{ config_id = 307007, gadget_id = 70310479, pos = { x = -1173.343, y = 292.983, z = 2152.029 }, rot = { x = 0.000, y = 331.467, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 21 },
	...
	{ config_id = 307025, gadget_id = 70330218, pos = { x = -1158.093, y = 290.006, z = 2137.894 }, rot = { x = 0.000, y = 206.416, z = 0.000 }, level = 30, isOneoff = true, persistent = true, area_id = 21 },
...
suites = {
	{
		...
		gadgets = { 307006, 307007, 307008, 307009, 307014, 307015, 307016, 307017, 307018, 307019, 307020, 307021, 307022, 307024, 307025, 307026 },
		regions = { },
		triggers = { "GROUP_LOAD_307002", "GROUP_LOAD_307010", "ANY_GADGET_DIE_307030", "VARIABLE_CHANGE_307031", "TIME_AXIS_PASS_307032" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_307010(context, evt)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_307010(context, evt)
	ScriptLib.SetGroupDead(context, 133304307)
