...
gadgets = {
	...
	{ config_id = 293002, gadget_id = 70330197, pos = { x = -562.546, y = 313.577, z = 2188.444 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 24 },
...
-- 区域
regions = {
	{ config_id = 293008, shape = RegionShape.SPHERE, radius = 3, pos = { x = -558.643, y = 300.957, z = 2233.933 }, area_id = 24 }
}
...
suites = {
	{
		...
		-- description = ,
		monsters = { 293007 },
		gadgets = { 293001, 293002, 293003, 293004, 293005 },
		regions = { 293008 },
...
function action_EVENT_ENTER_REGION_293008(context, evt)
	...
	-- 将configid为 293004 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 293004, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
	
	-- 将configid为 293005 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 293005, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
