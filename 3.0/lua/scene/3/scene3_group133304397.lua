...
-- 装置
gadgets = {
	[397001] = { config_id = 397001, gadget_id = 70330236, pos = { x = -1858.863, y = 217.532, z = 2952.408 }, rot = { x = 2.260, y = 20.223, z = 1.828 }, level = 30, persistent = true, area_id = 21 },
	...
	[397003] = { config_id = 397003, gadget_id = 70290264, pos = { x = -1858.363, y = 217.753, z = 2953.634 }, rot = { x = 0.000, y = 313.090, z = 0.000 }, level = 30, area_id = 21 },
	-- 2号门trigger 下面参数为传送后坐标
	[397004] = { config_id = 397004, gadget_id = 70290264, pos = { x = -1859.588, y = 106.883, z = 2955.331 }, rot = { x = 0.000, y = 358.199, z = 0.000 }, level = 30, area_id = 21 }
}
