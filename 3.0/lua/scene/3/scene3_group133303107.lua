...
gadgets = {
	...
	{ config_id = 107008, gadget_id = 70210101, pos = { x = -1468.284, y = 212.829, z = 3522.903 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 23 }
}
