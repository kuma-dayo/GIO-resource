...
monsters = {
	...
	[127010] = { config_id = 127010, monster_id = 25310101, pos = { x = -263.533, y = 245.589, z = 2211.897 }, rot = { x = 0.000, y = 173.569, z = 0.000 }, level = 30, drop_id = 1000100, pose_id = 1, area_id = 24 },
	[127011] = { config_id = 127011, monster_id = 25210302, pos = { x = -268.732, y = 245.611, z = 2210.865 }, rot = { x = 0.000, y = 100.452, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 24 },
	...
	[127013] = { config_id = 127013, monster_id = 25210302, pos = { x = -231.653, y = 251.080, z = 2219.026 }, rot = { x = 0.000, y = 163.293, z = 0.000 }, level = 30, drop_id = 1000100, area_id = 24 },
...
gadgets = {
	...
	-- 初始关门0，拾取钥匙后开门201
	[127020] = { config_id = 127020, gadget_id = 70290584, pos = { x = -261.549, y = 249.146, z = 2201.697 }, rot = { x = 0.000, y = 152.758, z = 180.000 }, level = 27, persistent = true, area_id = 24 },
	[127021] = { config_id = 127021, gadget_id = 70360286, pos = { x = -266.698, y = 251.636, z = 2212.188 }, rot = { x = 0.000, y = 332.056, z = 0.000 }, level = 30, persistent = true, worktop_config = { init_options = { 72 } }, area_id = 24 },
...
triggers = {
	-- 任务通知和刷宝箱保底
	{ config_id = 1127022, name = "GROUP_LOAD_127022", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_127022", action = "action_EVENT_GROUP_LOAD_127022" },
	-- 判断父任务完成则弄死group
	...
	{ config_id = 1127036, name = "CHALLENGE_SUCCESS_127036", event = EventType.EVENT_CHALLENGE_SUCCESS, source = "458", condition = "", action = "action_EVENT_CHALLENGE_SUCCESS_127036" },
...
suites = {
	{
		...
		triggers = { "GROUP_LOAD_127022", "GROUP_LOAD_127023", "ENTER_REGION_127024", "CHALLENGE_SUCCESS_127026", "CHALLENGE_FAIL_127027", "LEAVE_REGION_127029", "CHALLENGE_SUCCESS_127034", "CHALLENGE_SUCCESS_127039", "GROUP_LOAD_127052", "CHALLENGE_FAIL_127053", "GROUP_LOAD_127054", "TIME_AXIS_PASS_127059" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		regions = { 127033 },
		triggers = { "GROUP_LOAD_127022", "GROUP_LOAD_127023", "CHALLENGE_SUCCESS_127026", "CHALLENGE_FAIL_127027", "SELECT_OPTION_127028", "CHALLENGE_SUCCESS_127030", "CHALLENGE_FAIL_127031", "GADGET_STATE_CHANGE_127032", "LEAVE_REGION_127033", "CHALLENGE_SUCCESS_127034", "SELECT_OPTION_127035", "CHALLENGE_SUCCESS_127036", "LUA_NOTIFY_127037", "LUA_NOTIFY_127038", "CHALLENGE_SUCCESS_127039", "LUA_NOTIFY_127043", "LUA_NOTIFY_127044", "LUA_NOTIFY_127045", "CHALLENGE_FAIL_127053", "GROUP_LOAD_127055" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_127023(context, evt)
	local curQuestState = ScriptLib.GetHostQuestState(context,7304926)
...
-- 触发操作
function action_EVENT_GROUP_LOAD_127023(context, evt)
	ScriptLib.SetGroupDead(context, 133315127)
...
function condition_EVENT_SELECT_OPTION_127028(context, evt)
	-- 判断是gadgetid 127021 option_id 72
