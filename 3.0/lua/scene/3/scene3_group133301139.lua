...
gadgets = {
	...
	{ config_id = 139008, gadget_id = 70310191, pos = { x = -601.695, y = 33.563, z = 3797.578 }, rot = { x = 16.886, y = 279.907, z = 7.190 }, level = 33, isOneoff = true, persistent = true, area_id = 25 },
	...
	{ config_id = 139022, gadget_id = 70310191, pos = { x = -561.028, y = 31.379, z = 3774.597 }, rot = { x = 353.800, y = 66.710, z = 3.628 }, level = 33, state = GadgetState.GearStart, isOneoff = true, persistent = true, area_id = 25 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "QUEST_START_139012", "QUEST_START_139021" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function action_EVENT_QUEST_START_139012(context, evt)
	-- 杀死Group内所有monster
		...
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 139028 }) then
