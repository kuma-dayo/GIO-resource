...
-- 装置
gadgets = {
	{ config_id = 308004, gadget_id = 70211102, pos = { x = -883.338, y = 225.811, z = 3254.801 }, rot = { x = 355.917, y = 29.772, z = 359.485 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestTrap, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}

-- 区域
regions = {
	{ config_id = 308005, shape = RegionShape.SPHERE, radius = 3, pos = { x = -883.478, y = 225.623, z = 3254.470 }, area_id = 23 }
}
...
suites = {
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "ANY_MONSTER_DIE_308006" },
		rand_weight = 100
	}
}
