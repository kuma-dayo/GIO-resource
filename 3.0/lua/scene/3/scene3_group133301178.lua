...
-- 怪物
monsters = {
	{ config_id = 178001, monster_id = 24021101, pos = { x = -905.692, y = -5.523, z = 3142.515 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, affix = { 5182, 5183 }, area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 178002, gadget_id = 70211011, pos = { x = -903.122, y = -5.634, z = 3159.132 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	{ config_id = 178003, gadget_id = 70360001, pos = { x = -911.926, y = -5.561, z = 3128.762 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 }
}
