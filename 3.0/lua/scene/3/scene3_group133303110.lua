...
-- 装置
gadgets = {
	{ config_id = 110007, gadget_id = 70310001, pos = { x = -1908.876, y = 414.730, z = 3603.076 }, rot = { x = 0.000, y = 26.212, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 },
	{ config_id = 110008, gadget_id = 70310001, pos = { x = -1898.014, y = 406.168, z = 3620.097 }, rot = { x = 0.000, y = 338.644, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 },
