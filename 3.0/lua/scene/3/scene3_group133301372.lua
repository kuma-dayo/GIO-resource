...
suites = {
	{
		...
		monsters = { },
		gadgets = { },
		regions = { 372007, 372008 },
		triggers = { "GROUP_LOAD_372004", "ENTER_REGION_372007", "ENTER_REGION_372008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发操作
function action_EVENT_ENTER_REGION_372008(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133301372, 4)
