...
gadgets = {
	...
	{ config_id = 63002, gadget_id = 70217020, pos = { x = -1554.556, y = 270.052, z = 2304.352 }, rot = { x = 2.718, y = 19.037, z = 332.323 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 21 },
