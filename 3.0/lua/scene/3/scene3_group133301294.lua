...
-- 装置
gadgets = {
	{ config_id = 294004, gadget_id = 70210101, pos = { x = -479.378, y = 203.493, z = 3110.605 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 22 },
	{ config_id = 294005, gadget_id = 70210101, pos = { x = -480.225, y = 202.829, z = 3113.208 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 22 },
	...
	{ config_id = 294008, gadget_id = 70210101, pos = { x = -470.429, y = 202.907, z = 3127.494 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 22 },
	...
	{ config_id = 294014, gadget_id = 70210101, pos = { x = -472.570, y = 203.424, z = 3090.009 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 22 }
}
