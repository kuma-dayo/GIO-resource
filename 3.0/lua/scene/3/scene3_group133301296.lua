...
suites = {
	{
		...
		regions = { },
		triggers = { "GROUP_LOAD_296004", "GADGET_STATE_CHANGE_296005" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
function condition_EVENT_GROUP_LOAD_296004(context, evt)
	if GadgetState.GearStop ~= ScriptLib.GetGadgetStateByConfigId(context, 133301296, 296001) then
		return false
	end
...
function action_EVENT_GROUP_LOAD_296004(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301296, suite = 2 }) then
