...
gadgets = {
	...
	{ config_id = 54014, gadget_id = 70220103, pos = { x = -258.076, y = 219.176, z = 3057.912 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 22 }
}
...
suites = {
	{
		...
		gadgets = { 54002, 54006, 54007, 54010, 54011, 54012, 54013, 54014 },
		regions = { },
