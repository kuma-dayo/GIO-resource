...
regions = {
	...
	-- 新手指引2
	[466015] = { config_id = 466015, shape = RegionShape.SPHERE, radius = 5, pos = { x = -941.462, y = 205.864, z = 2641.938 }, area_id = 24 },
	-- 新手指引3
	[466016] = { config_id = 466016, shape = RegionShape.SPHERE, radius = 5, pos = { x = -944.690, y = 206.290, z = 2629.054 }, area_id = 24 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "LUA_NOTIFY_466004", "GROUP_LOAD_466011", "QUEST_START_466019", "ANY_GADGET_DIE_466023", "GADGET_STATE_CHANGE_466024", "GADGET_STATE_CHANGE_466025", "GADGET_STATE_CHANGE_466026", "ANY_GADGET_DIE_466027", "ANY_GADGET_DIE_466028", "ANY_GADGET_DIE_466029", "ANY_MONSTER_DIE_466030" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		triggers = { "ENTER_REGION_466014", "ENTER_REGION_466015", "ENTER_REGION_466016" },
		rand_weight = 100
	}
}
...
function action_EVENT_QUEST_START_466019(context, evt)
	...
	-- 添加suite5的新内容
	    ScriptLib.AddExtraGroupSuite(context, 133301466, 5)
...
-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_466027(context, evt)
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_466027(context, evt)
	-- 删除suite5的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133301466, 5)
	
	return 0
end

-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_466028(context, evt)
	if 466007 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_466028(context, evt)
	-- 删除suite5的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133301466, 5)
...
-- 触发条件
function condition_EVENT_ANY_GADGET_DIE_466029(context, evt)
	if 466008 ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_ANY_GADGET_DIE_466029(context, evt)
	-- 删除suite5的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133301466, 5)
