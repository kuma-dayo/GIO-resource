...
-- 触发器
triggers = {
	{ config_id = 1321009, name = "GADGET_STATE_CHANGE_321009", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_321009", action = "action_EVENT_GADGET_STATE_CHANGE_321009" }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_321009" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
