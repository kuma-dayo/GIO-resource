...
monsters = {
	...
	{ config_id = 431003, monster_id = 25310101, pos = { x = -1400.429, y = 181.819, z = 3472.282 }, rot = { x = 0.000, y = 201.582, z = 0.000 }, level = 30, drop_tag = "中级镀金旅团", pose_id = 9004, area_id = 23 }
}
...
-- 触发器
triggers = {
	{ config_id = 1431004, name = "MONSTER_BATTLE_431004", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "condition_EVENT_MONSTER_BATTLE_431004", action = "action_EVENT_MONSTER_BATTLE_431004" },
...
suites = {
	{
		...
		gadgets = { 431007 },
		regions = { },
		triggers = { "MONSTER_BATTLE_431004", "MONSTER_BATTLE_431005", "ANY_MONSTER_DIE_431006" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_MONSTER_BATTLE_431004(context, evt)
...
-- 触发操作
function action_EVENT_MONSTER_BATTLE_431004(context, evt)
		-- 移除指定monster
		ScriptLib.RemoveEntityByConfigId(context, 133303431, EntityType.MONSTER, 431003)
