...
-- 怪物
monsters = {
	[250001] = { config_id = 250001, monster_id = 26090501, pos = { x = -54.139, y = 284.958, z = 3198.802 }, rot = { x = 0.000, y = 55.724, z = 0.000 }, level = 27, drop_tag = "蕈兽", disableWander = true, pose_id = 101, area_id = 22 },
	[250002] = { config_id = 250002, monster_id = 26120201, pos = { x = -54.331, y = 284.924, z = 3196.551 }, rot = { x = 0.000, y = 62.972, z = 0.000 }, level = 33, drop_tag = "大蕈兽", disableWander = true, affix = { 6116, 6117 }, isElite = true, pose_id = 201, area_id = 22, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
	[250003] = { config_id = 250003, monster_id = 26090501, pos = { x = -52.625, y = 285.149, z = 3195.857 }, rot = { x = 0.000, y = 66.708, z = 0.000 }, level = 27, drop_tag = "蕈兽", disableWander = true, pose_id = 101, area_id = 22 }
}
