...
-- 装置
gadgets = {
	{ config_id = 659001, gadget_id = 70500000, pos = { x = -436.149, y = 214.399, z = 3771.079 }, rot = { x = 0.000, y = 121.301, z = 0.000 }, level = 10, point_type = 4014, isOneoff = true, persistent = true, explore = { name = "gather", exp = 30 }, area_id = 22, is_enable_interact = false },
	{ config_id = 659002, gadget_id = 70330199, pos = { x = -436.178, y = 213.885, z = 3771.169 }, rot = { x = 356.269, y = 121.670, z = 8.656 }, level = 10, state = GadgetState.GearStop, area_id = 22 }
}
