...
-- 装置
gadgets = {
	{ config_id = 601001, gadget_id = 70330197, pos = { x = -1287.805, y = 260.455, z = 3636.244 }, rot = { x = 2.328, y = 156.667, z = 12.672 }, level = 27, area_id = 23 },
	{ config_id = 601002, gadget_id = 70320004, pos = { x = -1284.659, y = 259.281, z = 3636.521 }, rot = { x = 0.000, y = 310.710, z = 0.000 }, level = 27, area_id = 23 },
...
suites = {
	...
	},
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_601005", "GROUP_LOAD_601006" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
...
function action_EVENT_GADGET_STATE_CHANGE_601005(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupVariableValue(context, "remove", 1) then
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_601006(context, evt)
	-- 判断变量"remove"为1
...
-- 触发操作
function action_EVENT_GROUP_LOAD_601006(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133303601, suite = 3 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
