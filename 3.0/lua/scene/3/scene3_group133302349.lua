...
-- 怪物
monsters = {
	{ config_id = 349004, monster_id = 26090201, pos = { x = -274.625, y = 135.257, z = 2209.817 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "蕈兽", disableWander = true, pose_id = 102, area_id = 24 },
	{ config_id = 349005, monster_id = 26090201, pos = { x = -272.369, y = 135.198, z = 2214.857 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_tag = "蕈兽", disableWander = true, pose_id = 102, area_id = 24 },
	{ config_id = 349010, monster_id = 26120101, pos = { x = -274.776, y = 134.608, z = 2212.236 }, rot = { x = 0.000, y = 125.868, z = 0.000 }, level = 27, drop_tag = "大蕈兽", disableWander = true, pose_id = 103, area_id = 24 }
}
