...
-- 装置
gadgets = {
	[405001] = { config_id = 405001, gadget_id = 70330229, pos = { x = -1472.378, y = 131.036, z = 3342.371 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, mark_flag = 3, area_id = 23 },
	...
	[405006] = { config_id = 405006, gadget_id = 70220103, pos = { x = -1455.184, y = 182.468, z = 3288.555 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, area_id = 23 }
}
