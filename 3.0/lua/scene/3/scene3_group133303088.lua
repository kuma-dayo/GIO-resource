...
-- 怪物
monsters = {
	{ config_id = 88001, monster_id = 25210201, pos = { x = -1172.712, y = 215.857, z = 3779.816 }, rot = { x = 0.000, y = 297.492, z = 0.000 }, level = 30, drop_tag = "镀金旅团", disableWander = true, pose_id = 9511, area_id = 23 },
...
gadgets = {
	...
	{ config_id = 88007, gadget_id = 70210101, pos = { x = -1177.419, y = 216.321, z = 3785.926 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 }
}
