...
-- 装置
gadgets = {
	{ config_id = 560002, gadget_id = 70210101, pos = { x = -1443.970, y = 261.181, z = 3829.745 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 23 }
}
