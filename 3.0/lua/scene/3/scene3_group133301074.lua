...
-- 怪物
monsters = {
	{ config_id = 74001, monster_id = 25210501, pos = { x = -404.229, y = 277.066, z = 3984.067 }, rot = { x = 0.000, y = 95.875, z = 0.000 }, level = 27, drop_id = 1000100, disableWander = true, affix = { 1007 }, isOneoff = true, pose_id = 9502, title_id = 10114, special_name_id = 10147, area_id = 22 }
}
