...
-- 装置
gadgets = {
	{ config_id = 63002, gadget_id = 70211012, pos = { x = -870.566, y = 225.752, z = 3256.626 }, rot = { x = 0.000, y = 91.526, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
...
-- 区域
regions = {
	{ config_id = 63011, shape = RegionShape.SPHERE, radius = 50, pos = { x = -852.027, y = 217.266, z = 3245.635 }, area_id = 23 }
}
...
function action_EVENT_ENTER_REGION_63011(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301063, suite = 2 }) then
