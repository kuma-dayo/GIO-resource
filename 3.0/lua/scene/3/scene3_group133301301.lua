...
monsters = {
	...
	{ config_id = 301009, monster_id = 25210201, pos = { x = -812.456, y = 178.251, z = 3767.265 }, rot = { x = 0.000, y = 24.354, z = 0.000 }, level = 33, drop_tag = "镀金旅团", area_id = 23 }
}
...
-- 装置
gadgets = {
	{ config_id = 301012, gadget_id = 70211011, pos = { x = -814.130, y = 178.028, z = 3765.707 }, rot = { x = 0.000, y = 45.641, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
suites = {
	{
		...
		gadgets = { },
		regions = { 301008 },
		triggers = { "ENTER_REGION_301008", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		...
		gadgets = { },
		regions = { 301002 },
		triggers = { "ENTER_REGION_301002", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 3,
		...
		gadgets = { },
		regions = { 301003 },
		triggers = { "ENTER_REGION_301003", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
		...
		gadgets = { },
		regions = { 301004 },
		triggers = { "ENTER_REGION_301004", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 5,
		...
		gadgets = { },
		regions = { 301005 },
		triggers = { "ENTER_REGION_301005", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 6,
		...
		gadgets = { },
		regions = { 301006 },
		triggers = { "ENTER_REGION_301006", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 7,
		...
		gadgets = { },
		regions = { 301007 },
		triggers = { "ENTER_REGION_301007", "GADGET_STATE_CHANGE_301010" },
		rand_weight = 100
	},
	{
		-- suite_id = 8,
...
function action_EVENT_ENTER_REGION_301007(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 133301301, suite = 8 }) then
