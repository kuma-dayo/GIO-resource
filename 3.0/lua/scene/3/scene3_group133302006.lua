...
-- 怪物
monsters = {
	{ config_id = 6001, monster_id = 23020101, pos = { x = -250.128, y = 244.303, z = 2218.937 }, rot = { x = 0.000, y = 346.352, z = 0.000 }, level = 24, drop_id = 1000100, disableWander = true, affix = { 1007 }, isOneoff = true, title_id = 10113, special_name_id = 10146, area_id = 24 }
}
