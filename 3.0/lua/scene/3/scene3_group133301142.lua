...
-- 装置
gadgets = {
	{ config_id = 142002, gadget_id = 70211151, pos = { x = -648.350, y = 127.873, z = 3787.771 }, rot = { x = 356.123, y = 102.917, z = 355.862 }, level = 26, chest_drop_id = 21910056, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_SUPER, explore = { name = "chest", exp = 10 }, area_id = 25 },
