...
gadgets = {
	...
	{ config_id = 460006, gadget_id = 70210101, pos = { x = -107.729, y = 214.480, z = 2928.151 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 20 },
	{ config_id = 460007, gadget_id = 70210101, pos = { x = -113.379, y = 216.960, z = 2934.601 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜通用须弥", isOneoff = true, persistent = true, area_id = 20 }
}
