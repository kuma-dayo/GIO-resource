...
-- 装置
gadgets = {
	{ config_id = 485001, gadget_id = 70330199, pos = { x = -1599.146, y = 211.901, z = 2770.946 }, rot = { x = 358.796, y = 335.035, z = 10.848 }, level = 30, state = GadgetState.GearStop, area_id = 21 },
...
suites = {
	{
		...
		gadgets = { 485001 },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_485003" },
		rand_weight = 100
	}
}
