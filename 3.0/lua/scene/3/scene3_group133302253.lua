...
gadgets = {
	...
	[253004] = { config_id = 253004, gadget_id = 70310440, pos = { x = 310.291, y = 421.538, z = 2464.385 }, rot = { x = 0.000, y = 128.797, z = 0.000 }, level = 27, persistent = true, area_id = 20 }
}

-- 区域
regions = {
	[253005] = { config_id = 253005, shape = RegionShape.SPHERE, radius = 100, pos = { x = 62.494, y = 230.309, z = 2481.914 }, area_id = 20 },
	...
	-- G键触发
	[253012] = { config_id = 253012, shape = RegionShape.CUBIC, size = { x = 5.000, y = 5.000, z = 5.000 }, pos = { x = 319.501, y = 420.831, z = 2455.602 }, area_id = 20 }
}
