...
gadgets = {
	...
	{ config_id = 332008, gadget_id = 70210101, pos = { x = -1662.600, y = 220.177, z = 2929.350 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 21 },
	{ config_id = 332009, gadget_id = 70210101, pos = { x = -1663.474, y = 220.202, z = 2928.730 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜果蔬须弥", isOneoff = true, persistent = true, area_id = 21 }
}
...
-- 触发器
triggers = {
	{ config_id = 1332010, name = "MONSTER_BATTLE_332010", event = EventType.EVENT_MONSTER_BATTLE, source = "", condition = "", action = "action_EVENT_MONSTER_BATTLE_332010", trigger_count = 0 }
}
