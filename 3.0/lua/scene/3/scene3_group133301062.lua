...
gadgets = {
	...
	{ config_id = 62003, gadget_id = 70217020, pos = { x = -736.511, y = 152.035, z = 3454.779 }, rot = { x = 350.982, y = 295.940, z = 1.932 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 },
