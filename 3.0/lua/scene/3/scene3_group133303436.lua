...
triggers = {
	...
	{ config_id = 1436018, name = "GROUP_LOAD_436018", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_436018", action = "action_EVENT_GROUP_LOAD_436018" }
}
