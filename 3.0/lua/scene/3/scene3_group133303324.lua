...
-- 装置
gadgets = {
	{ config_id = 324002, gadget_id = 70330199, pos = { x = -1780.729, y = 217.424, z = 3711.252 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, area_id = 23 },
	{ config_id = 324004, gadget_id = 70217020, pos = { x = -1780.647, y = 217.519, z = 3711.505 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
