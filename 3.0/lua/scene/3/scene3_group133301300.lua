...
gadgets = {
	...
	{ config_id = 300011, gadget_id = 70210101, pos = { x = -738.048, y = 239.756, z = 3442.840 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜遗物须弥", isOneoff = true, persistent = true, area_id = 23 },
	{ config_id = 300012, gadget_id = 70210101, pos = { x = -750.635, y = 241.701, z = 3445.735 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜人文须弥", isOneoff = true, persistent = true, area_id = 23 }
}
