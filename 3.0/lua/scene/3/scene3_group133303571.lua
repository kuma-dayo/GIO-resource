...
gadgets = {
	...
	{ config_id = 571003, gadget_id = 70211001, pos = { x = -1456.461, y = 129.019, z = 3339.056 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
