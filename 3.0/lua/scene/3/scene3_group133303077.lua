...
triggers = {
	...
	{ config_id = 1077008, name = "GROUP_LOAD_77008", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_77008", action = "action_EVENT_GROUP_LOAD_77008" }
}
