...
gadgets = {
	...
	{ config_id = 361008, gadget_id = 70310479, pos = { x = -1999.338, y = 283.235, z = 3373.034 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 },
	{ config_id = 361009, gadget_id = 70310479, pos = { x = -1999.275, y = 283.042, z = 3367.503 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 23 }
}
