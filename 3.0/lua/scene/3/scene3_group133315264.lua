...
-- 触发器
triggers = {
	{ config_id = 1264007, name = "GADGET_STATE_CHANGE_264007", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_264007", action = "action_EVENT_GADGET_STATE_CHANGE_264007", trigger_count = 0 }
}
...
function action_EVENT_GADGET_STATE_CHANGE_264007(context, evt)
	...
	-- 改变指定group组133315265中， configid为265002的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 133315265, 265002, GadgetState.GearStart) then
