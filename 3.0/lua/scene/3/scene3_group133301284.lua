...
gadgets = {
	...
	[284004] = { config_id = 284004, gadget_id = 70310440, pos = { x = -932.266, y = 386.044, z = 3222.740 }, rot = { x = 0.000, y = 244.127, z = 0.000 }, level = 30, persistent = true, area_id = 23 }
}
...
regions = {
	...
	-- 接取任务
	[284011] = { config_id = 284011, shape = RegionShape.SPHERE, radius = 5, pos = { x = -952.770, y = 411.422, z = 3185.673 }, area_id = 23 },
	-- G键触发
	[284012] = { config_id = 284012, shape = RegionShape.CUBIC, size = { x = 5.000, y = 5.000, z = 5.000 }, pos = { x = -949.981, y = 413.966, z = 3187.820 }, area_id = 23 }
}
...
triggers = {
	...
	-- G键触发
	{ config_id = 1284012, name = "ENTER_REGION_284012", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_284012", action = "action_EVENT_ENTER_REGION_284012" }
}
