...
-- 装置
gadgets = {
	{ config_id = 328002, gadget_id = 70330199, pos = { x = -1755.953, y = 165.996, z = 3633.310 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 },
