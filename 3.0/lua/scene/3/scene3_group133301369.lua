...
suites = {
	{
		...
		regions = { },
		triggers = { "LUA_NOTIFY_369001", "GADGET_STATE_CHANGE_369016", "ANY_GADGET_DIE_369023", "GADGET_STATE_CHANGE_369024", "GADGET_STATE_CHANGE_369025", "GADGET_STATE_CHANGE_369026" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_GADGET_STATE_CHANGE_369016(context, evt)
	if 369012 ~= evt.param2 or GadgetState.GearStart ~= evt.param1 then
		return false
	end
...
-- 触发操作
function action_EVENT_GADGET_STATE_CHANGE_369016(context, evt)
	-- 延迟0秒刷怪
