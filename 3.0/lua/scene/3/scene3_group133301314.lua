...
gadgets = {
	...
	{ config_id = 314002, gadget_id = 70290544, pos = { x = -865.139, y = 208.539, z = 3286.930 }, rot = { x = 9.067, y = 17.237, z = 0.237 }, level = 30, area_id = 23 },
	{ config_id = 314003, gadget_id = 70330219, pos = { x = -858.068, y = 196.715, z = 3306.952 }, rot = { x = 9.854, y = 264.720, z = 355.477 }, level = 30, area_id = 23 },
	{ config_id = 314004, gadget_id = 70900050, pos = { x = -857.991, y = 196.825, z = 3306.855 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.Action01, area_id = 23 }
}
