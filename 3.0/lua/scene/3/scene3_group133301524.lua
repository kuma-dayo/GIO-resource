...
suites = {
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "VARIABLE_CHANGE_524008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_524008(context, evt)
	if evt.param1 == evt.param2 then return false end
	
	-- 判断变量"suit2"为1
	if ScriptLib.GetGroupVariableValue(context, "suit2") ~= 1 then
			return false
	end
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_524008(context, evt)
		-- 重新生成指定group，指定suite
