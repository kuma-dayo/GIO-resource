...
gadgets = {
	...
	{ config_id = 315002, gadget_id = 70330218, pos = { x = -770.670, y = 237.528, z = 3248.341 }, rot = { x = 350.468, y = 110.797, z = 353.738 }, level = 30, area_id = 23 }
}
...
-- 触发器
triggers = {
	{ config_id = 1315006, name = "ANY_GADGET_DIE_315006", event = EventType.EVENT_ANY_GADGET_DIE, source = "", condition = "condition_EVENT_ANY_GADGET_DIE_315006", action = "action_EVENT_ANY_GADGET_DIE_315006", trigger_count = 0 }
}
