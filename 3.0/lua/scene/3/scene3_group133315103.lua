...
gadgets = {
	...
	{ config_id = 103023, gadget_id = 70330218, pos = { x = 489.874, y = 187.710, z = 2170.159 }, rot = { x = 0.000, y = 294.021, z = 355.874 }, level = 27, area_id = 20 },
...
triggers = {
	...
	{ config_id = 1103027, name = "GROUP_LOAD_103027", event = EventType.EVENT_GROUP_LOAD, source = "", condition = "condition_EVENT_GROUP_LOAD_103027", action = "action_EVENT_GROUP_LOAD_103027", trigger_count = 0 }
}
...
-- 触发条件
function condition_EVENT_GROUP_LOAD_103027(context, evt)
	-- 判断变量"open"为0
...
-- 触发操作
function action_EVENT_GROUP_LOAD_103027(context, evt)
		-- 重新生成指定group，指定suite
