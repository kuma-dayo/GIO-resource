...
triggers = {
	...
	{ config_id = 1117011, name = "GADGET_STATE_CHANGE_117011", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_117011", action = "action_EVENT_GADGET_STATE_CHANGE_117011" }
}
