...
-- 装置
gadgets = {
	{ config_id = 529002, gadget_id = 70211012, pos = { x = -834.564, y = 232.303, z = 3539.081 }, rot = { x = 0.000, y = 357.965, z = 0.000 }, level = 26, drop_tag = "战斗中级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	...
	{ config_id = 529015, gadget_id = 70210101, pos = { x = -847.460, y = 233.051, z = 3536.552 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 26, drop_tag = "搜刮点解谜武器须弥", isOneoff = true, persistent = true, area_id = 23 },
	...
	{ config_id = 529019, gadget_id = 70217020, pos = { x = -841.546, y = 239.415, z = 3558.021 }, rot = { x = 0.000, y = 347.102, z = 0.000 }, level = 26, drop_tag = "摩拉石箱须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 4 }, area_id = 23 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_MONSTER_DIE_529003", "MONSTER_BATTLE_529014" },
		rand_weight = 100
	}
}
...
-- 触发条件
function condition_EVENT_MONSTER_BATTLE_529014(context, evt)
...
-- 触发操作
function action_EVENT_MONSTER_BATTLE_529014(context, evt)
	-- 延迟0秒刷怪
	if 0 ~= ScriptLib.CreateMonster(context, { config_id = 529004, delay_time = 0 }) then
