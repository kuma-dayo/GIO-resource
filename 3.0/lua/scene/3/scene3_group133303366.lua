...
triggers = {
	...
	{ config_id = 1366006, name = "QUEST_START_366006", event = EventType.EVENT_QUEST_START, source = "7318504", condition = "condition_EVENT_QUEST_START_366006", action = "action_EVENT_QUEST_START_366006" }
}

-- 变量
variables = {
	{ config_id = 1, name = "questfinish", value = 0, no_refresh = false }
}
