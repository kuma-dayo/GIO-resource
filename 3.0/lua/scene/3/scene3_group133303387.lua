...
-- 装置
gadgets = {
	{ config_id = 387002, gadget_id = 70330199, pos = { x = -1772.545, y = 334.859, z = 3537.758 }, rot = { x = 358.412, y = 0.214, z = 349.384 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
