...
-- 装置
gadgets = {
	{ config_id = 127001, gadget_id = 70211101, pos = { x = -935.526, y = 313.905, z = 3125.388 }, rot = { x = 0.422, y = 130.131, z = 354.316 }, level = 26, drop_tag = "解谜低级须弥", isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 23 },
	{ config_id = 127002, gadget_id = 70350093, pos = { x = -839.860, y = 298.278, z = 3154.701 }, rot = { x = 0.000, y = 274.706, z = 0.000 }, level = 30, persistent = true, area_id = 23 },
	{ config_id = 127003, gadget_id = 70360001, pos = { x = -839.860, y = 299.243, z = 3154.695 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 23 },
