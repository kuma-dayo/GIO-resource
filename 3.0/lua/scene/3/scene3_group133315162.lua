...
-- 怪物
monsters = {
	{ config_id = 162001, monster_id = 28030313, pos = { x = 94.183, y = 203.153, z = 2605.503 }, rot = { x = 0.000, y = 268.521, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 20 },
	{ config_id = 162002, monster_id = 28030313, pos = { x = 32.804, y = 211.088, z = 2615.233 }, rot = { x = 0.000, y = 122.834, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 20 },
...
suites = {
	{
		-- suite_id = 1,
		-- description = ,
		monsters = { 162001, 162002, 162003, 162004, 162005, 162006, 162007, 162008, 162009, 162010, 162011, 162012, 162013, 162014, 162015 },
		gadgets = { },
		regions = { },
		triggers = { },
		rand_weight = 100
