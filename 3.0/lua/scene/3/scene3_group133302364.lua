...
gadgets = {
	...
	{ config_id = 364015, gadget_id = 70310479, pos = { x = -68.730, y = 257.267, z = 2896.779 }, rot = { x = 0.000, y = 287.343, z = 0.000 }, level = 27, state = GadgetState.GearStart, area_id = 20 },
	...
	-- 引导钥匙的火盆可替换其他火源
	{ config_id = 364038, gadget_id = 70310479, pos = { x = -74.292, y = 257.530, z = 2897.825 }, rot = { x = 0.000, y = 43.400, z = 0.000 }, level = 30, state = GadgetState.GearStart, area_id = 20 },
