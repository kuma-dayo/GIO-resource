...
-- 装置
gadgets = {
	{ config_id = 352002, gadget_id = 70211002, pos = { x = -694.589, y = 137.734, z = 4048.113 }, rot = { x = 0.000, y = 341.375, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_SUPER, explore = { name = "chest", exp = 10 }, area_id = 25 },
...
suites = {
	{
		...
		-- description = ,
		monsters = { 352004 },
		gadgets = { 352002, 352005, 352006, 352007, 352008, 352009 },
		regions = { },
