...
-- 装置
gadgets = {
	{ config_id = 330002, gadget_id = 70211151, pos = { x = -563.645, y = 163.137, z = 3896.472 }, rot = { x = 351.500, y = 110.457, z = 355.794 }, level = 26, chest_drop_id = 21910053, drop_count = 1, state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_SUPER, explore = { name = "chest", exp = 10 }, area_id = 25 },
