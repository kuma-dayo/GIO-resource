...
-- 装置
gadgets = {
	{ config_id = 688002, gadget_id = 70330199, pos = { x = -230.605, y = 227.053, z = 2577.537 }, rot = { x = 3.938, y = 41.063, z = 0.000 }, level = 27, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 20 }
}
