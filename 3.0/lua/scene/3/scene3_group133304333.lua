...
gadgets = {
	...
	{ config_id = 333004, gadget_id = 70900050, pos = { x = -1727.918, y = 179.555, z = 3064.219 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, persistent = true, area_id = 23 },
	...
	{ config_id = 333006, gadget_id = 70211102, pos = { x = -1747.377, y = 185.287, z = 3041.107 }, rot = { x = 0.000, y = 100.766, z = 0.000 }, level = 26, drop_tag = "解谜低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, vision_level = VisionLevelType.VISION_LEVEL_NORMAL, explore = { name = "chest", exp = 10 }, area_id = 23 }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_333007" },
		rand_weight = 100
	}
}
