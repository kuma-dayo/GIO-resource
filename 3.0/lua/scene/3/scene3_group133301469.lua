...
monsters = {
	...
	{ config_id = 469005, monster_id = 28030313, pos = { x = -931.185, y = 213.489, z = 2623.205 }, rot = { x = 0.000, y = 125.744, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 },
	{ config_id = 469006, monster_id = 28030313, pos = { x = -927.115, y = 210.168, z = 2628.330 }, rot = { x = 0.000, y = 125.744, z = 0.000 }, level = 27, drop_tag = "鸟类", area_id = 24 }
}
