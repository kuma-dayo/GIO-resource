...
-- 装置
gadgets = {
	{ config_id = 230002, gadget_id = 70330199, pos = { x = -1776.695, y = 126.437, z = 3258.770 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, state = GadgetState.GearStop, isOneoff = true, persistent = true, area_id = 23 }
}
