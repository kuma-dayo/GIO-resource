...
-- 装置
gadgets = {
	{ config_id = 139009, gadget_id = 70211002, pos = { x = 94.925, y = 133.177, z = 2995.638 }, rot = { x = 0.000, y = 296.508, z = 0.000 }, level = 26, drop_tag = "战斗低级须弥", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 10 }, area_id = 20 }
}
