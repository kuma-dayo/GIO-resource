...
-- 触发器
triggers = {
	{ config_id = 1536010, name = "GATHER_536010", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536010", action = "action_EVENT_GATHER_536010" },
	...
	{ config_id = 1536015, name = "GATHER_536015", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536015", action = "action_EVENT_GATHER_536015" },
	{ config_id = 1536016, name = "GATHER_536016", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536016", action = "action_EVENT_GATHER_536016" },
	{ config_id = 1536017, name = "GATHER_536017", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536017", action = "action_EVENT_GATHER_536017" },
	{ config_id = 1536018, name = "GATHER_536018", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536018", action = "action_EVENT_GATHER_536018" },
	{ config_id = 1536019, name = "GATHER_536019", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536019", action = "action_EVENT_GATHER_536019" },
	{ config_id = 1536020, name = "GATHER_536020", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536020", action = "action_EVENT_GATHER_536020" },
	{ config_id = 1536021, name = "GATHER_536021", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536021", action = "action_EVENT_GATHER_536021" },
	{ config_id = 1536022, name = "GATHER_536022", event = EventType.EVENT_GATHER, source = "", condition = "condition_EVENT_GATHER_536022", action = "action_EVENT_GATHER_536022" },
...
suites = {
	{
		...
		regions = { },
		triggers = { "GATHER_536010", "VARIABLE_CHANGE_536014", "GATHER_536015", "GATHER_536016", "GATHER_536017", "GATHER_536018", "GATHER_536019", "GATHER_536020", "GATHER_536021", "GATHER_536022", "GROUP_LOAD_536023" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
