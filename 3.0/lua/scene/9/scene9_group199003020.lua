...
-- 触发器
triggers = {
	{ config_id = 1020002, name = "SELECT_OPTION_20002", event = EventType.EVENT_SELECT_OPTION, source = "", condition = "condition_EVENT_SELECT_OPTION_20002", action = "action_EVENT_SELECT_OPTION_20002" },
...
function action_EVENT_GROUP_LOAD_20005(context, evt)
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 199003020, 20003, {171}) then
