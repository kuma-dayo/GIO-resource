...
monsters = {
	...
	{ config_id = 1006, monster_id = 24030101, pos = { x = -0.071, y = -0.102, z = -10.039 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101 }
}
...
function action_EVENT_ANY_MONSTER_LIVE_1010(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 166, 180, 250094001, 2, 0) then
