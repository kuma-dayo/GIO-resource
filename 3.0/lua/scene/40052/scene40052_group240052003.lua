...
-- 怪物
monsters = {
	{ config_id = 3005, monster_id = 25210201, pos = { x = 728.464, y = 71.415, z = 336.723 }, rot = { x = 0.000, y = 259.424, z = 0.000 }, level = 1, disableWander = true, pose_id = 9006 },
	{ config_id = 3006, monster_id = 25210401, pos = { x = 733.569, y = 71.429, z = 332.280 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 9001 },
...
-- 装置
gadgets = {
	{ config_id = 3001, gadget_id = 70290508, pos = { x = 733.544, y = 71.345, z = 336.768 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 3002, gadget_id = 70360001, pos = { x = 733.544, y = 71.393, z = 336.768 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, worktop_config = { init_options = { 220 } } },
	{ config_id = 3003, gadget_id = 70290484, pos = { x = 733.544, y = 71.345, z = 336.768 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
