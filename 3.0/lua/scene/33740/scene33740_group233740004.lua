...
-- 怪物
monsters = {
	{ config_id = 4001, monster_id = 24030101, pos = { x = 0.076, y = -0.102, z = 10.101 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, pose_id = 101, vision_level = VisionLevelType.VISION_LEVEL_LITTLE_REMOTE },
