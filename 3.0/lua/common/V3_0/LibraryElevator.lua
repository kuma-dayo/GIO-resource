...
local extraTriggers = 
{
    ...
    { config_id = 40000003, name = "tri_reach_point", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "", action = "action_EVENT_PLATFORM_REACH_POINT", trigger_count = 0 },
