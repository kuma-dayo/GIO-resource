...
function LF_Initialize_Group(triggers, suites)
	...
	table.insert(variables,{ name = "step", value = 0, no_refresh = false})
	table.insert(variables,{ name = "killMonster", value = 0, no_refresh = false})
	table.insert(variables,{ name = "RaioCotterDoLaserSkill", value = 0, no_refresh = false})
--初始化
end
