...
-- 怪物
monsters = {
	{ config_id = 18001, monster_id = 28020402, pos = { x = 1.594, y = -0.009, z = -2.513 }, rot = { x = 0.000, y = 328.309, z = 0.000 }, level = 1, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 1 },
	{ config_id = 18004, monster_id = 28020401, pos = { x = 1.594, y = -0.009, z = -2.513 }, rot = { x = 0.000, y = 328.309, z = 0.000 }, level = 1, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 1 },
	{ config_id = 18005, monster_id = 28020403, pos = { x = 1.594, y = -0.009, z = -2.513 }, rot = { x = 0.000, y = 328.309, z = 0.000 }, level = 1, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 1 },
	{ config_id = 18006, monster_id = 28020404, pos = { x = 1.594, y = -0.009, z = -2.513 }, rot = { x = 0.000, y = 328.309, z = 0.000 }, level = 1, drop_tag = "走兽", disableWander = true, pose_id = 2, area_id = 1 }
}
