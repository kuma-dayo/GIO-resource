...
-- 区域
regions = {
	{ config_id = 1032, shape = RegionShape.SPHERE, radius = 50, pos = { x = 57.938, y = 76.940, z = -84.240 } }
}
...
triggers = {
	...
	{ config_id = 1001032, name = "ENTER_REGION_1032", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_1032", action = "action_EVENT_ENTER_REGION_1032" },
	...
	{ config_id = 1001039, name = "CHALLENGE_FAIL_1039", event = EventType.EVENT_CHALLENGE_FAIL, source = "", condition = "", action = "action_EVENT_CHALLENGE_FAIL_1039" }
}

-- 变量
variables = {
	{ name = "challenge", value = 0, no_refresh = false },
	{ name = "OneTimeDungeon", value = 0, no_refresh = false }
}
...
suites = {
	{
		...
		regions = { 1032 },
		triggers = { "ANY_MONSTER_DIE_1029", "ENTER_REGION_1032", "CHALLENGE_SUCCESS_1036", "CHALLENGE_FAIL_1039" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
...
-- 触发条件
function condition_EVENT_ENTER_REGION_1032(context, evt)
	if evt.param1 ~= 1032 then return false end
...
-- 触发操作
function action_EVENT_ENTER_REGION_1032(context, evt)
