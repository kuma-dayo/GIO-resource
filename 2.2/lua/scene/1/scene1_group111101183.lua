...
-- 变量
variables = {
	{ name = "Pillar01", value = 1, no_refresh = false },
	{ name = "Pillar02", value = 2, no_refresh = false },
	{ name = "Pillar03", value = 3, no_refresh = false },
	{ name = "Pillar04", value = 4, no_refresh = false },
	{ name = "Pillar05", value = 5, no_refresh = false },
