...
-- 变量
variables = {
	{ name = "battle", value = 0, no_refresh = false }
}
...
suites = {
	{
		...
		regions = { 1007, 1012 },
		triggers = { "SPECIFIC_MONSTER_HP_CHANGE_1003", "ANY_MONSTER_DIE_1005", "ENTER_REGION_1007", "CHALLENGE_SUCCESS_1009", "CHALLENGE_FAIL_1010", "MONSTER_BATTLE_1011", "ENTER_REGION_1012" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
