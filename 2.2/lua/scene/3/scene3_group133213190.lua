...
-- 怪物
monsters = {
	{ config_id = 190001, monster_id = 25100101, pos = { x = -3447.114, y = 200.178, z = -3318.089 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, drop_id = 1000100, affix = { 1008, 1009 }, isElite = true, isOneoff = true, pose_id = 1, title_id = 10029, special_name_id = 10050, area_id = 12 }
}
