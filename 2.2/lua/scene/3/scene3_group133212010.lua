...
garbages = {
	gadgets = {
		{ config_id = 10008, gadget_id = 70900387, pos = { x = -3854.804, y = 202.303, z = -2588.741 }, rot = { x = 10.703, y = 72.667, z = 356.185 }, level = 27, isOneoff = true, persistent = true, area_id = 13 }
	}
}
