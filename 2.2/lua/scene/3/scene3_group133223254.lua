...
-- 装置
gadgets = {
	{ config_id = 254004, gadget_id = 70500000, pos = { x = -6152.149, y = 220.608, z = -2816.690 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 4005, isOneoff = true, persistent = true, area_id = 18 }
}
