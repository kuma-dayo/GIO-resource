...
gadgets = {
	...
	{ config_id = 201002, gadget_id = 70211111, pos = { x = -2495.840, y = 274.326, z = -4296.047 }, rot = { x = 0.341, y = 306.751, z = 17.680 }, level = 26, drop_tag = "解谜中级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 11 },
