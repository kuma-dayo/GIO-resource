...
-- 装置
gadgets = {
	{ config_id = 60002, gadget_id = 70211012, pos = { x = -6407.694, y = 201.041, z = -2386.212 }, rot = { x = 355.053, y = 134.687, z = 4.006 }, level = 26, drop_tag = "战斗中级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 18 },
