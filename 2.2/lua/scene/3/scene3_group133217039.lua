...
-- 怪物
monsters = {
	[39001] = { config_id = 39001, monster_id = 23010101, pos = { x = -4475.442, y = 200.944, z = -3771.290 }, rot = { x = 0.000, y = 337.246, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1401 }, isElite = true, area_id = 14 },
	...
	[39003] = { config_id = 39003, monster_id = 23010201, pos = { x = -4487.508, y = 200.000, z = -3760.809 }, rot = { x = 12.865, y = 134.128, z = 2.543 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1401 }, isElite = true, area_id = 14 },
...
-- 变量
variables = {
	{ name = "hasStarted", value = 0, no_refresh = true }
}
