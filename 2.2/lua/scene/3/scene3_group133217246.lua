...
monsters = {
	...
	{ config_id = 246003, monster_id = 24020301, pos = { x = -4431.458, y = 164.492, z = -3776.076 }, rot = { x = 0.097, y = 211.539, z = 359.636 }, level = 30, drop_tag = "拟生机关", isOneoff = true, pose_id = 101, area_id = 14 },
...
variables = {
	...
	{ name = "win", value = 0, no_refresh = true }
}
