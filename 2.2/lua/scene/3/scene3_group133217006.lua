...
-- 变量
variables = {
	{ name = "Option", value = 0, no_refresh = false },
...
suites = {
	{
		...
		regions = { 6018, 6020 },
		triggers = { "VARIABLE_CHANGE_6016", "QUEST_START_6017", "ENTER_REGION_6018", "SELECT_OPTION_6019", "LEAVE_REGION_6020", "VARIABLE_CHANGE_6021", "TIME_AXIS_PASS_6022" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
