...
variables = {
	...
	{ name = "PuzzleFinish", value = 0, no_refresh = true },
	{ name = "number", value = 3, no_refresh = true },
	{ name = "challenge", value = 0, no_refresh = true },
	{ name = "monster", value = 12, no_refresh = true }
}
