...
gadgets = {
	...
	{ config_id = 40027, gadget_id = 70900388, pos = { x = -4313.865, y = 200.194, z = -4050.058 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 14 },
	{ config_id = 40028, gadget_id = 70220004, pos = { x = -4311.569, y = 200.081, z = -4056.319 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 14 },
	{ config_id = 40029, gadget_id = 70900388, pos = { x = -4331.420, y = 200.217, z = -4027.849 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 14 },
	{ config_id = 40030, gadget_id = 70220004, pos = { x = -4327.482, y = 200.299, z = -4032.577 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 14 },
	{ config_id = 40031, gadget_id = 70900388, pos = { x = -4323.747, y = 200.262, z = -4037.304 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, area_id = 14 },
...
variables = {
	...
	{ name = "isObstacle3Available", value = 2, no_refresh = false }
}
