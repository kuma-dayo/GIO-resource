...
gadgets = {
	...
	{ config_id = 124022, gadget_id = 70220026, pos = { x = -4821.569, y = 212.293, z = -4750.833 }, rot = { x = 0.372, y = 89.843, z = 1.624 }, level = 30, area_id = 14 },
...
garbages = {
	...
	gadgets = {
		{ config_id = 124001, gadget_id = 70220014, pos = { x = -4809.011, y = 211.953, z = -4777.959 }, rot = { x = 5.334, y = 345.521, z = 354.045 }, level = 30, area_id = 14 },
