...
-- 装置
gadgets = {
	{ config_id = 294001, gadget_id = 70360170, pos = { x = -3780.932, y = 203.984, z = -3102.702 }, rot = { x = 87.764, y = 261.010, z = 18.622 }, level = 27, isOneoff = true, persistent = true, area_id = 12 },
...
-- 变量
variables = {
	{ name = "count", value = 1, no_refresh = false }
}
