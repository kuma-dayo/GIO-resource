...
triggers = {
	...
	{ config_id = 1190023, name = "ENTER_REGION_190023", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_190023", action = "", tag = "666" }
}
...
function action_EVENT_CHALLENGE_SUCCESS_190018(context, evt)
	...
	-- 删除suite5的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133212190, 5)
