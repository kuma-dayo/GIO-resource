...
-- 变量
variables = {
	{ name = "Gadget_Count1", value = 0, no_refresh = true },
	{ name = "Gadget_Count2", value = 0, no_refresh = true },
	{ name = "Gadget_Count3", value = 0, no_refresh = true },
	{ name = "Gadget_Count4", value = 0, no_refresh = true },
