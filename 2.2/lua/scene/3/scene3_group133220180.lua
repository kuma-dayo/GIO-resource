...
gadgets = {
	...
	{ config_id = 180025, gadget_id = 70300075, pos = { x = -2609.879, y = 199.945, z = -3973.389 }, rot = { x = 0.000, y = 66.717, z = 0.000 }, level = 1, area_id = 11 },
...
-- 变量
variables = {
	{ name = "isObstacle1Available", value = 2, no_refresh = false },
	{ name = "isObstacle2Available", value = 0, no_refresh = false },
