...
-- 变量
variables = {
	{ name = "EnergyBall_Succ_Count", value = 0, no_refresh = true },
	{ name = "mission_progress", value = 0, no_refresh = true },
	{ name = "feather_count", value = 0, no_refresh = true },
	{ name = "feather01", value = 0, no_refresh = true },
	{ name = "feather02", value = 0, no_refresh = true },
	{ name = "feather03", value = 0, no_refresh = true },
	{ name = "feather04", value = 0, no_refresh = true }
}
