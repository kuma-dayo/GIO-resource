...
gadgets = {
	...
	{ config_id = 456006, gadget_id = 70360170, pos = { x = -2817.120, y = 190.205, z = -4072.253 }, rot = { x = 87.360, y = 39.349, z = 167.475 }, level = 27, area_id = 11 },
...
-- 变量
variables = {
	{ name = "gate1", value = 0, no_refresh = true },
	{ name = "gate2", value = 0, no_refresh = true },
	{ name = "gate3", value = 0, no_refresh = true }
}
