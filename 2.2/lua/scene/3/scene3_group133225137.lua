...
-- 装置
gadgets = {
	{ config_id = 137001, gadget_id = 70500000, pos = { x = -6483.073, y = 223.393, z = -2448.782 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 4005, isOneoff = true, persistent = true, area_id = 18 }
}
