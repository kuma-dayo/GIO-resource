...
-- 装置
gadgets = {
	{ config_id = 367001, gadget_id = 70330064, pos = { x = -3732.698, y = 203.826, z = -1671.198 }, rot = { x = 0.000, y = 155.125, z = 0.028 }, level = 27, state = GadgetState.GearStop, persistent = true, interact_id = 35, area_id = 13 },
