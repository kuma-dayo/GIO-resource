...
garbages = {
	gadgets = {
		{ config_id = 141001, gadget_id = 70350292, pos = { x = -3610.148, y = 211.634, z = -953.343 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 },
		{ config_id = 141002, gadget_id = 70211101, pos = { x = -3575.436, y = 207.473, z = -949.548 }, rot = { x = 355.767, y = 239.968, z = 6.600 }, level = 26, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 17 },
		{ config_id = 141003, gadget_id = 70350292, pos = { x = -3578.015, y = 207.755, z = -949.999 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 2, start_route = false, persistent = true, is_use_point_array = true, area_id = 17 }
	}
}
