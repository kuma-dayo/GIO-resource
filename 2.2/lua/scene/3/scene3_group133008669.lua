...
points = {
	...
	{ config_id = 669026, pos = { x = 890.184, y = 201.247, z = -1141.777 }, rot = { x = 0.000, y = 79.460, z = 0.000 }, area_id = 10, tag = 4 },
...
-- 变量
variables = {
	{ name = "finalWave", value = 6, no_refresh = false },
	{ name = "refreshMonster", value = 0, no_refresh = false },
	{ name = "isTimeout", value = 0, no_refresh = false }
}
