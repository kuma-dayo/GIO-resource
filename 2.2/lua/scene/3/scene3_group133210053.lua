...
-- 装置
gadgets = {
	{ config_id = 53001, gadget_id = 70211111, pos = { x = -4028.396, y = 207.990, z = -900.455 }, rot = { x = 4.019, y = 169.158, z = 7.918 }, level = 26, drop_tag = "解谜中级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 17 },
