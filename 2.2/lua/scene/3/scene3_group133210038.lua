...
-- 装置
gadgets = {
	{ config_id = 38001, gadget_id = 70500000, pos = { x = -4061.951, y = 236.787, z = -873.308 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, point_type = 4005, isOneoff = true, area_id = 17 },
	{ config_id = 38002, gadget_id = 70500000, pos = { x = -4060.414, y = 206.825, z = -816.264 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 30, point_type = 4005, isOneoff = true, area_id = 17 },
