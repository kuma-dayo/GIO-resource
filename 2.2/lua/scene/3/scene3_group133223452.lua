...
gadgets = {
	...
	{ config_id = 452002, gadget_id = 70230046, pos = { x = -5958.679, y = 239.136, z = -2577.777 }, rot = { x = 87.118, y = 236.533, z = 313.725 }, level = 33, state = GadgetState.GearStop, persistent = true, area_id = 18 },
...
variables = {
	...
	{ name = "Notified", value = 0, no_refresh = false }
}
