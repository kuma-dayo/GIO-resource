...
variables = {
	...
	{ name = "SeelieMove1", value = 0, no_refresh = true },
	{ name = "SeelieMove2", value = 0, no_refresh = true },
	{ name = "SeelieMove3", value = 0, no_refresh = true },
	{ name = "SeelieMove4", value = 0, no_refresh = true }
}
