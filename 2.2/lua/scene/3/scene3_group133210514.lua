...
triggers = {
	...
	{ config_id = 1514004, name = "VARIABLE_CHANGE_514004", event = EventType.EVENT_VARIABLE_CHANGE, source = "ActiveCount4", condition = "condition_EVENT_VARIABLE_CHANGE_514004", action = "action_EVENT_VARIABLE_CHANGE_514004", trigger_count = 0 },
	{ config_id = 1514010, name = "PLATFORM_REACH_POINT_514010", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_514010", action = "action_EVENT_PLATFORM_REACH_POINT_514010", trigger_count = 0 },
	...
	{ config_id = 1514019, name = "PLATFORM_REACH_POINT_514019", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_514019", action = "action_EVENT_PLATFORM_REACH_POINT_514019", trigger_count = 0 },
	{ config_id = 1514020, name = "PLATFORM_REACH_POINT_514020", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_514020", action = "action_EVENT_PLATFORM_REACH_POINT_514020", trigger_count = 0 },
	{ config_id = 1514021, name = "TIME_AXIS_PASS_514021", event = EventType.EVENT_TIME_AXIS_PASS, source = "setstatue1", condition = "condition_EVENT_TIME_AXIS_PASS_514021", action = "action_EVENT_TIME_AXIS_PASS_514021", trigger_count = 0 },
	{ config_id = 1514022, name = "TIME_AXIS_PASS_514022", event = EventType.EVENT_TIME_AXIS_PASS, source = "setstatue2", condition = "condition_EVENT_TIME_AXIS_PASS_514022", action = "action_EVENT_TIME_AXIS_PASS_514022", trigger_count = 0 },
	{ config_id = 1514023, name = "TIME_AXIS_PASS_514023", event = EventType.EVENT_TIME_AXIS_PASS, source = "setstatue3", condition = "condition_EVENT_TIME_AXIS_PASS_514023", action = "action_EVENT_TIME_AXIS_PASS_514023", trigger_count = 0 },
	{ config_id = 1514024, name = "PLATFORM_REACH_POINT_514024", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_514024", action = "action_EVENT_PLATFORM_REACH_POINT_514024", trigger_count = 0 },
	{ config_id = 1514025, name = "AVATAR_NEAR_PLATFORM_514025", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_514025", action = "action_EVENT_AVATAR_NEAR_PLATFORM_514025", trigger_count = 0 },
	{ config_id = 1514026, name = "AVATAR_NEAR_PLATFORM_514026", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_514026", action = "action_EVENT_AVATAR_NEAR_PLATFORM_514026", trigger_count = 0 },
	{ config_id = 1514027, name = "AVATAR_NEAR_PLATFORM_514027", event = EventType.EVENT_AVATAR_NEAR_PLATFORM, source = "", condition = "condition_EVENT_AVATAR_NEAR_PLATFORM_514027", action = "action_EVENT_AVATAR_NEAR_PLATFORM_514027", trigger_count = 0 },
...
-- 变量
variables = {
	{ name = "ActiveCount1", value = 0, no_refresh = true },
	{ name = "ActiveCount2", value = 0, no_refresh = true },
	{ name = "ActiveCount3", value = 0, no_refresh = true },
	{ name = "ActiveCount4", value = 0, no_refresh = true },
	{ name = "Success", value = 0, no_refresh = true },
	{ name = "reminder", value = 0, no_refresh = true },
	{ name = "Monster1", value = 0, no_refresh = true },
	{ name = "Monster2", value = 0, no_refresh = true },
	{ name = "Monster3", value = 0, no_refresh = true }
}

-- 废弃数据
garbages = {
	gadgets = {
		{ config_id = 514007, gadget_id = 70710010, pos = { x = -3802.437, y = 149.395, z = -1131.022 }, rot = { x = 0.000, y = 93.941, z = 0.000 }, level = 30, route_id = 321000111, start_route = false, persistent = true, area_id = 17 },
		{ config_id = 514008, gadget_id = 70710010, pos = { x = -3801.195, y = 149.430, z = -1089.918 }, rot = { x = 0.000, y = 135.437, z = 0.000 }, level = 30, route_id = 321000112, start_route = false, persistent = true, area_id = 17 },
		{ config_id = 514009, gadget_id = 70710010, pos = { x = -3759.152, y = 149.465, z = -1091.741 }, rot = { x = 0.000, y = 187.831, z = 0.000 }, level = 30, route_id = 321000113, start_route = false, persistent = true, area_id = 17 }
	}
}
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_514004(context, evt)
	if evt.param1 == evt.param2 then return false end
	
	-- 判断变量"ActiveCount4"为1
	if ScriptLib.GetGroupVariableValue(context, "ActiveCount4") ~= 1 then
			return false
	end
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_514004(context, evt)
		-- 添加某个flowSuite里的要素，如果当前与目标suite属性不一样，会纠正为目标属性，同时触发相应Trigger
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_514010(context, evt)
	-- 判断是gadgetid 为 514007的移动平台，是否到达了321000111 的路线中的 8 点
	
	if 514007 ~= evt.param1 then
	  return false
	end
	
	if 321000111 ~= evt.param2 then
	  return false
	end
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_514010(context, evt)
	-- 停止移动平台
	if 0 ~= ScriptLib.StopPlatform(context, 514007) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : stop_platform")
	  return -1
	end
	
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 514007 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : kill_entity_by_configId")
		    return -1
		end
		
	
	-- 创建标识为"setstatue1"，时间节点为{3}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "setstatue1", {3}, false)
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_514019(context, evt)
	-- 判断是gadgetid 为 514008的移动平台，是否到达了321000112 的路线中的 12 点
	
	if 514008 ~= evt.param1 then
	  return false
	end
	
	if 321000112 ~= evt.param2 then
	  return false
	end
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_514019(context, evt)
	-- 停止移动平台
	if 0 ~= ScriptLib.StopPlatform(context, 514008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : stop_platform")
	  return -1
	end
	
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 514008 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : kill_entity_by_configId")
		    return -1
		end
		
	
	-- 创建标识为"setstatue2"，时间节点为{3}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "setstatue2", {3}, false)
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_514020(context, evt)
	-- 判断是gadgetid 为 514009的移动平台，是否到达了321000113 的路线中的 8 点
	
	if 514009 ~= evt.param1 then
	  return false
	end
	
	if 321000113 ~= evt.param2 then
	  return false
	end
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_514020(context, evt)
	-- 停止移动平台
	if 0 ~= ScriptLib.StopPlatform(context, 514009) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : stop_platform")
	  return -1
	end
	
		-- 永久关闭CongfigId的Gadget，需要和Groups的RefreshWithBlock标签搭配
		if 0 ~= ScriptLib.KillEntityByConfigId(context, { config_id = 514009 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : kill_entity_by_configId")
		    return -1
		end
		
	
	-- 创建标识为"setstatue3"，时间节点为{3}的时间轴，false用于控制该时间轴是否循环
	ScriptLib.InitTimeAxis(context, "setstatue3", {3}, false)
...
function action_EVENT_TIME_AXIS_PASS_514021(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 133210391, 391004, GadgetState.GearStart) then
...
function action_EVENT_TIME_AXIS_PASS_514022(context, evt)
	...
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 133210391, 391005, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
-- 触发条件
function condition_EVENT_TIME_AXIS_PASS_514023(context, evt)
	if evt.param1 ~= 1 then
	   return false
	end
	return true
...
-- 触发操作
function action_EVENT_TIME_AXIS_PASS_514023(context, evt)
	-- 改变指定group组133210391中， configid为391001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 133210391, 391001, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
-- 触发条件
function condition_EVENT_PLATFORM_REACH_POINT_514024(context, evt)
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_514024(context, evt)
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_514025(context, evt)
	if 514007 ~= evt.param1 then
	return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_514025(context, evt)
	-- 启动移动平台
	if 0 ~= ScriptLib.StartPlatform(context, 514007) then
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_514026(context, evt)
	if 514008 ~= evt.param1 then
	return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_514026(context, evt)
	-- 启动移动平台
	if 0 ~= ScriptLib.StartPlatform(context, 514008) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : start_platform")
	  return -1
	end
...
-- 触发条件
function condition_EVENT_AVATAR_NEAR_PLATFORM_514027(context, evt)
	if 514009 ~= evt.param1 then
	return false
	end
...
-- 触发操作
function action_EVENT_AVATAR_NEAR_PLATFORM_514027(context, evt)
	-- 启动移动平台
	if 0 ~= ScriptLib.StartPlatform(context, 514009) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : start_platform")
	  return -1
	end
