...
gadgets = {
	...
	{ config_id = 358008, gadget_id = 70360025, pos = { x = -6234.837, y = 277.857, z = -2927.062 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	{ config_id = 358009, gadget_id = 70350085, pos = { x = -6248.335, y = 245.759, z = -2956.660 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	{ config_id = 358011, gadget_id = 70350085, pos = { x = -6238.394, y = 258.680, z = -2957.618 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	...
	{ config_id = 358015, gadget_id = 70350085, pos = { x = -6234.837, y = 279.284, z = -2927.062 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	{ config_id = 358016, gadget_id = 70350085, pos = { x = -6250.553, y = 233.015, z = -2940.329 }, rot = { x = 8.166, y = 253.112, z = 0.817 }, level = 19, area_id = 18 },
	{ config_id = 358017, gadget_id = 70710126, pos = { x = -6248.335, y = 244.769, z = -2956.660 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	{ config_id = 358018, gadget_id = 70710126, pos = { x = -6238.394, y = 257.420, z = -2957.618 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 19, area_id = 18 },
	...
	{ config_id = 358030, gadget_id = 70330064, pos = { x = -6249.524, y = 244.721, z = -2960.309 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, interact_id = 35, area_id = 18 },
	...
	{ config_id = 358035, gadget_id = 70330064, pos = { x = -6234.928, y = 258.327, z = -2959.229 }, rot = { x = 24.596, y = 0.000, z = 0.000 }, level = 1, interact_id = 35, area_id = 18 },
	{ config_id = 358036, gadget_id = 70330064, pos = { x = -6226.761, y = 269.240, z = -2949.615 }, rot = { x = 17.430, y = 8.512, z = 355.621 }, level = 1, interact_id = 35, area_id = 18 }
}

-- 区域
regions = {
	{ config_id = 358010, shape = RegionShape.SPHERE, radius = 3, pos = { x = -6248.003, y = 244.833, z = -2956.802 }, area_id = 18 },
	{ config_id = 358023, shape = RegionShape.SPHERE, radius = 2, pos = { x = -6234.875, y = 277.868, z = -2927.090 }, area_id = 18 },
	{ config_id = 358026, shape = RegionShape.SPHERE, radius = 3, pos = { x = -6238.409, y = 257.418, z = -2957.631 }, area_id = 18 },
...
triggers = {
	...
	{ config_id = 1358023, name = "ENTER_REGION_358023", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_358023", action = "", trigger_count = 0, tag = "888" },
...
suites = {
	...
	},
	{
		...
		-- description = 节点2,
		monsters = { },
		gadgets = { 358011, 358018, 358031, 358035 },
		regions = { 358026 },
