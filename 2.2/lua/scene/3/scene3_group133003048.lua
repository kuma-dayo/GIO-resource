...
gadgets = {
	...
	[48012] = { config_id = 48012, gadget_id = 70300085, pos = { x = 2563.119, y = 357.711, z = -1720.627 }, rot = { x = 0.000, y = 9.185, z = 16.898 }, level = 15, persistent = true, area_id = 1 },
...
-- 变量
variables = {
	{ name = "save", value = 0, no_refresh = true },
	{ name = "IS_BOSS1_DEAD", value = 0, no_refresh = true },
	{ name = "IS_BOSS2_DEAD", value = 0, no_refresh = true },
	{ name = "OverKey", value = 0, no_refresh = false },
	{ name = "stage", value = 1, no_refresh = true }
}
