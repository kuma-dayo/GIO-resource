...
-- 装置
gadgets = {
	{ config_id = 198001, gadget_id = 70950095, pos = { x = -6101.766, y = 218.711, z = -2453.745 }, rot = { x = 0.006, y = 136.564, z = 0.116 }, level = 2, persistent = true, is_use_point_array = true, area_id = 18 },
