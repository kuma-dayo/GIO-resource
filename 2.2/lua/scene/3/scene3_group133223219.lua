...
-- 装置
gadgets = {
	{ config_id = 219001, gadget_id = 70500000, pos = { x = -5890.947, y = 171.142, z = -2691.726 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 4005, isOneoff = true, persistent = true, area_id = 18 },
	{ config_id = 219002, gadget_id = 70500000, pos = { x = -5927.839, y = 157.339, z = -2710.209 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 4005, isOneoff = true, persistent = true, area_id = 18 }
}
