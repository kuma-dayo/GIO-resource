...
-- 变量
variables = {
	{ name = "group_1_progress", value = 0, no_refresh = true },
	{ name = "group_2_progress", value = 0, no_refresh = true },
	{ name = "group_3_progress", value = 0, no_refresh = true },
	{ name = "group_4_progress", value = 0, no_refresh = true }
}
