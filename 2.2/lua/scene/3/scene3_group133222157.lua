...
gadgets = {
	...
	{ config_id = 157040, gadget_id = 70310074, pos = { x = -4677.371, y = 119.958, z = -4239.891 }, rot = { x = 0.000, y = 88.034, z = 0.000 }, level = 30, persistent = true, area_id = 14 },
...
-- 变量
variables = {
	{ name = "Last", value = 0, no_refresh = true }
}
