...
garbages = {
	gadgets = {
		...
		{ config_id = 434004, gadget_id = 70500000, pos = { x = -6378.064, y = 203.839, z = -2918.497 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 33, point_type = 4005, isOneoff = true, persistent = true, area_id = 18 },
