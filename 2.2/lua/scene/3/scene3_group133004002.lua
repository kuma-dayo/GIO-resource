...
garbages = {
	gadgets = {
		{ config_id = 2108, gadget_id = 70310008, pos = { x = 1957.797, y = 235.980, z = 666.300 }, rot = { x = 89.980, y = 75.000, z = 0.000 }, level = 1, area_id = 5 },
		{ config_id = 2109, gadget_id = 70310008, pos = { x = 1958.807, y = 235.980, z = 662.494 }, rot = { x = 90.000, y = 75.000, z = 0.000 }, level = 1, area_id = 5 }
	}
}
