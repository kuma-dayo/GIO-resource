...
-- NPC
npcs = {
	{ config_id = 3006, npc_id = 20408, pos = { x = -3012.049, y = 225.358, z = -4406.031 }, rot = { x = 0.000, y = 296.280, z = 0.000 }, area_id = 11 },
...
-- 装置
gadgets = {
	{ config_id = 3001, gadget_id = 70710443, pos = { x = -3011.906, y = 224.596, z = -4406.079 }, rot = { x = 0.000, y = 296.240, z = 0.000 }, level = 1, area_id = 11 },
