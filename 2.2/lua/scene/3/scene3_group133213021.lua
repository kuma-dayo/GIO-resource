...
monsters = {
	...
	{ config_id = 21005, monster_id = 22010401, pos = { x = -3870.841, y = 200.314, z = -2899.600 }, rot = { x = 1.739, y = 93.109, z = 0.990 }, level = 27, drop_tag = "深渊法师", disableWander = true, pose_id = 9013, area_id = 12 }
}
