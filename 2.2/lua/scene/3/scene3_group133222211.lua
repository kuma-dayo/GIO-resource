...
gadgets = {
	...
	{ config_id = 211004, gadget_id = 70950095, pos = { x = -4789.759, y = 286.662, z = -4046.907 }, rot = { x = 0.000, y = 74.830, z = 0.000 }, level = 2, persistent = true, is_use_point_array = true, area_id = 14 },
	...
	{ config_id = 211006, gadget_id = 70950145, pos = { x = -4503.669, y = 96.783, z = -4384.732 }, rot = { x = 4.413, y = 53.626, z = 0.660 }, level = 2, persistent = true, area_id = 14 },
	...
	{ config_id = 211017, gadget_id = 70330114, pos = { x = -4571.956, y = 336.156, z = -4312.676 }, rot = { x = 4.418, y = 53.338, z = 0.626 }, level = 30, area_id = 14 },
...
regions = {
	...
	{ config_id = 211012, shape = RegionShape.SPHERE, radius = 1.5, pos = { x = -4790.063, y = 287.417, z = -4046.913 }, area_id = 14 }
}
