...
-- 装置
gadgets = {
	{ config_id = 62002, gadget_id = 70211002, pos = { x = -3535.851, y = 202.657, z = -793.666 }, rot = { x = 6.667, y = 268.471, z = 0.819 }, level = 26, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 17 },
