...
gadgets = {
	...
	{ config_id = 85004, gadget_id = 70211002, pos = { x = -6251.516, y = 248.501, z = -2573.993 }, rot = { x = 359.762, y = 204.205, z = 3.273 }, level = 26, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 18 },
...
-- 变量
variables = {
	{ name = "chestState", value = 0, no_refresh = true },
	{ name = "suiteBySeq", value = 0, no_refresh = true }
}
