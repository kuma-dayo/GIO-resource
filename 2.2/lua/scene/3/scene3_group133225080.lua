...
monsters = {
	...
	{ config_id = 80014, monster_id = 21030101, pos = { x = -6401.841, y = 199.554, z = -2822.758 }, rot = { x = 343.739, y = 61.489, z = 354.838 }, level = 33, drop_tag = "丘丘萨满", disableWander = true, pose_id = 9012, climate_area_id = 7, area_id = 18 },
