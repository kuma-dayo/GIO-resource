...
-- 装置
gadgets = {
	{ config_id = 130001, gadget_id = 70350006, pos = { x = -3893.464, y = 226.640, z = -2273.554 }, rot = { x = 270.119, y = 151.000, z = 180.000 }, level = 27, state = GadgetState.GearStart, persistent = true, area_id = 13 },
	{ config_id = 130002, gadget_id = 70350006, pos = { x = -3893.467, y = 224.109, z = -2273.550 }, rot = { x = 270.119, y = 151.001, z = 180.000 }, level = 27, state = GadgetState.GearStart, persistent = true, area_id = 13 },
	{ config_id = 130003, gadget_id = 70350006, pos = { x = -3893.469, y = 221.643, z = -2273.545 }, rot = { x = 270.117, y = 151.001, z = 180.000 }, level = 27, persistent = true, area_id = 13 },
...
-- 变量
variables = {
	{ name = "debug_01", value = 0, no_refresh = false },
	{ name = "door_01", value = 0, no_refresh = false }
}
