...
function action_EVENT_ENTER_REGION_4005(context, evt)
	...
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220118004, 4003, {1}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220118004, 4006, {1}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220118004, 4013, {73}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
	
	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 220118004, 4016, {73}) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_wok_options_by_configid")
		return -1
	end
...
function action_EVENT_ENTER_REGION_4007(context, evt)
	-- 改变指定group组220118004中， configid为4003的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118004, 4003, GadgetState.Default) then
...
function action_EVENT_ENTER_REGION_4009(context, evt)
	-- 改变指定group组220118004中， configid为4006的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118004, 4006, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_SELECT_OPTION_4010(context, evt)
	-- 改变指定group组220118004中， configid为4006的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118004, 4006, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
...
function action_EVENT_SELECT_OPTION_4014(context, evt)
	-- 改变指定group组220118004中， configid为4012的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118004, 4012, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 删除指定group： 220118004 ；指定config：4013；物件身上指定option：73；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 220118004, 4013, 73) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		return -1
	end
...
function action_EVENT_SELECT_OPTION_4017(context, evt)
	-- 改变指定group组220118004中， configid为4015的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118004, 4015, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 删除指定group： 220118004 ；指定config：4016；物件身上指定option：73；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 220118004, 4016, 73) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : del_work_options_by_group_configId")
		return -1
	end
