...
function action_EVENT_SELECT_OPTION_1015(context, evt)
	-- 改变指定group组220118001中， configid为1008的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 220118001, 1008, GadgetState.GearStart) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end 
	
	-- 删除指定group： 220118001 ；指定config：1012；物件身上指定option：73；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 220118001, 1012, 73) then
