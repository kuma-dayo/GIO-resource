...
local var = {
	[1] = {name="SGV_TDLevel",value=1,no_refresh=true},
	[2] = {name="SGV_TDCanDoAttack",value=1,no_refresh=true},
	[3] = {name="SGV_TDUpGrade_Special",value=0,no_refresh=true},
	[4] = {name="SGV_TDAttackDamage_A",value=0,no_refresh=true},
	[5] = {name="SGV_TDAttackSpeed_A",value=0,no_refresh=true},
	[6] = {name="SGV_TDAttackRange_A",value=0,no_refresh=true},
	[7] = {name="SGV_TDAttackDamage_B",value=0,no_refresh=true},
	[8] = {name="SGV_TDAttackSpeed_B",value=0,no_refresh=true},
	[9] = {name="SGV_TDAttackRange_B",value=0,no_refresh=true},
	[10]= {name="SGV_TDAttackSpeed_C",value=0,no_refresh=true},
	[11]= {name="SGV_TDAttackMastery",value=0,no_refresh=true}
}
local tri = {
