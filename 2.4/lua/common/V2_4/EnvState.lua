...
function Initialize()
    ...
    if (hasTriggerInsertWhitelist) then
        ...
        if (init_config.io_type ~= 1) then
            ...
            table.insert(variables,{ name = "is_daynight_finish", value = 0, no_refresh = true})
        else
            ...
            for i = 1, #TriggerInsertWhitelist do 
                ...
                table.insert(suite_disk[TriggerInsertWhitelist[i]].variables,{ name = "is_daynight_finish", value = 0, no_refresh = true})
            end
        end
    else
        ...
        if (init_config.io_type ~= 1) then
            ...
            for i = 1, #suite_disk do 
                ...
                table.insert(suite_disk[i].variables,{ name = "is_daynight_finish", value = 0, no_refresh = true})
            end
        end
    end
