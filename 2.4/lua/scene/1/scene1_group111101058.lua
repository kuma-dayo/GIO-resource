...
regions = {
	...
	{ config_id = 58011, shape = RegionShape.POLYGON, pos = { x = 2354.168, y = 284.141, z = -1738.440 }, height = 15.000, point_array = { { x = 2361.730, y = -1727.950 }, { x = 2365.169, y = -1743.243 }, { x = 2351.515, y = -1750.085 }, { x = 2343.166, y = -1740.615 }, { x = 2347.505, y = -1726.796 } } }
}
