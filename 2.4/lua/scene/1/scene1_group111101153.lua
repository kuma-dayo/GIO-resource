...
-- 变量
variables = {
	{ name = "gadget_Teleport_1_isActive", value = 0, no_refresh = false },
	{ name = "gadget_Teleport_2_isActive", value = 0, no_refresh = false },
	{ name = "gadget_Teleport_3_isActive", value = 0, no_refresh = false },
	{ name = "gadget_Teleport_4_isActive", value = 0, no_refresh = false }
}
