...
-- 变量
variables = {
	{ name = "sort", value = 0, no_refresh = true },
	{ name = "gear_reset", value = 0, no_refresh = true },
	{ name = "v_error", value = 0, no_refresh = true },
	{ name = "trigger_output", value = 0, no_refresh = true },
