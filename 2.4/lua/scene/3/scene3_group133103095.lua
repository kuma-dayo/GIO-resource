...
-- 变量
variables = {
	{ name = "ovenATemp", value = 50, no_refresh = false },
	{ name = "ovenBTemp", value = 50, no_refresh = false },
	{ name = "ovenCTemp", value = 50, no_refresh = false },
	{ name = "curPos", value = 2, no_refresh = false },
	{ name = "fireDirection", value = 0, no_refresh = false },
	{ name = "ovenATempDirection", value = 2, no_refresh = false },
	{ name = "ovenBTempDirection", value = 1, no_refresh = false },
	{ name = "ovenCTempDirection", value = 2, no_refresh = false },
	{ name = "startOrNot", value = 0, no_refresh = false },
	{ name = "isRightBtnPressed", value = 0, no_refresh = false },
	{ name = "isLeftBtnPressed", value = 0, no_refresh = false }
}
