...
variables = {
	...
	{ name = "isObstacle0Available", value = 1, no_refresh = false },
	{ name = "gadget1", value = 1, no_refresh = false },
	{ name = "gadget2", value = 1, no_refresh = false },
	{ name = "monster3", value = 1, no_refresh = false }
}
