...
-- 变量
variables = {
	{ name = "decal_finish_1", value = 0, no_refresh = true },
	{ name = "decal_finish_2", value = 0, no_refresh = true },
	{ name = "decal_finish_3", value = 0, no_refresh = true },
	{ name = "total_progress", value = 0, no_refresh = true },
	{ name = "decal_create_1", value = 0, no_refresh = true },
	{ name = "decal_create_2", value = 0, no_refresh = true },
	{ name = "decal_create_3", value = 0, no_refresh = true },
	{ name = "decal_create_all", value = 0, no_refresh = true }
}
