...
-- 变量
variables = {
	{ name = "hasReachedO1", value = 0, no_refresh = false },
	{ name = "isO1Available", value = 1, no_refresh = false },
	{ name = "hasReachedO2", value = 0, no_refresh = false },
	{ name = "isO2Available", value = 1, no_refresh = false },
	{ name = "hasReachedO3", value = 0, no_refresh = false },
	{ name = "isO3Available", value = 1, no_refresh = false }
}
