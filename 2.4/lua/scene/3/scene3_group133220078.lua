...
-- 变量
variables = {
	{ name = "regionCount", value = 0, no_refresh = false },
	{ name = "RockDoor1", value = 0, no_refresh = true },
	{ name = "RockDoor2", value = 0, no_refresh = true },
	{ name = "RockDoor3", value = 0, no_refresh = true }
}
