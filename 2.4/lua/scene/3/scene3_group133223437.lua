...
variables = {
	...
	{ name = "featherfinish", value = 0, no_refresh = true }
}
...
suite_disk = {
	[1] = {
		...
		variables = {
			...
			{ name = "isstart", value = 0, no_refresh = false },
			{ name = "currentPathNodeIndex", value = 0, no_refresh = false },
			{ name = "featherfinish", value = 0, no_refresh = false }
		}
	},
	[2] = {
		gadgets = {
			{ config_id = 437002, state = 0, platform_info = { point_id = 0, move_type = 1, route_id = 0, route_index = 0, is_started = false } },
