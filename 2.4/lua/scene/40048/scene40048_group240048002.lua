...
-- 变量
variables = {
	{ name = "wall3", value = 1, no_refresh = false },
	{ name = "wall4", value = 0, no_refresh = false },
	{ name = "wall5", value = 1, no_refresh = false },
	{ name = "wall6", value = 0, no_refresh = false },
	{ name = "wall7", value = 1, no_refresh = false },
	{ name = "wall9", value = 1, no_refresh = false },
	{ name = "wall70", value = 1, no_refresh = false },
	{ name = "wall90", value = 0, no_refresh = false },
	{ name = "gadget1", value = 4, no_refresh = false },
	{ name = "gadget2", value = 4, no_refresh = false },
	{ name = "gadget3", value = 4, no_refresh = false },
	{ name = "gadget4", value = 4, no_refresh = false },
	{ name = "point", value = 0, no_refresh = false },
	{ name = "wall40", value = 0, no_refresh = false },
	{ name = "wall1", value = 0, no_refresh = false }
}
