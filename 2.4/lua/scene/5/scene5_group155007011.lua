...
variables = {
	...
	{ name = "Rune_01", value = 0, no_refresh = true },
	{ name = "Rune_02", value = 0, no_refresh = true },
	{ name = "Rune_03", value = 0, no_refresh = true },
	{ name = "Rune_04", value = 0, no_refresh = true },
	{ name = "Rune_05", value = 0, no_refresh = true }
}
...
suite_disk = {
	...
	[2] = {
		...
		npcs = { },
		variables = {
			{ name = "activecount", value = 5, no_refresh = true },
			{ name = "Rune_01", value = 1, no_refresh = true },
			{ name = "Rune_02", value = 1, no_refresh = true },
			{ name = "Rune_03", value = 1, no_refresh = true },
			{ name = "Rune_04", value = 1, no_refresh = true },
			{ name = "Rune_05", value = 1, no_refresh = true }
		}
	},
	[3] = {
		gadgets = {
