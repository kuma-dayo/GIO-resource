...
gadgets = {
	...
	{ config_id = 105003, gadget_id = 70211101, pos = { x = -178.902, y = 204.558, z = 1622.877 }, rot = { x = 349.005, y = 282.117, z = 4.833 }, level = 21, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 },
