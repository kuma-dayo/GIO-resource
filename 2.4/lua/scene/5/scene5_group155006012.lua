...
-- 变量
variables = {
	{ name = "RotWall_1", value = 180, no_refresh = true },
	{ name = "RotWall_2", value = 180, no_refresh = true },
	{ name = "RotWall_3", value = 0, no_refresh = true },
	{ name = "isStartRot_Wall_1", value = 0, no_refresh = false },
	{ name = "isStartRot_Wall_2", value = 0, no_refresh = false },
	{ name = "isStartRot_Wall_3", value = 0, no_refresh = false },
