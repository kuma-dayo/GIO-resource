...
-- 变量
variables = {
	{ name = "Door02", value = 0, no_refresh = true },
	{ name = "Door01", value = 0, no_refresh = true }
}
...
function condition_EVENT_GADGET_STATE_CHANGE_118007(context, evt)
	if 222 ~= ScriptLib.GetGadgetStateByConfigId(context, 155005118, 118003) then
			return false
		end
...
function condition_EVENT_GADGET_STATE_CHANGE_118008(context, evt)
	if 322 ~= ScriptLib.GetGadgetStateByConfigId(context, 155005118, 118004) then
			return false
		end
