...
gadgets = {
	...
	{ config_id = 224003, gadget_id = 70211111, pos = { x = -159.981, y = 168.233, z = 128.538 }, rot = { x = 19.109, y = 102.089, z = 354.332 }, level = 16, drop_tag = "解谜中级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 },
