...
gadgets = {
	...
	{ config_id = 146007, gadget_id = 70310009, pos = { x = 376.502, y = 165.600, z = -204.530 }, rot = { x = 1.869, y = 259.795, z = 351.694 }, level = 36, area_id = 200 },
	...
	{ config_id = 146013, gadget_id = 70300107, pos = { x = 366.287, y = 164.735, z = -205.661 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, state = GadgetState.GearStart, area_id = 200 }
}
