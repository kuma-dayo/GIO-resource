...
-- 变量
variables = {
	{ name = "isObstacle1Available1", value = 1, no_refresh = false },
	{ name = "isObstacle2Available1", value = 1, no_refresh = false },
	{ name = "isObstacle3Available1", value = 1, no_refresh = false },
	{ name = "isObstacle1Available2", value = 1, no_refresh = false },
	{ name = "isObstacle2Available2", value = 1, no_refresh = false },
	{ name = "isObstacle3Available2", value = 1, no_refresh = false }
}
