...
triggers = {
	...
	{ config_id = 1181065, name = "ENTER_REGION_181065", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_181065", action = "", tag = "666" }
}
...
function action_EVENT_CHALLENGE_SUCCESS_181060(context, evt)
	...
	-- 删除suite7的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 133213181, 7)
