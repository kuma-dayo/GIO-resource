...
variables = {
	...
	{ name = "TsurumiStone", value = 1, no_refresh = true },
	{ name = "StoneCanPlace_A", value = 0, no_refresh = true },
	{ name = "StoneCanPlace_B", value = 0, no_refresh = true },
	{ name = "StoneCanPlace_C", value = 0, no_refresh = true },
	{ name = "isQuestNotify", value = 0, no_refresh = true }
}
