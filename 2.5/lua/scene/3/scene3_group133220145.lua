...
-- 怪物
monsters = {
	{ config_id = 145001, monster_id = 23010501, pos = { x = -2448.271, y = 226.480, z = -4204.861 }, rot = { x = 0.000, y = 220.027, z = 0.000 }, level = 1, drop_tag = "先遣队", disableWander = true, pose_id = 9001, area_id = 11 },
	...
	{ config_id = 145005, monster_id = 23010201, pos = { x = -2451.242, y = 225.686, z = -4190.349 }, rot = { x = 0.000, y = 165.699, z = 0.000 }, level = 1, drop_tag = "先遣队", area_id = 11 },
	{ config_id = 145012, monster_id = 23010601, pos = { x = -2456.498, y = 225.967, z = -4195.664 }, rot = { x = 0.000, y = 252.523, z = 0.000 }, level = 1, drop_tag = "先遣队", disableWander = true, pose_id = 9002, area_id = 11 }
}
