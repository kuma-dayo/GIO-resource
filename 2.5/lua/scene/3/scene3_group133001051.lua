...
-- 变量
variables = {
	{ name = "ovenATemp", value = 46, no_refresh = false },
	{ name = "ovenBTemp", value = 35, no_refresh = false },
	{ name = "ovenCTemp", value = 56, no_refresh = false },
	...
	{ name = "failTimes", value = 0, no_refresh = true }
}
