...
-- 变量
variables = {
	{ name = "isInitial", value = 1, no_refresh = false },
	{ name = "gadget_Teleport_1_isActive", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_2_isActive", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_3_isActive", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_4_isActive", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_5_isActive", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_1_state", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_2_state", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_3_state", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_4_state", value = 0, no_refresh = true },
	{ name = "gadget_Teleport_5_state", value = 0, no_refresh = true }
}
