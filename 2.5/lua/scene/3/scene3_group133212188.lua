...
-- 怪物
monsters = {
	{ config_id = 188001, monster_id = 20011301, pos = { x = -3611.666, y = 208.327, z = -2264.733 }, rot = { x = 0.000, y = 138.726, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188002, monster_id = 20011301, pos = { x = -3609.305, y = 208.031, z = -2264.277 }, rot = { x = 0.000, y = 161.159, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188003, monster_id = 20010601, pos = { x = -3660.939, y = 203.753, z = -2238.089 }, rot = { x = 0.000, y = 176.526, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188004, monster_id = 20010701, pos = { x = -3663.556, y = 203.883, z = -2239.206 }, rot = { x = 0.000, y = 159.631, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188005, monster_id = 20010901, pos = { x = -3681.622, y = 208.678, z = -2138.631 }, rot = { x = 0.000, y = 141.192, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188006, monster_id = 20010901, pos = { x = -3675.414, y = 209.064, z = -2138.681 }, rot = { x = 0.000, y = 212.314, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188030, monster_id = 20011301, pos = { x = -3612.951, y = 208.060, z = -2267.178 }, rot = { x = 0.000, y = 131.714, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 },
	{ config_id = 188031, monster_id = 20010601, pos = { x = -3667.153, y = 203.859, z = -2240.610 }, rot = { x = 0.000, y = 157.315, z = 0.000 }, level = 1, drop_id = 1000100, disableWander = true, affix = { 1410 }, climate_area_id = 9, area_id = 13 }
}
...
gadgets = {
	...
	{ config_id = 188036, gadget_id = 70900380, pos = { x = -3689.177, y = 227.238, z = -2106.481 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
	{ config_id = 188037, gadget_id = 70900380, pos = { x = -3681.747, y = 216.931, z = -2161.587 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
	{ config_id = 188038, gadget_id = 70900380, pos = { x = -3685.577, y = 219.685, z = -2111.575 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 27, area_id = 13 },
...
triggers = {
	...
	{ config_id = 1188023, name = "ENTER_REGION_188023", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_188023", action = "", trigger_count = 0, tag = "888" },
	...
	{ config_id = 1188025, name = "ANY_MONSTER_DIE_188025", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_188025", action = "action_EVENT_ANY_MONSTER_DIE_188025" },
	...
	{ config_id = 1188029, name = "ANY_MONSTER_DIE_188029", event = EventType.EVENT_ANY_MONSTER_DIE, source = "", condition = "condition_EVENT_ANY_MONSTER_DIE_188029", action = "action_EVENT_ANY_MONSTER_DIE_188029" }
}
...
function action_EVENT_GADGET_STATE_CHANGE_188020(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 666, 207, 90, 4, 888, 10) then
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_188025(context, evt)
	-- 将configid为 188010 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 188010, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
function action_EVENT_ENTER_REGION_188026(context, evt)
	...
	-- 将configid为 188012 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 188012, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
function action_EVENT_ANY_MONSTER_DIE_188027(context, evt)
	-- 将configid为 188012 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 188012, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
function action_EVENT_ENTER_REGION_188028(context, evt)
	...
	-- 将configid为 188014 的物件更改为状态 GadgetState.GearStart
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 188014, GadgetState.GearStart) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
...
-- 触发操作
function action_EVENT_ANY_MONSTER_DIE_188029(context, evt)
	-- 将configid为 188014 的物件更改为状态 GadgetState.Default
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 188014, GadgetState.Default) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
			return -1
		end 
