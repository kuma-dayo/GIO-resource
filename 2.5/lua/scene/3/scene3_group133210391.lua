...
-- 变量
variables = {
	{ name = "Gadget_Count", value = 0, no_refresh = true },
	{ name = "Statue_Rotate1", value = 0, no_refresh = true },
	{ name = "Statue_Rotated1", value = 0, no_refresh = true },
	{ name = "Statue_Rotate2", value = 0, no_refresh = true },
	{ name = "Statue_Rotated2", value = 0, no_refresh = true },
	{ name = "Statue_Rotate3", value = 0, no_refresh = true },
	{ name = "Statue_Rotated3", value = 0, no_refresh = true },
	{ name = "Success", value = 0, no_refresh = true },
	{ name = "StatueCount", value = 0, no_refresh = true }
}
...
suite_disk = {
	...
	[3] = {
		...
		variables = {
			...
			{ name = "Statue_Rotated3", value = 0, no_refresh = true },
			{ name = "Success", value = 0, no_refresh = true },
			{ name = "StatueCount", value = 3, no_refresh = true }
		}
	},
	[4] = {
		gadgets = {
