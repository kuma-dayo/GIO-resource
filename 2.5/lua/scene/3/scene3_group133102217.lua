...
-- 变量
variables = {
	{ name = "hasOpen", value = 0, no_refresh = true },
	{ name = "isAvailable", value = 1, no_refresh = false },
	{ name = "openFire", value = 0, no_refresh = false },
	{ name = "closeFire", value = 0, no_refresh = false }
}
