...
triggers = {
	...
	{ config_id = 1179023, name = "ENTER_REGION_179023", event = EventType.EVENT_ENTER_REGION, source = "", condition = "condition_EVENT_ENTER_REGION_179023", action = "", trigger_count = 0, tag = "888" },
