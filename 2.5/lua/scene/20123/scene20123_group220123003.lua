...
regions = {
	...
	{ config_id = 3008, shape = RegionShape.CUBIC, size = { x = 5.000, y = 2.000, z = 10.000 }, pos = { x = 35.183, y = -11.773, z = -26.947 } },
	{ config_id = 3009, shape = RegionShape.CUBIC, size = { x = 5.000, y = 2.000, z = 10.000 }, pos = { x = 11.975, y = -5.588, z = -50.019 } },
	-- 点完三盏灯之后玩家来到这，去掉怪物
...
variables = {
	...
	{ name = "BACKDOOR", value = 0, no_refresh = false }
}
