...
regions = {
	-- 进入平台处刷怪
	{ config_id = 8003, shape = RegionShape.CUBIC, size = { x = 3.000, y = 2.000, z = 3.000 }, pos = { x = -3.281, y = -6.253, z = -35.277 } },
	-- 进入此区域把怪给remove掉
	{ config_id = 8009, shape = RegionShape.CUBIC, size = { x = 11.000, y = 5.000, z = 15.000 }, pos = { x = 4.576, y = -7.001, z = -29.578 } },
	-- 进入平台处刷怪2
	{ config_id = 8011, shape = RegionShape.CUBIC, size = { x = 3.000, y = 2.000, z = 3.000 }, pos = { x = 13.136, y = -7.494, z = -23.202 } }
}
...
suites = {
	{
		...
		regions = { },
		triggers = { "VARIABLE_CHANGE_8006", "VARIABLE_CHANGE_8010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
