...
-- 变量
variables = {
	{ name = "A", value = 2, no_refresh = false },
	{ name = "B", value = 2, no_refresh = false },
	{ name = "C", value = 1, no_refresh = false },
	{ name = "D", value = 2, no_refresh = false },
	{ name = "Lamp", value = 0, no_refresh = false },
	{ name = "Yes", value = 0, no_refresh = false },
...
suites = {
	{
		...
		regions = { },
		triggers = { "VARIABLE_CHANGE_4005", "GROUP_LOAD_4025", "GADGET_STATE_CHANGE_4050", "GADGET_STATE_CHANGE_4051", "GADGET_STATE_CHANGE_4052", "GADGET_STATE_CHANGE_4053" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
