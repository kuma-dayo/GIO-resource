...
-- 变量
variables = {
	{ name = "PlatPoint1", value = 0, no_refresh = false },
	{ name = "PlatPoint2", value = 76002, no_refresh = false },
	{ name = "PlatPoint3", value = 76003, no_refresh = false },
	{ name = "PlatPoint4", value = 76001, no_refresh = false },
	{ name = "PlatPoint5", value = 76006, no_refresh = false },
	{ name = "PlatPoint6", value = 76005, no_refresh = false },
	{ name = "PlatPoint7", value = 76004, no_refresh = false },
	{ name = "PlatPoint8", value = 76007, no_refresh = false },
	{ name = "PlatPoint9", value = 76008, no_refresh = false },
	{ name = "PuzzleFlag", value = 0, no_refresh = true },
	{ name = "stageflag", value = 0, no_refresh = true },
	{ name = "doorflag", value = 0, no_refresh = true },
	{ name = "questflag", value = 0, no_refresh = true }
}
