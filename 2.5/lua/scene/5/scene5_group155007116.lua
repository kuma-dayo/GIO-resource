...
-- 装置
gadgets = {
	{ config_id = 116001, gadget_id = 70211101, pos = { x = -1.272, y = 215.221, z = 1380.735 }, rot = { x = 2.379, y = 272.401, z = 358.651 }, level = 21, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 },
