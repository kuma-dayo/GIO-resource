...
gadgets = {
	...
	{ config_id = 88004, gadget_id = 70211101, pos = { x = -37.715, y = 198.574, z = 1572.184 }, rot = { x = 3.945, y = 351.493, z = 351.878 }, level = 21, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}
