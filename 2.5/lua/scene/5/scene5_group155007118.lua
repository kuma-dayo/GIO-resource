...
garbages = {
	gadgets = {
		{ config_id = 118001, gadget_id = 70211101, pos = { x = -88.560, y = 228.953, z = 1656.602 }, rot = { x = 358.804, y = 210.158, z = 15.969 }, level = 21, drop_tag = "解谜低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
	},
	triggers = {
