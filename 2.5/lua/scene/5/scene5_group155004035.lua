...
-- 装置
gadgets = {
	{ config_id = 35002, gadget_id = 70211002, pos = { x = 35.517, y = 201.699, z = 1572.048 }, rot = { x = 0.000, y = 318.023, z = 0.000 }, level = 21, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}
