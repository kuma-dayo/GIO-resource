...
gadgets = {
	...
	{ config_id = 87004, gadget_id = 70211101, pos = { x = -165.025, y = 217.804, z = 1494.936 }, rot = { x = 347.830, y = 297.116, z = 4.252 }, level = 21, drop_tag = "解谜低级稻妻", showcutscene = true, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 },
