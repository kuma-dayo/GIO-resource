...
garbages = {
	gadgets = {
		{ config_id = 120001, gadget_id = 70211001, pos = { x = -75.516, y = 196.662, z = 1430.296 }, rot = { x = 358.659, y = 69.273, z = 3.468 }, level = 21, drop_tag = "战斗低级稻妻", isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
	},
	triggers = {
