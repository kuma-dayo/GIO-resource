...
function Initialize_Group(triggers, suites)
	...
	table.insert(variables,{ name = "digged", value = 0, no_refresh = true})
	table.insert(variables,{ name = "successed", value = 0, no_refresh = true})
	table.insert(variables,{ name = "challenge_state", value = 0})
	table.insert(variables,{ name = "current_stone", value = 0})
--初始化
end
