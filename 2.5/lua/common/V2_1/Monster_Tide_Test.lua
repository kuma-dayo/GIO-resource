...
local var = {
	{ name = "sum", value = 0, no_refresh = true },
	{ name = "max", value = 0, no_refresh = true },
	{ name = "min", value = 0, no_refresh = true },
	{ name = "suite", value = 0, no_refresh = true },
	{ name = "test", value = 0, no_refresh = true }
}
