local temp_Variables = {
	{ name = "SET_GV_1", value = 0, no_refresh = false },
	{ name = "SET_GV_0", value = 0, no_refresh = false },
	{ name = "StartChallenge", value = 0, no_refresh = false },
	{ name = "FinishChallenge", value = 0, no_refresh = false },
	{ name = "StartGallery", value = 0, no_refresh = false },
}
