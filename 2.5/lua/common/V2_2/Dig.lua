...
local temp_Variables = {
	{ name = "IsFinished", value = 2, no_refresh = false },	--用于标识是否已完成，未开始为2，战斗中为0，完成后变1.
	{ name = "Boss_Enhance", value = 0, no_refresh = false },	--用于标识是否狂暴，挑战开始时初始化为0，其他时候由ServerLuaCall控制
	{ name = "Active_Count", value = 0, no_refresh = false },	--用于表示当前运行中挖掘器数量。(0~3)
	{ name = "test_quickFinish", value = 0, no_refresh = false },	--快速完成
	{ name = "Boss_SetBattle", value = 0, no_refresh = false },	--快速完成
}
local Tirgger_Start = {
