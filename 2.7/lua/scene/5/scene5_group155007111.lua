...
-- 装置
gadgets = {
	{ config_id = 111002, gadget_id = 70211002, pos = { x = -12.497, y = 197.845, z = 1438.261 }, rot = { x = 0.000, y = 342.310, z = 0.000 }, level = 1, drop_tag = "战斗低级稻妻", state = GadgetState.ChestLocked, isOneoff = true, persistent = true, explore = { name = "chest", exp = 1 }, area_id = 200 }
}
