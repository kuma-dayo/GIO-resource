...
suites = {
	{
		...
		regions = { 2059, 2061 },
		triggers = { "GADGET_CREATE_2003", "VARIABLE_CHANGE_2035", "VARIABLE_CHANGE_2036", "VARIABLE_CHANGE_2037", "ENTER_REGION_2059", "ENTER_REGION_2061", "GROUP_LOAD_2084" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
	...
	},
	{
		...
		gadgets = { },
		regions = { },
		triggers = { "GADGET_STATE_CHANGE_2013", "SELECT_OPTION_2019", "GADGET_STATE_CHANGE_2020", "VARIABLE_CHANGE_2032", "VARIABLE_CHANGE_2033", "VARIABLE_CHANGE_2034", "SELECT_OPTION_2046", "SELECT_OPTION_2082", "TIMER_EVENT_2083" },
		rand_weight = 100
	},
	{
		-- suite_id = 6,
...
-- 触发条件
function condition_EVENT_VARIABLE_CHANGE_2037(context, evt)
	if evt.param1 == evt.param2 then return false end
...
-- 触发操作
function action_EVENT_VARIABLE_CHANGE_2037(context, evt)
	-- 调用提示id为 201270101 的提示UI，会显示在屏幕中央偏下位置，id索引自 ReminderData表格
	if 0 ~= ScriptLib.ShowReminder(context, 201270101) then
