...
function LF_Initialize_Group(triggers, suites)
	...
	--下一个该被激活的branch装置序号.
	table.insert(variables,{ name = "next_index", value = 1})
	--0未完成,1-开始中 2-已经完成
	table.insert(variables,{ name = "puzzle_state", value = 0, no_refresh = true})
	table.insert(variables,{ name = "challenge", value = 0})
end
