...
local temp_Variables = {
	{ name = "GalleryStart", value = 0, no_refresh = false },
	{ name = "GalleryFinish", value = 0, no_refresh = false },
	{ name = "Try_Add_Box", value = 0, no_refresh = false },
	{ name = "ADD_Gallery_monster_count", value = 0, no_refresh = false },
	{ name = "ADD_Gallery_box_count", value = 0, no_refresh = false },
	{ name = "Gallery_fail_reason", value = 0, no_refresh = false },
	{ name = "GalleryStart_Success", value = 0, no_refresh = false },
	{ name = "GalleryEnd", value = 0, no_refresh = false },
}
