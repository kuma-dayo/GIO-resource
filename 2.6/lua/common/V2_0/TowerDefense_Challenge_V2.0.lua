...
function LF_Init_Challenge_Group()
	...
	table.insert(variables, { name = "GM_VALUE", value = 0})
	...
	table.insert(variables, { name = "challenge_93", value = 0})
	table.insert(variables, { name = "challenge_94", value = 0})
	table.insert(variables, { name = "challenge_95", value = 0})
	table.insert(variables, { name = "challenge_active_93", value = 0})
	table.insert(variables, { name = "challenge_active_94", value = 0})
	table.insert(variables, { name = "challenge_active_95", value = 0})
	table.insert(variables, { name = "planNum", value = 1,no_refresh = true})
	table.insert(variables, { name = "ban_tag_1", value = 999})
	table.insert(variables, { name = "ban_tag_2", value = 999})
	table.insert(variables, { name = "ban_tag_3", value = 999})
end
--------------------------------------
