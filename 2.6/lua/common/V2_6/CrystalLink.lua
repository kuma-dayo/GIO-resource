...
function Initialize()
    ...
    --保存当前fever值，并传给下半场
    table.insert(variables,{ name = "current_fever", value = 0})
    --是否允许开始玩法
    table.insert(variables,{ name = "can_start", value = 0})
    --当前玩法group是否激活
    table.insert(variables,{ name = "is_active", value = 0})

    table.insert(variables,{ name = "current_monster_tide", value = 0})
	table.insert(variables,{ name = "current_elite", value = 1})
    table.insert(variables,{ name = "fever_ratio", value = 1})
    ...
    table.insert(variables,{ name = "last_created_tide_index", value = 0})
    --记录当前怪物潮是否死完了
    table.insert(variables,{ name = "current_tide_all_killed", value = 1})

    --是否因波次推进而被暂停
    table.insert(variables,{ name = "has_paused_by_index_move_forward", value = 0})
    --是否因小怪死亡而被暂停
    table.insert(variables,{ name = "has_paused_by_minion_die", value = 0})


    --记录pause操作的数量，相当于一个栈。pause操作全部弹出后，continue或create操作才能生效
    table.insert(variables,{ name = "pause_operation_num", value = 0})
end
