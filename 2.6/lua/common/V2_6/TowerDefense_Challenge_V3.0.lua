...
function LF_Init_Challenge_Group()
	...
	-- 掉落击杀的怪物获得资源点提升
	table.insert(variables, { name = "CardPicked_DieReasonIsFall", value = 0})
	-- 机关冷却时间减半
	table.insert(variables, { name = "CardPicked_GearCoolDown", value = 0})
	-- 地脉异常4是否激活
	table.insert(variables, { name = "M4_Active", value = 0})

	--
	--table.insert(variables, { name = "DieY", value = 0})

		-- GM
		table.insert(variables, { name = "GM_LevelNum", value = 0})
