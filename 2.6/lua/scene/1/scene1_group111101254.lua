...
-- 变量
variables = {
	{ name = "Trigger_1", value = 0, no_refresh = true },
	{ name = "Trigger_2", value = 0, no_refresh = true },
	{ name = "Trigger_3", value = 0, no_refresh = true },
	{ name = "Trigger_4", value = 0, no_refresh = true }
}
