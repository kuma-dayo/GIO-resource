...
variables = {
	...
	{ name = "battle_01", value = 0, no_refresh = true },
	{ name = "battle_02", value = 0, no_refresh = true },
	{ name = "battle_03", value = 0, no_refresh = true },
	{ name = "battle_04", value = 0, no_refresh = true },
	{ name = "battleState", value = 0, no_refresh = false },
	{ name = "battleindex", value = 1, no_refresh = false }
}
