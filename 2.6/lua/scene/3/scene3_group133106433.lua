...
gadgets = {
	...
	{ config_id = 433009, gadget_id = 70360001, pos = { x = -697.950, y = 99.190, z = 1817.170 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 36, area_id = 19 },
...
triggers = {
	...
	{ config_id = 1433008, name = "GADGET_CREATE_433008", event = EventType.EVENT_GADGET_CREATE, source = "", condition = "condition_EVENT_GADGET_CREATE_433008", action = "action_EVENT_GADGET_CREATE_433008" },
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_GADGET_DIE_433005", "GADGET_CREATE_433008", "GADGET_STATE_CHANGE_433010", "SELECT_OPTION_433011" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
