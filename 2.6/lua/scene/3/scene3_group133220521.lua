...
-- 变量
variables = {
	{ name = "ChallengeState", value = 0, no_refresh = true },
	{ name = "ChallengeLevel", value = 1, no_refresh = true },
	{ name = "pos_x", value = 0, no_refresh = true },
	{ name = "pos_y", value = 0, no_refresh = true },
	{ name = "pos_z", value = 0, no_refresh = true }
}
