...
-- 变量
variables = {
	{ name = "entered", value = 0, no_refresh = true },
	{ name = "finished1", value = 0, no_refresh = true },
	{ name = "finished2", value = 0, no_refresh = true },
	{ name = "finished3", value = 0, no_refresh = true },
	{ name = "finished4", value = 0, no_refresh = true },
	{ name = "finished5", value = 0, no_refresh = true },
	{ name = "globalfinish1", value = 0, no_refresh = true },
	{ name = "globalfinish2", value = 0, no_refresh = true }
}
