...
-- 变量
variables = {
	{ name = "w1", value = 0, no_refresh = false },
	{ name = "w2", value = 0, no_refresh = false },
	{ name = "w3", value = 0, no_refresh = false },
	{ name = "lastID", value = 0, no_refresh = false },
	{ name = "killID", value = 0, no_refresh = false },
