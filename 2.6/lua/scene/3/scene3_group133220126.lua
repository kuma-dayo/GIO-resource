...
-- 变量
variables = {
	{ name = "1_die", value = 0, no_refresh = false },
	{ name = "2_die", value = 0, no_refresh = false },
	{ name = "3_die", value = 0, no_refresh = false },
	{ name = "4_die", value = 0, no_refresh = false },
	{ name = "5_die", value = 0, no_refresh = false },
	{ name = "6_die", value = 0, no_refresh = false },
	{ name = "7_die", value = 0, no_refresh = false }
}
