...
-- 变量
variables = {
	{ name = "CookingCamp", value = 0, no_refresh = true },
	{ name = "AlchemyCamp", value = 0, no_refresh = true },
	{ name = "WeaponCamp", value = 0, no_refresh = true },
	{ name = "AllCleared", value = 0, no_refresh = true }
}
