...
-- 变量
variables = {
	{ name = "successed", value = 0, no_refresh = true },
	{ name = "challenge_state", value = 0, no_refresh = false },
	{ name = "current_stone", value = 0, no_refresh = false },
	{ name = "starter_id", value = 0, no_refresh = false },
	{ name = "start_enter", value = 0, no_refresh = false },
	{ name = "open", value = 0, no_refresh = true },
	{ name = "stone1", value = 0, no_refresh = true },
	{ name = "stone2", value = 0, no_refresh = true },
	{ name = "stone3", value = 0, no_refresh = true },
	{ name = "stone4", value = 0, no_refresh = true }
}
...
suite_disk = {
	...
	[2] = {
		...
		variables = {
			{ name = "successed", value = 0, no_refresh = true },
			{ name = "challenge_state", value = 1, no_refresh = false },
			{ name = "current_stone", value = 0, no_refresh = false },
			{ name = "starter_id", value = 0, no_refresh = false },
			{ name = "start_enter", value = 0, no_refresh = false },
			{ name = "open", value = 0, no_refresh = true },
			{ name = "stone1", value = 1, no_refresh = true },
			{ name = "stone2", value = 1, no_refresh = true },
			{ name = "stone3", value = 1, no_refresh = true },
			{ name = "stone4", value = 1, no_refresh = true }
		}
	},
	[3] = {
		gadgets = {
		...
		npcs = { },
		variables = {
			{ name = "successed", value = 1, no_refresh = true },
			{ name = "challenge_state", value = 2, no_refresh = false },
			{ name = "current_stone", value = 0, no_refresh = false },
			{ name = "starter_id", value = 0, no_refresh = false },
			{ name = "start_enter", value = 0, no_refresh = false },
			{ name = "open", value = 1, no_refresh = true },
			{ name = "stone1", value = 1, no_refresh = true },
			{ name = "stone2", value = 1, no_refresh = true },
			{ name = "stone3", value = 1, no_refresh = true },
			{ name = "stone4", value = 1, no_refresh = true }
