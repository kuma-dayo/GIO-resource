...
-- 变量
variables = {
	{ name = "start16", value = 0, no_refresh = false },
	{ name = "pick1", value = 0, no_refresh = false },
	{ name = "pick2", value = 0, no_refresh = false },
	{ name = "pick3", value = 0, no_refresh = false },
	{ name = "start06", value = 0, no_refresh = false }
}
