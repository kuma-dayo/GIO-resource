...
-- 变量
variables = {
	{ name = "succ", value = 0, no_refresh = true },
	{ name = "challenge_finish_1", value = 0, no_refresh = true },
	{ name = "challenge_finish_2", value = 0, no_refresh = true },
	{ name = "challenge_finish_3", value = 0, no_refresh = true }
}
