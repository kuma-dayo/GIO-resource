...
-- 装置
gadgets = {
	{ config_id = 441001, gadget_id = 70290403, pos = { x = -501.105, y = 175.960, z = 1789.721 }, rot = { x = 355.716, y = 282.876, z = 91.878 }, level = 36, isOneoff = true, persistent = true, area_id = 19 },
...
suites = {
	{
		...
		regions = { },
		triggers = { "ANY_GADGET_DIE_441006", "GADGET_STATE_CHANGE_441011" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
