...
-- 变量
variables = {
	{ name = "thief_progress", value = 0, no_refresh = true },
	{ name = "thief_A_finish", value = 0, no_refresh = true },
	{ name = "thief_B_finish", value = 0, no_refresh = true },
	{ name = "thief_C_finish", value = 0, no_refresh = true }
}
