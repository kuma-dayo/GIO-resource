...
-- 变量
variables = {
	{ name = "Wall1", value = 1, no_refresh = false },
	{ name = "Wall2", value = 1, no_refresh = false },
	{ name = "Wall3", value = 1, no_refresh = false },
	{ name = "Wall4", value = 1, no_refresh = false },
	{ name = "Wall5", value = 1, no_refresh = false },
	{ name = "Wall6", value = 1, no_refresh = false },
	{ name = "Block4", value = 1, no_refresh = false },
	{ name = "Block6", value = 1, no_refresh = false }
}
