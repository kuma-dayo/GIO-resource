...
triggers = {
	...
	{ config_id = 1002009, name = "PLATFORM_REACH_POINT_2009", event = EventType.EVENT_PLATFORM_REACH_POINT, source = "", condition = "condition_EVENT_PLATFORM_REACH_POINT_2009", action = "action_EVENT_PLATFORM_REACH_POINT_2009" },
...
-- 变量
variables = {
	{ name = "stairs1", value = 1, no_refresh = false }
}
...
-- 触发操作
function action_EVENT_PLATFORM_REACH_POINT_2009(context, evt)
