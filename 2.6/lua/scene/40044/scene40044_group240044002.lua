...
variables = {
	...
	{ name = "wall2", value = 0, no_refresh = false },
	{ name = "wall3", value = 0, no_refresh = false },
	{ name = "wall4", value = 0, no_refresh = false },
	{ name = "wall5", value = 0, no_refresh = false },
	{ name = "wall6", value = 0, no_refresh = false },
	{ name = "wall7", value = 0, no_refresh = false },
	{ name = "wall8", value = 0, no_refresh = false },
	{ name = "wall9", value = 0, no_refresh = false }
}
