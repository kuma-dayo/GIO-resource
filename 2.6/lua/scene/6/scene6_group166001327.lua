...
-- 变量
variables = {
	{ name = "Progress_Var", value = 0, no_refresh = true },
	{ name = "Battle_Var", value = 0, no_refresh = false },
	{ name = "RoomClear_1", value = 0, no_refresh = true },
	{ name = "RoomClear_2", value = 0, no_refresh = true },
	{ name = "RoomClear_3", value = 0, no_refresh = true },
	{ name = "RoomClear_4", value = 0, no_refresh = true }
}
