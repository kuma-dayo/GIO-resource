...
triggers = {
	...
	{ config_id = 1067004, name = "GADGET_STATE_CHANGE_67004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_67004", action = "action_EVENT_GADGET_STATE_CHANGE_67004" },
...
suites = {
	{
		...
		gadgets = { 67001, 67002 },
		regions = { 67007 },
		triggers = { "QUEST_START_67003", "GADGET_STATE_CHANGE_67004", "GADGET_STATE_CHANGE_67005", "ENTER_REGION_67007", "TIME_AXIS_PASS_67010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
