...
triggers = {
	...
	{ config_id = 1063004, name = "GADGET_STATE_CHANGE_63004", event = EventType.EVENT_GADGET_STATE_CHANGE, source = "", condition = "condition_EVENT_GADGET_STATE_CHANGE_63004", action = "action_EVENT_GADGET_STATE_CHANGE_63004" },
...
suites = {
	{
		...
		gadgets = { 63001, 63002 },
		regions = { 63008 },
		triggers = { "QUEST_START_63003", "GADGET_STATE_CHANGE_63004", "GADGET_STATE_CHANGE_63005", "ENTER_REGION_63008" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
